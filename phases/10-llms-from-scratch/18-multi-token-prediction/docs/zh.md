...
**类型：** 构建
**语言：** Python (标准库)
**前置条件：** Phase 10 · 04 (pre-training a mini GPT), Phase 10 · 15 (speculative decoding)
**时长：** 约 60 分钟
...
### 步骤 3： the transformer block at depth k
