...
**类型：** 构建
**语言：** Python (标准库)
**前置条件：** Phase 7 · 02 (self-attention), Phase 7 · 15 (attention variants), Phase 10 · 14 (architecture walkthrough)
**时长：** 约 60 分钟
...
### 步骤 4： noise cancellation measurement
...
### 步骤 5： V1 vs V2 parameter accounting
