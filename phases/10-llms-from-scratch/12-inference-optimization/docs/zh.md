...
**类型：** 构建
**语言：** Python
**前置条件：** Phase 10, Lessons 01-08 (Transformer architecture, attention)
**时长：** 约 120 分钟
...
### 步骤 5： Speculative Decoding Simulator
