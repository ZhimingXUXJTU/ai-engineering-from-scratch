...
**类型：** 构建
**语言：** Python (stdlib)
**前置条件：** Phase 14 · 06 (Tool Use), Phase 14 · 21 (Computer Use)
**预计时间：** ~75 minutes
...
| 术语 | 实际含义 |
|------|---------|
| Indirect prompt injection | "Injection in retrieved content" |
| Direct prompt injection | "Jailbreak" |
| PVE | "Prompt-Validator-Executor" |
| Source tag | "Content provenance" |
| Allowlist navigation | "URL whitelist" |
| Worming | "Self-replicating exploit" |
