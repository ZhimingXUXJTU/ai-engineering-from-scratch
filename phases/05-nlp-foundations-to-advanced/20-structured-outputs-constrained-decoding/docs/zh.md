...
**类型：** 构建
**编程语言：** Python
**前置课程：** Phase 5 · 17 (Chatbots), Phase 5 · 19 (Subword Tokenization)
**预计时长：** ~60 minutes
...
### 步骤 1： regex-constrained generation from scratch
...
### 步骤 3： Instructor for provider-agnostic Pydantic
