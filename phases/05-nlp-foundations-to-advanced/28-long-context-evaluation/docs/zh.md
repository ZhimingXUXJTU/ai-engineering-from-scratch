...
**类型：** 学习
**编程语言：** Python
**前置课程：** Phase 5 · 13 (Question Answering), Phase 5 · 23 (Chunking Strategies)
**预计时长：** ~60 minutes
...
### 步骤 1： a custom NIAH for your domain
...
### 步骤 3： multi-hop variable tracing (RULER-style)
...
### 步骤 4： LongBench v2 on your stack
