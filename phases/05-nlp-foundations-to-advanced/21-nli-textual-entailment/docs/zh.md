...
**类型：** 学习
**编程语言：** Python
**前置课程：** Phase 5 · 05 (Sentiment Analysis), Phase 5 · 13 (Question Answering)
**预计时长：** ~60 minutes
...
### 步骤 1： run a pretrained NLI model
...
### 步骤 3： faithfulness check for RAG
...
### 步骤 4： hand-rolled NLI classifier (conceptual)
