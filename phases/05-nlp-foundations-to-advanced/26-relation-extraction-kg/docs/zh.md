...
**类型：** 构建
**编程语言：** Python
**前置课程：** Phase 5 · 06 (NER), Phase 5 · 25 (Entity Linking)
**预计时长：** ~60 minutes
...
### 步骤 2： supervised relation classification
...
### 步骤 3： LLM-prompted extraction with anchoring
...
### 步骤 4： canonicalize onto a closed ontology
...
### 步骤 5： build a small graph and query
