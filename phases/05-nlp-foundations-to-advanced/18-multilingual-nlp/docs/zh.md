...
**类型：** 学习
**编程语言：** Python
**前置课程：** Phase 5 · 04 (GloVe, FastText, Subword), Phase 5 · 11 (Machine Translation)
**预计时长：** ~45 minutes
...
### 步骤 1： zero-shot cross-lingual classification
...
### 步骤 2： multilingual embedding space
...
### 步骤 3： few-shot fine-tuning strategy
