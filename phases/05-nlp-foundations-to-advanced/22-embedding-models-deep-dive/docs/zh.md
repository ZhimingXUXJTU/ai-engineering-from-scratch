...
**类型：** 学习
**编程语言：** Python
**前置课程：** Phase 5 · 03 (Word2Vec), Phase 5 · 14 (Information Retrieval)
**预计时长：** ~60 minutes
...
### 步骤 1： baseline — dense embeddings with Sentence-BERT
...
### 步骤 3： BGE-M3 multi-functionality
...
### 步骤 4： MTEB eval on a custom task
...
### 步骤 5： hand-rolled cosine from scratch
