...
**类型：** 学习
**语言：** Python (标准库， 12-field California AB 2013 scaffolding generator)
**前置条件：** Phase 18 · 24 (regulatory), Phase 18 · 26 (cards)
**时间：** 约 60 分钟
...
1. 运行 `code/main.py`. Produce a 12-field summary for a toy dataset and identify which fields are under-specified.
...
3. 阅读 the Data Provenance Initiative's "Consent in Crisis" (July 2024). Describe the three fastest-restricting content categories and argue one economic consequence.
...
5. 草拟a training-data-provenance manifest that composes with the AB 2013 fields and a C2PA-signed provenance chain for each dataset. Identify one technical and one legal barrier.
