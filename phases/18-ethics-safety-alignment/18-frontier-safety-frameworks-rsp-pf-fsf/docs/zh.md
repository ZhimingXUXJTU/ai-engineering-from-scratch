...
**类型：** 学习
**语言：** none
**前置条件：** Phase 18 · 17 (WMDP), Phase 18 · 07-09 (deception failures)
**时间：** 约 75 分钟
...
1. 阅读 RSP v3.0, PF v2, and FSF v3.0. Compile a table of each lab's CBRN threshold, each's AI R&D threshold, and each's required pre-deployment evaluation.
...
3. 设计一个safety case for a model crossing Anthropic's AI R&D-4 threshold. Name the evidence each of the three pillars (monitoring, illegibility, incapability) requires.
...
5. 阅读 METR's "Common Elements of Frontier AI Safety Policies" (2025). Name the three strongest cross-lab convergences and the two largest divergences.
