...
**类型：** 学习
**语言：** Python (标准库， scope-violation trace reconstruction)
**前置条件：** Phase 18 · 15 (indirect prompt injection)
**时间：** 约 45 分钟
...
1. 运行 `code/main.py`. Report the exfiltrated data with and without the scope-separation defense.
