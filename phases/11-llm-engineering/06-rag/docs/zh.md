...
**类型：** Build
**语言：** Python
**前置知识：** Phase 10 (LLMs from Scratch), Phase 11 Lessons 01-05
**时长：** ~90 minutes
**相关：** Phase 5 · 23 (Chunking Strategies for RAG) for the six chunking algorithms and when each wins. Phase 5 · 22 (Embedding Models Deep Dive) for picking the embedder. Phase 11 · 07 (Advanced RAG) for hybrid search, reranking, and query transformation.
