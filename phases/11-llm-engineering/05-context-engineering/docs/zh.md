...
**类型：** Build
**语言：** Python
**前置知识：** Phase 10 (LLMs from Scratch), Phase 11 Lesson 01-02
**时长：** ~90 minutes
**相关：** Phase 11 · 15 (Prompt Caching) — the cache-friendly layout is an extension of context engineering. Phase 5 · 28 (Long-Context Evaluation) for how to measure lost-in-the-middle with NIAH/RULER.
