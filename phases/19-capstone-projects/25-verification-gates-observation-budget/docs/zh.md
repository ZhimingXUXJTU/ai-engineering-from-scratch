...
**类型：** 构建
**语言：** Python (stdlib)
**前置知识：** Phase 19 · 20-24 (Track A1: agent loop, tool registry, message store, prompt builder, model router), Phase 14 · 33 (instructions as constraints), Phase 14 · 36 (scope contracts), Phase 14 · 38 (verification gates)
**预计时间：** ~90 minutes
