...
**类型：** 结业项目
**语言：** Python (server, via FastMCP) or TypeScript (@modelcontextprotocol/sdk), Go (registry service)
**前置知识：** Phase 11 (LLM engineering), Phase 13 (tools and MCP), Phase 14 (agents), Phase 17 (infrastructure), Phase 18 (safety)
**涉及的 Phase：** P11 · P13 · P14 · P17 · P18
**预计时间：** 25 hours
