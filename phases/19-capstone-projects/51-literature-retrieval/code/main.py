...
核心概念：文献检索——BM25 摘要检索 + 引用图谱遍历 + 融合排序，在学术论文语料上实现
基于关键词匹配和引用网络的双路文献发现
AI 对应：Semantic Scholar (Allen AI) 使用类似的 BM25 + 引用图谱检索架构；
Google Scholar 的排序算法结合文本相关性和引用信号；
Perplexity AI 的学术搜索模式使用 RAG + 引用追踪；
BM25 + citation graph 是学术文献检索的 2026 标准范式
"""
