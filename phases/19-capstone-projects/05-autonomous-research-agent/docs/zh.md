...
**前置知识：** Phase 2 (ML), Phase 3 (deep learning), Phase 7 (transformers), Phase 10 (LLMs from scratch), Phase 14 (agents), Phase 15 (autonomous), Phase 16 (multi-agent), Phase 18 (safety)
**涉及的 Phase：** P0 · P2 · P3 · P7 · P10 · P14 · P15 · P16 · P18
**预计时间：** 40 hours
