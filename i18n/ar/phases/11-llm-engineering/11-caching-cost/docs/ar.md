# التخزين المحفوظة، الحد من معدلات التكلفة وتحسين التكلفة
...
> **【中文解读】**شركة إصدار الذكاء الاصطناعي تعاني بشكل كبير من نموذج اقتصادي واحد سيء، وليس نموذج سيء. 10،000 مستخدم يستخدمون 10 مرات في اليوم، وتكلف الشركة 250 دولارًا في اليوم.

> **【拓展：成本优化→AI商业化】**提示缓存(سريعة التخزين) يمكن أن تقلل من 50-90% من تكلفة التفكير،语义缓存(Cache Semantic) يمكن أن تكون مماثلة للتسائل

>  **【前置】**学本节前请先掌握:(1) المرحلة 11·09(تدعيم الوظيفة);(2) المرحلة 11·04(التركيبات)语义缓存依赖嵌入;(3) Redis أو Memcached 基础──本节会用 `redis`.`fastapi-cache`أو`gptcache`.

**Type:** Build | **类型:** 构建
**Languages:** Python | **语言:** Python
**Prerequisites:** Phase 11 Lesson 09 (Function Calling) | **前置知识:** Phase 11 · 09 (函数调用)
**Time:** ~45 minutes | **时间:** ~45 分钟
**Related:**المرحلة 11 · 15 (التخزين السريع)  هذا الدروس يغطي التخزين السريع للتطبيق (التخزين السريع، التخزين السريع الدقيق، توجيه النموذج). الدروس 15 تغطي التخزين السريع للمقدم (Anthropic cache_control، OpenAI تلقائي، Gemini CachedContent). مزج الاثنين لخفض التكلفة بنسبة 50-95%. ‬**相关:**المرحلة 11 · 15 (提示缓存) 本课讲应用层缓存(语义缓存、精确哈希缓存、模型路由) درس 15 讲提供商层提示缓存(Anthropic cache_control、OpenAI自动、Gemini CachedContent) 结合两者可降低50-95% 成本。

## أهداف التعلم

- تنفيذ التخزين الآلي الذي يخدم استفسارات متكررة أو مماثلة من التخزين الآلي بدلاً من إجراء مكالمة API جديدة
  实现语义缓存, من خدمة缓存重复或相似查询, وليس كل مرة جديدة API 调用
...
- صمم استراتيجية تخزين المستويات باستخدام المقابلة الدقيقة، والتشابه النطاقي، وتخزين الاحتياطي المسبق لأنواع الاستفسارات المختلفة
   صياغة استراتيجيات تخزين على مستوى مختلف، وذلك لتنسيق نوع الاستفسار مع التطابق الدقيق، والتكامل مع تخزين الاختلافات

> **【中文解读】**هدف هذه الدورة: فهم استراتيجية تحسين تكاليف تطبيق LLM تخزين سريع 语义缓存、模型路由、批处理──LLM API 成本是生产部署的主要支出──

>  **【类比】**لا تحمل تخفيضات LLM  تطبيق مثل المطعم في كل من زبائنها على إعادة صناعة الطعام  بطيء و باهظ الثمن ∙ ثلاث طبقات تخفيض مثل ثلاث طبقات المواد الغذائية:**精确哈希缓存**冰箱里现成菜(同问题直接返回,毫秒);(2) **语义缓存** مثل غرفة البردة                                                                                                                                                                                                                                                            **prompt caching** الموردين يعدون الطعام جيد  النظام سريع استعمال،省 90% من تكلفة المدخل)

> ️ **【易错点】**缓存的 3 个坑: ((1) **缓存中毒** المستخدم يسأل "كم هو مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مبلغ مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّة مّ**相似度阈值过高**0.95                                                                                                                                                                                                                                                             **TTL 太长** اخبار نوع استفسار缓存 24h,模型答案过时;区分类 استفسار,事实查询 TTL=1h,聊 TTL=24h。
...
> GPT-5 لكل مليون رمز إدخال$5，每百万输出 $15―كلود أوبوس 4.7$15/$75‬ جيميني 3 برو$1.25/$5

هذه هي الرياضيات التي تقتل الشركات الناشئة:

> هذا هو جعل الشركات الناشئة في حالة إغلاق:
...
- 1000 رمز إدخال لكل استفسار (تعليق النظام + سياق + رسالة المستخدم)
  كل استفسار 1000 إدخال رمز
- 500 رمز خروجي لكل رد
  500  إشارة إصدار في كل مرة
...
> هذا مجرد تكاليف ماجستير في التدريس. بالإضافة إلى إضافة إلى إضافة إلى إضافة إلى إدارة قاعدة البيانات.
...
> الجزء المثير: 40-60% من الاستفسارات هي تقريبية متكررة. المستخدمون يستخدمون بعض الكلمات المختلفة.

أنت تدفع الثمن الكامل للحسابات الزائدة

> أنت في حسابات الزائد دفع كامل السعر.

## المفهوم الأساسي

> **【中文解读】**تحسين تكلفة API LLM هو الاعتبار الرئيسي لتنفيذ الإنتاج. الاستراتيجية الرئيسية: التخزين السريع (缓存不变前) 语义缓存 (缓存相似查询的回复) 模型路由 (简单问题用便宜模型) 批处理 (合并请求减少调用次数) 

> **【拓展：LLM 成本的实际数据】**GPT-4o 定价 $5/$15 لكل M رموز ((دخل/خروج) ،Claude 3.5 Sonnet $3/$15── يوماً ما يعيش 100،000 مستخدم لتطبيقات، كل مرة يتم فيها إدخال حوالي 2K + 500 رمزاً خروجاً، تتكلف حوالي 15،000-45,000 دولار.── من خلال التخزين السريع يمكن أن يقلل عن 50٪، باستخدام GPT-4o-mini ‬بدائل البحث البسيط يمكن أن يقلل عن 30٪.──
...
> كل إطار إدارة المعالجة تتميز بخمسة مكونات تكلفة
...
> النظام يطلب أن يكون هناك قتيل صامت. 1500 رمز. النظام يطلب كل طلب يتم إرساله، كل مليون طلب فقط هذا الوضع$3.75。每天 10 万请求就是 $375/天$11,250/月                                                                                                                                                                                                                                                          
...
> ثلاثة مُقدّمي خدمات في عام 2026 كلّهم يقدمون إشارات إضافية، لكن الجهاز مختلف.
...
> **Anthropic 方式**هو واضحة.`cache_control: {"type": "ephemeral"}`标记提示段──首次请求付 25% 写入溢价──后续同前请求获得90% 折扣──2,000 رمز 系统提示正常$0.005，缓存命中 $0.000625‬ 10،000 طلبات省 437.50$/天‬
...
> **OpenAI 方式**هو تلقائي. أي تلبية للمطالبة قد حصلت على 50٪ خصم.
...
> المقدم كاشوف فقط على نفس الملفات السابقة والتي تصل إلى النتائج.
...
> "ما هي السياسة المرجعية؟" و"ما هي المرجعية؟" هي مختلفة الخطوط ولكن النية هي نفسها.
...
> 嵌入成本可忽略──OpenAI نص-إدمج-3-صغيرة لكل مليون رمز 0.02 $.
...
> على التأكد من استخدامها (حرارة = 0 ̇ مع نموذج ̇ مع النقطة) ، تحديد الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على الحفاظ على.

هذا يعمل بشكل مثالي ل:

> هذا المشهد يعد مناسباً:
...
**令牌桶算法**: كل مستخدم واحد N رمزة برميل، حسب R/ ثانية معدل إضافة.

**Per-user quotas:**تحديد حدود يومية/شهرية للرموز لكل مستوى مستخدم.
**每用户配额**: حسب مستوى المستخدم设日/月 رمز 上限。
...
> "تجارة قليلة"$10/M 输出模型。$0.60/م 输出 GPT-4o-mini 完全胜任。 $1.25/م 输出 كلود هايكو 也可以──简单分类器把便宜查询路由到便宜模型,复杂查询路由到贵模型──
...
> هذه البيانات تكشف عن أي وظائف تستغرقها المستخدمين بشكل كبير، والتي تؤثر على وجودها بشكل أكبر.
...
> توقف الإنفاق عند الوصول إلى الحد الأقصى.
...
2. **Throttle**(85% من الميزانية): الانتقال إلى نماذج أرخص فقط
   **降速**(ميزانية 85٪): فقط تغيير إلى أكثر تكلفة
3. **Stop**(95% من الميزانية): رفض طلبات جديدة، إرجاع الردود المحفوظة فقط
   **停止**(ميزانية 95%): رفض طلب جديد، فقط العودة إلى الحافظة
...
> تطبيقات 1-5 طبقة من RAG تطبيقات عادة تنقل التكلفة الشهرية من$22,500 降到 $4000-6000... هذا هو الفرق بين حرق المال و عمل الأعمال

### التوفير الحقيقي: قبل وبعد ذلك

هنا تحطيم حقيقي لـ (راج) يتحدث مع (داو) 10 آلاف

> هذا هو تحليل حقيقي لـ 10 آلاف دولار
...
> 语义缓存的嵌入成本 ($180/月) في أول ساعة من الحياة في缓存就回本──
...
> 哈希完整提示، على نفس الطلب عودة إلى الحافظة
...
> جعل بطار محدودات، بما في ذلك كل مستخدم حصة.
...
> أن تكون أكثر الطرق الرخيصة لمعالجة الأسئلة
...
> افتتاح الآلي الكاشوف الآلي أي 1,024 + رمز 匹配近期请求的提示前得 50% 折扣──无需改码检查响应中 `prompt_tokens_details.cached_tokens`验证即可──
...
> API المجموعة على جميع الرموز 统一 50% 折扣── نتيجة 24 ساعة في العودة──适合非实时工作负载:评估、数据标注、批量摘要──
...
> 生产中用向量索引(Redis Vector Search、Pinecone أو pgvector)替换线性扫描──线性扫描适用 <1,000 条目──超过使用 ANN(近似近邻)实现 O(log n) 查找──
...
> 本课产出 `outputs/prompt-cost-optimizer.md` تحليل LLM 应用并推具体成本优化 (含预计节省) 
...
> أيضاً`outputs/skill-cost-patterns.md` بناء على الاستخدام مثال اختيار مناسب استراتيجية تخزين  إطار القرارات لتصميم التدفقات والقواعد من طريق النموذج
...
1. **Implement LRU eviction for the semantic cache.**استبدل أقدم وقت الإخلاء الأول بأقل استخدامًا. تتبع آخر وقت الوصول لكل إدخال وتخلص من الإدخال مع أقدم وقت الوصول عندما يكون الكاش مليئا. مقارنة معدلات الوصول بين الاستراتيجيات الثانية على أكثر من 100 استفسار.
   **为语义缓存实现 LRU 淘汰。**استخدام أقدم غير مستخدمة بدلاً من أقدم تحديد الاولوية ∙ تتبع كل مقالة في آخر وقت زيارة،缓存满时淘汰访问时间最旧条目 ∙ مقارنة اثنين من الاستراتيجيات في 100 استفسار على مقارنة معدل الحد الأقصى ∙
...
2. **Build a cost projection tool.**في إطار سجل المكالمات في إطار الإطار الإجتماعي (سجلات CostTracker) ، توقع التكلفة الشهرية بناءً على متوسط 7 أيام متأخر. حساب أنماط أيام الأسبوع/أسبوع. تنشئ تنبيه إذا تجاوز التكلفة الشهرية المتوقعة الميزانية بأكثر من 20%.
   **构建成本预测工具。**给定 API 调用日志(CostTracker 日志),按 7 天移动平均预测月成本──考虑工作日/周末模式──若预测月成本超预算20% 触发告警──
...
3. **Implement tiered semantic caching.**استخدم عتبات شبيهة: 0.98 لضربات الثقة العالية (العودة فورًا) و 0.90 لضربات الثقة المتوسطة (العودة مع إعفاء المسؤولية: "بناء على سؤال سابق مماثل..."). تتبع من أي مستوى جاء كل ضرب وقياس اختلاف رضا المستخدمين.
   **实现分层语义缓存。**تستخدم اثنين من التشابهات قيمة: 0.98 高置信命中(立即回归) و 0.90 中置信命中(带免责声明回归:"基于类似的过往问题...") 追踪每次命中来源层级,测量用户满意度差异──
...
4. **Build a model routing classifier.**استبدل المصنف القائم على الكلمات الرئيسية بمصنف قائم على التوابل. دمج 50 استفسارًا معلقاً (بسيط / متوسط / معقد) ، ثم تصنيف استفسارات جديدة عن طريق العثور على أقرب مثال معلقاً. قياس دقة التصنيف مقابل مجموعة اختبار من 20 استفسارًا.
   **构建模型路由分类器。**استخدام الاختبارات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبطة بالشكلات المرتبة الأولى والمرة الأولى والمرة الأولى والخفضلة بالشكل المرتبة الأولى والخفضلة على العشرطة بالشكل المرتبة على العشرطة بالشرة الأولى.
...
5. **Implement a circuit breaker with degradation levels.**عند 70% من الميزانية، سجل تحذير. عند 85%، قم بتبديل جميع التوجيهات تلقائيًا إلى أرخص نموذج (gpt-4o-mini). عند 95%، قم بتقديم إجابات مخزن مخزن فقط ورفض استفسارات جديدة. اختبر عن طريق محاكاة 1000 طلب مقابل ميزانية 1.00 دولار وتحقق من كل عتبة تسبب بشكل صحيح.
   **实现带降级层级的断路器。**70% 预算时记日志告警─85% 自动把所有路由切换到最便宜模型(gpt-4o-mini)─95% 只服务缓存响应并拒绝新查询──使用1000 请模拟1.00 预算测试,验证各值正确触发──
...
- [Anthropic Prompt Caching Guide](https://docs.anthropic.com/en/docs/build-with-claude/prompt-caching)-- الأوراق الرسمية لمراقبين التحكم الصريح في التخزين التخزينية، التسعير، و سلوك التخزين المضمون
  الأنثروبات 提示缓存指南أنثروبات 显式 cache_control 标记、定价和缓存生命周期行为的官方文档
- [OpenAI Prompt Caching](https://platform.openai.com/docs/guides/prompt-caching)-- التخزين الآلي OpenAI، كيفية التحقق من ضربات التخزين عبر حقل الاستخدام، وأقل طولات المقبلات
  OpenAI 提示缓存OpenAI自动缓存、如何通过使用 字段验证缓存命中、最小前长度
- [OpenAI Batch API](https://platform.openai.com/docs/guides/batch)-- تخفيض 50٪ على المعالجة غير المزامنة، شكل JSONL، نافذة استكمال 24 ساعة، و 50K الحدود الطلب
  OpenAI API مختلفة التدابير معالجة 50% خصم  JSONL 格式、24 ساعة لإكمال النافذة و 50,000 طلب الحد
- [GPTCache](https://github.com/zilliztech/GPTCache)-- مكتبة التخزين الآلي المفتوحة التي تدعم العديد من الخلفيات المتضمنة، مخازن المتجهات، وسياسات الإخلاء
  GPTCache open source لغة كاشف مخزن، دعم العديد من التدخينات الخلفية
- [Martian Model Router](https://docs.withmartian.com)-- توجيه نموذج الإنتاج الذي يختار تلقائيًا أرخص نموذج قادر على التعامل مع كل استفسار
  المريخ 模型路由器 توليد درجة نموذج الطريق، تلقائيًا اختيار قادرة على معالجة كل استفسار من أرخص نموذج
- [Not Diamond](https://www.notdiamond.ai)-- توجيه نموذج على أساس ML الذي يتعلم من أنماط حركة المرور الخاصة بك لتحسين التكلفة / الجودة التداول بين مقدمي
  ليس الماس على أساس نموذج ML، من نمط التدفق تعلم لتحسين تكلفة / الجودة الوزن عبر المقدمين
- [Helicone](https://www.helicone.ai)-- منصة ملاحظة LLM مع تتبع التكاليف، التخزين الآلي، الحد من المعدلات، وتنبيهات الميزانية كطبقة وكيل
  هيليكون LLM منصة مراقبة، بما في ذلك التتبع التكلفة  تخزين  الحد الأدنى والمدفوعة الميزانية، كمنطقة وكيلة
- [Dean & Barroso, "The Tail at Scale" (CACM 2013)](https://research.google/pubs/the-tail-at-scale/)-- التأخير، والانتاج، والرسائل TTFT/TPOT، والطلبات المحافظة؛ نموذج التكلفة وراء "اختر أرخص نموذج لا يزال يلبي P95. "
  دين وباروسو "الذيل على نطاق واسع" ((CACM 2013) 延迟、吞吐、TTFT/TPOT 百分位和对冲请求;"选满足P95的最便宜模型"背后的成本模型──
- [Kwon et al., "Efficient Memory Management for Large Language Model Serving with PagedAttention" (SOSP 2023)](https://arxiv.org/abs/2309.06180)-- ورقة vLLM؛ لماذا مخزن KV-Cache + مسلسل batching يضرب الخوادم الباهظة 24x على التكامل، الطبقة تحت "الخزف والتكلفة".
  كوان 等 "vLLM PagedAttention"(SOSP 2023) vLLM 论文;为何分页 KV 缓存 + 连续批处理吞吐量超朴素服务器 24 倍,"缓存与成本" تحت الهياكل التحتية层。
- [Dao et al., "FlashAttention-2: Faster Attention with Better Parallelism and Work Partitioning" (ICLR 2024)](https://arxiv.org/abs/2307.08691)-- تخفيض التكلفة على مستوى النواة محاكاة لتسجيل التخزين الآلي؛ اقرأ جنبا إلى جنب مع فك التخزين المضاربة و GQA للوصول إلى صورة كاملة عن منحنى التكلفة.
  كما أن "FlashAttention-2" ((ICLR 2024))  انخفاض تكاليف الطاقة النووية، مع التوجهات المثلى للحفظ الصائب؛ مع الإشارة إلى حل الحدود والج.ق.
