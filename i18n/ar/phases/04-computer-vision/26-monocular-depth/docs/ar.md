...
> **【中文解读】**التخطيط العميق هو صورة واحدة، وتعبر قيمة كل صورة عن مسافة الصورة. من الصورة الواحدة RGB  الصورة التنبؤ بعمق كان من المعتبر مستحيلاً، ولكن في عام 2026 يمكن لجهاز التخطيط الفيوت + القيادة الخفيفة الوصول إلى القيمة الحقيقية تقريباً.
...
> الغموض هو المحور المفقود في الرؤية الكمبيوترية في 2D. معتمدًا على RGB ، أنت تعرف مكان الأشياء على سطح الصورة. أنت لا تعرف كم تصل إلى حد ما.
...
>  التقديرات العميقة  من RGB  التنبؤ العميقة  الماضي تسبب في المضمون  المخرجات غير الموثوق بها  إلى 2026 عام كبير التدريبات المعدة تغير هذا النقطة: عمق أي شيء V3 استخدام结  DINOv2 骨干 وخلق عبر室内 室外 、 الطب والقمر الصناعي عالمية عمق الرسمة  مارجولد سوف يعيد تعريف العميقة كشروط انتشار المشكلة  ZooDepth للعودة إلى المسافة العامة الحقيقية 
...
> العميقة هي أيضا الجسر بين 2D الاختبار و 3D فهم: سوف تكتشف الصور من الصفوف ضرباً عميقة، يمكنك أن ترتفع 2D الأشياء إلى 3D نقطة النقطة.
...
- **Relative depth** أمر `z`"البيكسل A أقرب من البيكسل B، ولكن نسبة المسافات لا تربط بالمتري".
  中文翻译:**相对深度**有序的 `z`值,没有真实世界单位──"بصيغة A比بصيغة B قريباً، لكن نسبة المسافة غير محددة إلى米──"
- **Metric depth** المسافة المطلقة في أمتار من الكاميرا. يتطلب من النموذج أن يكون قد تعلم العلاقة الإحصائية بين إشارات الصورة والمسافة الحقيقية.
  中文翻译:**度量深度** من الصورة الصادرة عن المسافة الحتمية ((米) ◊ تحتاج إلى نموذج تعلم العلاقة الإحصائية بين الصورة والخطوط والمسافة الحقيقية
...
> MiDaS و عمق أي شيء V3 产生 relatively إلى عمقها── مارجولد 产生 relative to depth── زويعمقها、UniDepth 和 متريك3D 产生 طول عمقها── موديل الاعتدال على الجوانب الداخلية حساسة؛ relative model则不敏感──
...
> سيتم تحويل هذه الأسلوب إلى إشعاعات متدربة على مليارات الصور.
...
> هذا هو نموذج 2026 تحتاج إلى عمق مباشرة
...
> مارجولد (((ك 等،CVPR 2024)) سوف تعيد تقييم الغموض لتقديم إطار جديد لشرط الصورة إلى التوسع في الصورة.
