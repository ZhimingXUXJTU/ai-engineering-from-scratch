# تتبع متعددة الأجسام وذاكرة الفيديو ٠٠

> التتبع هو الكشف بالإضافة إلى الرابط، اكتشاف كل إطار، تطابق كشف هذا الإطار مع آثار الإطار الأخير حسب التعرف.

> **【中文解读】**跟踪 = 检测 + 关联── كل هدف للاختبار، ثم سوف نتائج الاختبار الحالية مع المسار التابع للسلسلة السابقة من خلال ID 匹配──多目标跟踪(MOT) هي التقنية الأساسية لفهم الفيديو، تحتاج إلى معالجة الظروف المعقدة 、 غياب、 إعادة الظهور ──

> **【拓展：MOT 的应用】**多目标跟踪在安防监控 (منظور المراقبة)                                                                                                                                                                                                  
...
> الاختبار يخبرك بمكان الأشياء في المجموعة`t`中哪个检测与第 `t-1`أيّة من الاختبارات هي نفس الكائن؟ بدونها، لا يمكنك حساب عدد الكائنات التي تمر عبر الخط، تتبع الكرة المغطاة، أو تعرف أن السيارة رقم 4 قد كانت على هذا الطريق منذ 8 ثوانٍ.
...
> المراقبة على كل منتج من المشاهد الفيديو هي أمر بالغ الأهمية: تحليلات الرياضة، المراقبة، السيارات الذاتية، التحليل الفيديو الطبي، مراقبة الحيوانات البرية، العلامات التجارية.
...
> عام 2026 يُحدث نوعين من النماذج الجديدة:**SAM 2 基于记忆的跟踪**(ت征记忆替代运动模型关联) و **SAM 3.1 Object Multiplex**(العديد من المواقف من نفس المفهوم هي التذكرة المشتركة)
...
> كل متابعة ستواجهها في عام 2026 هي متغيرات في هذه الدورة

- **SORT**(2016): فلتر كالمين + IoU المجرية. بسيط، سريع، لا نموذج مظهر.
  中文翻译:**SORT**(2016):كارمان 波器 + IoU 匈牙利算法──简单、快速、无外观模型──
- **DeepSORT**(2017): SORT + ميزة مظهر على أساس CNN لكل مسار (إدمج ReID). يتعامل مع العبور بشكل أفضل.
  中文翻译:**DeepSORT**(2017):SORT + كل مسار CNN 外观特征(ReID 嵌入)
- **ByteTrack**(2021): يربط الكشف عن انخفاض الثقة بمرحلة ثانية؛ لا توجد حاجة إلى ميزات المظهر ولكن أفضل الأداء على MOT17.
  中文翻译:**ByteTrack**(2021): سيتم إجراء اختبار الوقاية المنخفضة كمرحلة ثانية من المرتبطين؛ لا حاجة إلى خصائص ظاهرية ولكن أفضل أداء في MOT17
- **BoT-SORT**(2022): بايت + تعويض حركة الكاميرا + ReID.
  中文翻译:**BoT-SORT**(2022):بايت + 相机运动补偿 + ReID。
...
> كارمن 波器 الحفاظ على كل مسار الحالة `(x, y, w, h, dx, dy, dw, dh)`和协方差──每先用恒速模型**预测** حالت, reuse匹配的检测**更新** توقعات غير مؤكدة  توقعات عالية  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا  توقعات أكثر إعتمادا 

كل متابعة كلاسيكية تستخدم مرشح كالمان في خطوة التنبؤ بالحركة.

> كل جهاز متبعي كلاسيكي يستخدم كارمن بوتر في كل خطوة تحركية
...
> - نعم`M x N`                                                                                                                                                                                                                                                              `1 - IoU(轨迹框, 检测框)`أو ظاهرة خصائص من الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصفوف الصف`scipy.optimize.linear_sum_assignment`足足足快――
...
> 标准跟踪器丢弃低置信度检测(< 0.5)**第二阶段候选**: بعد تطبيق المسار إلى اختبار الثقة العالية، حاولت تطبيق المسار غير المتناسب لتطبيق القيمة القليلة للتطبيق على اختبار الثقة العالية.
...
- **MOTA (Multi-Object Tracking Accuracy)** 1 - (FN + FP + ID switches) / GT. يتم وزنها حسب نوع الخطأ؛ مقياس واحد يجمع بين إخفاقات الكشف والارتباط.
  中文翻译:**MOTA（多目标跟踪精度）**1 - (FN + FP + ID 切换) / GT── حسب الخطأ نوع إضافة الخصم ؛ سوف الاختبار وال关联失败 اختلط مع واحد واحد مؤشر──
- **IDF1 (ID F1)** متوسط متناغم من دقة الهوية والذكرى. يركز على وجه التحديد على مدى الحفاظ على هوية كل مسار حقيقة الأرض مع مرور الوقت. أفضل من MOTA للمهام الحساسة على مفتاح الهوية.
  中文翻译:**IDF1（ID F1）**معدل تحديد الهوية ومعدل استدعاء معدل التغيير والمتوسط معدل التدريب على كل مسار حقيقي مع الوقت للحفاظ على توافق الهوية مهمة حساسة للتغيير الهوية أفضل من MOTA
- **HOTA (Higher Order Tracking Accuracy)** يتحلل إلى دقة الكشف (DetA) ودقة الرابطة (AssA). المعيار المجتمعي منذ عام 2020؛ الأكثر شمولا.
  中文翻译:**HOTA（高阶跟踪精度）** تحلل للقياس دقة  DetA) و关联精度 AssA) ―― 2020 年以来的社区标准;最全面──
