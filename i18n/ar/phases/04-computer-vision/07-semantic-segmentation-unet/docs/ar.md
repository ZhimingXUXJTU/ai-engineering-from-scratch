# التقسيم الجوهري  U-Net  语义分割  U-Net
...
> **【中文解读】**语义分割就是 تقسيم كل صورة. U-Net 通过配对下采样编码器和上采样解码器,并连接跳跃连接实现这一点.

> **【拓展：U-Net 的广泛应用】**تم تصميم شبكة الويب في البداية لتقسيم الصور الطبية ، ولكنها أصبحت بنية أساسية في العديد من المجالات: انتشار المستقر استخدام شبكة الويب  كنواة للشبكة غير الضوضاء ‬التقسيم الطريقي في القيادة الذاتية‬التغطية الأرضية للصور الصناعية ‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬
...
>  分类 图像输出标签――检测 图像输出几框――分割 图像输出标签――对于大小为`H x W`من المدخلات، والخارج هي شكل`H x W`(语义) أو `H x W x N_instances`(مثال) من 张量──那是每张图像数百万预测, وليس واحد──
...
> إن التركيبات المفصلة هي السبب في أنها تدفع إلى جميع منتجات التنبؤات المباشرة: الطبية (طبية) ؛ السيارات الذاتية (طريق، طريق، حواجز، حواجز) ؛ الصناعات المتحركة (المحيطات) ؛ تحليل الملفات (المنطقة) ؛ الآلات (المنطقة القابلة للاستيعاب).
...
> المشكلة في البناء بسيطة ولكن الحل ليس بسيطا: تحتاج إلى شبكة على نفس الوقت لرؤية المشهد على الإطار الكلي على نفس الوقت.
...
- **Semantic**يقول "هذا البيكسل هو الطريق، وهذا البيكسل هو السيارة". سيارتان بجانب بعضها البعض تنهار إلى بقعة واحدة.
  中文翻译:语义分割说" هذا الصيغة هو الطريق، ذلك الصيغة هو السيارة"──
- **Instance**يقول "هذا البيكسل هو السيارة رقم 3، وهذا البيكسل هو السيارة رقم 5". يتجاهل الأشياء الخلفية ("الشئ" = السماء، الطريق، العشب).
  中文翻译:实例分割说"هذا الصيغة هو المركبة الثالثة،ذلك الصيغة هو المركبة الخامسة"──忽略背景类别(" Stuff" = 天空、道路、草地)──
- **Panoptic**يوحد كلتا: كل بكسل يحصل على علامة طبقة، كل حالة تحصل على هوية فريدة، الأشياء والأشياء كلتا قطعات.
  كل صورة تحصل على نوع من العلامات، كل حالة تحصل على هويتها الوحيدة، والسياق والشكل المقبل يتم تقسيمها.
