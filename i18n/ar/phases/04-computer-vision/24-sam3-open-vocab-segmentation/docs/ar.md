# SAM 3 & Open-Vocablary Segmentation ‬ SAM 3 مع إفتتاح الكلمات

> أعط نموذج عرض نصية وصورة و الحصول على أقنعة لكل كائن يطابق. SAM 3 جعل ذلك واحد المضي قدما.

> **【中文解读】**给模型一个文本提示和一个图像,就能得到所有匹配对象的分割掩码──SAM 3(Segment Anything Model 3) سوف تحويل هذه العملية إلى مجرد الاحتمالات الروتينية إلى التوزيع──开放词汇 分裂突破了传统分化模型只能识别训练类的限制──

> **【拓展：SAM 的革命性影响】**نموذج SAM 系列模型(Meta 发布) هو "نموذج أساسي" في مجال التقسيم، يمكن أن يُمكن التقسيم بأي شكل من الأشكال.
...
> عام 2023 SAM هو نموذج فقط للحصول على النقاط البصرية: يمكنك النقر على نقطة أو رسم مربع ، فإنه يعود إلى مخفي.
...
> SAM 3(Meta,2025 年 11 月,ICLR 2026) طيّن درجة联──.**可提示概念分割（PCS）**◊结合 2026 年 3 月的对象多复制 更新(SAM 3.1),它能高效地在视频中跟踪同一概念的多个例子──
...
> هذه الدورة تكشف عن التحولات الهيكلية التي تمثل ذلك. 2D التقسيم، الاختبار والنص والصور الأساسية قد تم دمجها إلى نموذج. مشكلة الإنتاج ليست "أضع أي خطوط مياه مرتبطة معا" ، بل "أي نموذج يمكن أن يُحذى من نهاية إلى آخر مع نموذج استخدامي".
...
> "提示概念词" هو كلمة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قصيرة قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص قص

هذا يختلف عن SAM بصري كلاسيكي على ثلاثة طرق:

> هذا يختلف عن المشاهد الكلاسيكية
...
3. يعيد عدة حالات في وقت واحد بدلا من قناع واحد لكل طلب.
   中文翻译: مرة واحدة عودة العديد من الحالات، بدلا من كل عرض واحد مخفي.

### قطع معمارية رئيسية

- **Shared backbone** جهاز ViT واحد يعالج الصورة. كل من رأس الكشف والمتابعة القائمة على الذاكرة تقرأ منه.
  中文翻译:**共享骨干** واحد في تي  معالجة الصور  اختبار الرأس و على أساس الذاكرة متابعة آلة تتبع كل من بينها
- **Presence head** يتوقع ما إذا كان المفهوم موجودًا في الصورة على الإطلاق. يزيل "هل هذا هنا؟" من "أين هو؟" يقلل من الإيجابيات الخاطئة على المفاهيم الغائبة.
  中文翻译:**存在性头** هل يوجد مفهوم التنبؤ في الصورة. "هذه هنا؟" و"هذه في أين؟"
- **Decoupled detector-tracker** اكتشاف مستوى الصورة والتتبع على مستوى الفيديو لديهما رؤوس منفصلة بحيث لا تتداخل.
  中文翻译:**解耦的检测器-跟踪器** تصويري درجة الاختبار و درجة الفيديو تتبع لها رؤوس مستقلة، لا يزعج بعضها البعض.
- **Memory bank** تخزين ميزات لكل مثال عبر الإطارات للتتبع فيديو (الآلية نفسها SAM 2 المستخدمة).
  中文翻译:**记忆库** عبر  تخزين خصائص كل حالة، لاستخدامات فيديو تتبع
...
- **YOLO-World**كاشف لغة مفتوح فقط (لا أقنعة) في الوقت الحقيقي. أفضل عندما تحتاج إلى صناديق في ارتفاع في الثانية.
  中文翻译:**YOLO-World** فقط open كلمة汇检测器(无掩码)。实时──需要高 fps 框时的最佳选择──
- **SAM 3** التقسيم الكامل + التتبع. إنتاج أبطأ ولكن أكثر غنى.
  中文翻译:**SAM 3** كامل التقسيم + 跟踪──更慢但输出更丰富──
...
> 生产分工:YOLO-World تستخدم فقط لتحقيق سريع التدفقات المائية (آجهزة إدارة السيارات) ،SAM 3 تستخدم للاختفاء أو تتبع المشهد.
