# Modelos abiertos: arquitectura pasos en adelante.
...
> **【中文解读】**En el cuarto curso desde cero construimos GPT-2 Small。2026 Year Front-End Open Source Modelo sólo hizo cinco modificaciones: RMSNorm  sustituir LayerNorm、SwiGLU  sustituir GELU、RoPE  sustituir el código de posición de aprendizaje、GQA/MLA  sustituir todo el enfoque、 MoE── ya se ha dominado el 95% de la matemática.

> **【拓展：DeepSeek架构】**El proyecto de investigación de DeepSeek-V3 tiene como objetivo desarrollar un sistema de análisis de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos

> ¿ Qué es esto ?**【前置】**学本节前请先掌握:Fase 10·04(Pre-Training Mini GPT) 理解原始 GPT 架构;Fase 10·05(Scaling);Fase 10·12(Inferencia Optimización) 理解 KV cache 才能懂 MLA──本节是后续 15-22 节(架构创新详解) 的概览──

> ¿ Qué es esto ?**【类比】**Mira 2026 开源模型 = 看不同品牌的电动车──Llama 3 = 特斯拉(务实,GQA + RoPE 标准配置);DeepSeek-V3 = 比亚迪(堆料王,MLA + MoE + MTP + DualPipe 全套);Mixtral = 大众 ID(MoE 老牌);Qwen = 小(多尺寸覆盖);Gemma = 沃尔沃(精简安全)──底层都是变压器(电动车底盘),差异在 5-6 个关键模块──
...
- Lea la configuración.json de Llama 3, Mistral, Mixtral, Gemma 2, Qwen 2.5, y DeepSeek-V3 y explique cada campo
  阅读 Llama 3、Mistral、Mixtral、Gemma 2、Qwen 2.5 和 DeepSeek-V3 de configuración. json 并解释每个字段
- Nombre el cambio arquitectónico específico que cada modelo hizo en comparación con GPT-2 Small y justifica desde los primeros principios
  Expresar cada modelo en relación con GPT-2 Small de modificaciones de la estructura específica, y analizar desde el principio básico
- Conto de parámetros de cálculo, tamaño de caché KV y memoria de activación para cualquier modelo abierto desde su configuración sola
   Sólo desde la configuración calcular la cantidad de parámetros de cualquier modelo de código abierto  KV  caché tamaño y activar la memoria
- Elija el modelo abierto adecuado para un objetivo de implementación dado las restricciones de latencia, memoria y capacidad
  De acuerdo con la limitación de la memoria y la capacidad, para la implementación de objetivos seleccionar el modelo de código abierto adecuado
...
> En la cuarta clase escribiste 350 líneas de numpy sobre un modelo de forma GPT-2 ∙∙ Llama 3 405B tiene un informe técnico de 200 páginas― Tu instinto te dice que son cosas completamente diferentes― en realidad no es―200 páginas describen el mismo objeto, sólo cinco o seis modificaciones con movimiento suficiente, además de mil detalles de la realización de la expansión―
...
> Este curso es un diferente. Para cada familia de modelos de código abierto principal, hemos listado en comparación con GPT-2 hasta el final de lo que ha cambiado, por qué ha cambiado, cuánto cuesta.
...
> **【中文解读】**Este programa se desarrolla en el campo de la tecnología de la información y de la información.

> **【拓展：架构演进的趋势】**Tendencias de la arquitectura de 2024-2025: RoPE  rotativo de la posición codificada ha reemplazado el código de la posición absoluta, GQA(分组查询注意力) redujo el caché KV 大小, SwiftGLU 替代 ReLU 升级 el rendimiento, RMSNorm 替代 LayerNorm 降低计算开销──MoE(混合专家) 通过稀疏激活降低推理成本,DeepSeek-V3 的MoE 每次只激活约37B/671B参数──
...
> **【拓展：开源模型的选型指南】**2024-2025 años de código abierto modelo seleccionado: general diálogo seleccionado Llama-3-70B, sugerir tareas seleccionadas DeepSeek-R1, código generado seleccionado DeepSeek-Coder-V2,长上下文选 Qwen-2.5-72B(128K 上下文),轻量级选 Llama-3-8B 或 Qwen-2.5-7B──
...
> 本课产 出  `outputs/skill-open-model-picker.md` Proporcionar objetivos de implementación  GPU 类型、显存、上下文长度、延迟预算) y asignación de tareas  Chat chat ̊代码、推理、长上下文), propone un modelo de código abierto  El esquema de cuantificación de la décima clase y la de la doce, y proporciona una racionalización clara de las seis estructuras rotativas 
...
1. Lea la configuración Qwen 2.5 72B de HuggingFace. Calcule los parámetros totales desde cero. Compara con el valor reportado por HF e identifique de dónde proviene cualquier delta (arrondamiento de la cabeza, factor de distribución de KV, etc.).
   China 翻译:阅读 HuggingFace 上的 Qwen 2.5 72B 配置──从零计算总参数──与 HF 报告值比较,找出差异来源(头维度舍入、KV 共享因子等)──
...
2. DeepSeek V3 utiliza 256 expertos con roteamiento de 8 principales. Calcule la proporción de expertos activados a expertos totales y compare con los 2 principales de 8 de Mixtral 8x7B. ¿Qué implica el cambio de poco (25%) a más denso poco (3%) sobre la capacidad por FLOP?
   China Translation:DeepSeek V3 utilizó 256 专家 top-8 路由──计算激活专家与总专家的比率, comparando con Mixtral 8x7B's top-2 of 8比──¿Qué significa el cambio de la capacidad de FLOP de un grupo de 25 por ciento a un grupo de 3 por ciento?
...
3. Compute la caché KV para Llama 3 405B en contexto 128k en FP8 y BF16. en FP8 es la mitad del número BF16. ¿Cuántas secuencias paralelas puede servir en un solo nodo 8xH100 (80 GB cada = 640 GB total, menos memoria de peso)?
   La base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de la base de datos de datos de la base de datos de la base de datos de datos de la base de datos de datos de la base de datos de datos de la base de datos de datos de la base de datos de datos de la base de datos de datos de la base de datos de datos de la base de datos de datos de datos de la base de datos de datos de la base de datos de datos de datos de la base de datos de datos de datos de la base de datos de datos de datos de la base de datos de datos de datos de datos de la base de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de la base de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos de datos
...
4. Gemma 2 alterna capas de atención completa y de atención de ventana deslizante. Escribe las matemáticas para el caché KV cuando la mitad de las capas usan una ventana deslizante de 4096 tokens en lugar de contexto completo. ¿Cuánto memoria ahorra eso en 8k contexto total?
   Gemma 2 交替使用全注意和滑动窗口注意层──写出一半层使用4096-token 滑动窗口而不是全上下文时 KV 缓存的数学公式──在 8K 总上下文省多少内存?
...
5. Encuentra un modelo abierto de fronteras reciente que se lanzó después de que se escribiera esta lección. Identifique cuál de los seis botones eligió y si introdujo un séptimo botón. El plan de estudios se sentirá obsoleto en el momento en que una nueva arquitectura se lance - el objetivo es actualizar tu mesa sin reconstruir tu modelo mental.
   China Translation: encontrar un artículo sobre el modelo de código abierto de la última línea de la redacción de este libro publicado después de su publicación. Identificar cuál de los seis rotos ha sido elegido y si ha introducido el séptimo. El objetivo del programa es actualizar tu perfil y no reconstruir el modelo intelectual.
