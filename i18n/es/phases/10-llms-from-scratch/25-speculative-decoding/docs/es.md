# Descifrado especulativo y EAGLE
...
> **【中文解读】**El primer modelo de la LLM se desarrolla para convertirse en un token  necesita una vez completa de miles de millones de parámetros                                                                                                                                                                                                                                                

> **【拓展：投机解码→推理加速】**投机解码是2025-2026年推理加速的标准技术──DeepSeek-V3 的 MTP 头在推理时被重复用于草稿器,接受率80%+──vLLM、TensorRT-LLM 都已内置支持──

> ¿ Qué es esto ?**【前置】**学本节前请先掌握:Fase 07·16(投机解码数学证明);Fase 10·12(推理优化基础)。本节是Fase 10·15(EAGLE-3) 的更早版本(基础+EAGLE),Fase 10·15是V3 升级版。
...
> **【中文解读】**投机解码的核心思想: con un pequeño proyecto de modelo rápidamente genera k 个候选标, reutiliza el objetivo del modelo y se va a verificar este k 个标. 接受的标志 直接保留(零额外延迟), fue rechazado de la primera error de la nueva generación.

> **【拓展：投机解码的工程实践】**La velocidad de la resolución de los proyectos depende de la distribución de modelos de proyecto y de la compatibilidad de los modelos objetivos y de la eficiencia de la batería de los procesos de procesamiento. En la práctica, el uso de la misma versión de la serie de modelos (como Llama-3-8B para Llama-3-70B) tiene el mejor efecto.
...
> **【拓展：投机解码的数学保证】**La distribución de salida del proyecto de resolución de códigos no es totalmente compatible con el modelo objetivo, sino que es un método matemático de equivalencia.
...
> 本课产 出  `outputs/skill-speculative-tuning.md` un análisis objetivo modelo trabajo carga y seleccionar el modelo de proyecto  K(duración del proyecto)  Ancho de árbol ̊ temperatura y cuándo regresar a la normalización 
...
1. Implemente la regla exacta de rechazo y verifique empíricamente.`speculative_decode`y mediante muestreo objetivo simple; calcular la distancia de TV entre las dos distribuciones de salida. Debe ser < 0,01.
   En español, "rechazar" significa "rechazar" o "rechazar".`speculative_decode`Y el objetivo común es que cada uno de ellos tenga una distribución de 10K; calcular la distancia entre dos distribuciones de salida y distribución de TV.

2. Calcule la fórmula de aceleración.`α`y `K`En el gráfico de los tokens esperados por objetivo-ahead.
   En inglés, el cálculo de la aceleración es un cálculo de la aceleración.`α`Y `K`, dibujar cada uno de los objetivos de la espera de la difusión número.
...
3. Entrenar un pequeño borrador. Toma un objetivo de 124M GPT-2 y destila un borrador de 30M GPT-2 en 100M tokens con pérdida KL.`α`En el texto retrasado.
   En el caso de los modelos de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión de la versión`α` Previo tiempo: 0,6-0,7
...
4. Implemente el dibujo de árbol estilo EAGLE. En lugar de una cadena, tenga el dibujo de salida de tres ramas en cada profundidad. Construya la máscara de atención del árbol. Verifique si el objetivo acepta la rama correcta más larga.
   La obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de la obra de
...
5. Mide los modos de falla. ejecuta el decodificación especulativa a temperatura=1.5 (alto estocástico). muestra que α se derrumba y el algoritmo es más lento que el decodificación simple debido a la carga general de proyección.
   En el caso de los sistemas de cálculo, el cálculo de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la velocidad de la veloc
