# Async y Hogwild! ¡Inferencia! ¡Es un paso diferente con Hogwild!
...
> **【中文解读】**投机解码在单序列内并行化代币――多 Agent 框架跨序列并行但需要显式协调――Hogwild! 推理让 N 个 LLM 实例并行共享 KV-cache, cada trabajador incluso cuando vea a otro trabajador 生成的代币――QwQ、DeepSeek-R1 等推理模型无需微调就能通过共享缓存 自行协调――

> **【拓展：多Agent推理→LLM Agent】**Hogwild! 推理是多 LLM Agent 协作的新模式──不同于传统的投票或子任务分配,它通过共享上下文实现自发协调, similar a un equipo humano en el mismo whiteboard 协作──

> ¿ Qué es esto ?**【前置】**学本节前请先掌握:Fase 10·15(Decodificación especulativa);Fase 10·12(Optimización de la inferencia + KV cache 概念);多 Agent 协作基础──本节是实验性前沿QwQ、DeepSeek-R1等推理模型才能用──
> ¿ Qué es esto ?**【类比】**Hogwild! = 多人共写一个Google Doc.── Cada trabajador (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人)  (人 (人)  (人)  (人)  (人)  (人)  (人)  ( ( ()  ()  ( ()  ()  ()  ()  ()  ()  ( ()  ()  ()  ()  () )  ()  ( () )  ()  ()  ( ()  () )  ()  () )  ( ()  () )  ( ()  () )  ()  ( () )  ()  (
...
- Describa las tres topologías comunes paralelas de LLM (voting, subtask, Hogwild!) y nombre los problemas que cada uno de ellos tiene como objetivo.
  描述三种常见的并行 LLM 拓(vota、子任务、Hogwild!), ¡explica sus problemas específicos
- En el caso de Hogwild! se puede establecer una configuración de base: múltiples trabajadores, una caché compartida de KV, coordinación emergente a través de auto-promulgación.
  Explicar el diseño central de Hogwild: muchos trabajadores, un KV compartido, un cajamiento, una coordinación de la aparición de la información.
- Calcule la velocidad de tiempo de Hogwild! en función del recuento de trabajadores`N`, paralelo a nivel de tareas `p`, y los gastos generales de coordinación `c`¿ Qué ?
  计算 Hogwild! 的挂钟时间加速, como trabajador 数 `N`、 tareas y ejecuciones `p`Y coordinar la venta`c`de la función
- Implemente un simulador Hogwild! de dos trabajadores en un problema de juguete y observa la división de tareas emergente.
  ¡En el problema de los juguetes, realice a dos trabajadores Hogwild!
...
> 现代 LLM 通过产生长推理链来解决难题5000代币的逐步逻辑很常见,深层数学问题上数万代币也会发生──以70B模型 35代币/秒的解码速度,50k代币需要24分钟──这不算上交互式──

La descifrado especulativo (fase 10 · 15) te da una velocidad de 3-5 veces paralela dentro de una secuencia.

> 投机解码(Fase 10 · 15) A través de la secuencia en un solo secuencia, la secuencia se acelera 3-5 veces.
...
> ¿Podemos ejecutar varias copias de modelos en el mismo problema, hacer que cooperen, hacer que compartan el trabajo?
...
> **【中文解读】**异步Hogwild 推理允许在模型权重更新时同时推理,不做加锁同步―― este método sacrificó la coherencia a cambio de una mayor capacidad de desglose, se aplica a la formación continua (continuous training) 场景模型一边学习一边服务――

> **【拓展：异步推理的应用场景】**异步推理适用于实时个性化 (): 模型边学习用户偏好边服务)  A/B 测试 (: 不同模型版本无切换) 持续预训 (: 持续预训) 模型边学新知识边回答问题) ◊ la industria se ha vuelto a centrarse en el modelo que está siempre en el aprendizaje 不需要停机重新部署就能获得新知识──
...
> **【拓展：异步推理的实际应用】**异步 Hogwild 推理适用于持续学习场景:模型一边从用户反中学习,一边继续服务―― las aplicaciones de la industria incluyen realtime personalización 推、在线 A/B 测试中的模型热更新、以及持续预训中的不停机知识更新──
...
> 本课产 出  `outputs/skill-parallel-inference-router.md` Dado un cálculo de la asignación de trabajo y carga de trabajo (toko 预算 任务并行配置 模型族 部署目标), se encuentra en el proceso de votación 思考树 多智能体 霍格威尔德! 和投机解码策略之间路由──
...
1. - ¿ Qué ?`code/main.py`Confirmar que la configuración N=2 Hogwild! produce más tokens de trabajo que la línea de base N=1 en el mismo tiempo de pared.
   En inglés: "Con un sistema de configuración de funcionamiento"`code/main.py` Confirmar N=2 Hogwild! 配置在同一挂钟时间产生比N=1 基线更多工作代币──
...
2. Reducir la fuerza de la heurística de coordinación (conjunto `coordination_weight=0.1`Re-run. Muestre que el acelerador se derrumba. Explique por qué: los trabajadores duplican el esfuerzo cuando no pueden coordinarse.
   La situación de la situación en el país se ha vuelto más difícil.`coordination_weight=0.1`La situación de los trabajadores en el sector de la seguridad social se ha vuelto a agravar.
...
3. Calcule la velocidad esperada Hogwild! para una tarea de razonamiento de 50k tokens con `p=0.8, c=500`Haga lo mismo para una tarea de chat de 1k-token con `p=0.3, c=200`¿Por qué uno es una victoria y el otro una pérdida?
   En español: calcular 50K tokens 推理任务`p=0.8, c=500`¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡`p=0.3, c=200`,N=4) hacer el mismo cálculo... ¿Por qué uno es ganar y uno es perder?
...
4. Lea la sección 4 (evaluación preliminar) del artículo Hogwild. Identifique los dos modos de falla que informan los autores.
   En el artículo 4 del informe, el autor del informe identifica dos tipos de fallas.
...
5. Combine Hogwild! con la descifrado especulativo en el juguete: cada trabajador utiliza un 2-token especificación-decodificación internamente. Informar el multiplicativo de aceleración. ¿Qué problema de contabilidad surge cuando dos trabajadores ambos quieren extender el mismo prefijo de caché compartido?
   En el modelo de juguetes, en el que se combina Hogwild! y el juego de libretas: cada trabajador utiliza 2 tokens en el interior.
