...
> Las características no son más, más buenas.
...
- Implementar desde cero los métodos de filtro (umbral de variación, información mutua, cuadrado de chi) y los métodos de envoltura (RFE, selección hacia adelante)
  Desde el principio de la práctica de la técnica de la información y de la preparación de la información (RFE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
- Explica por qué la información mutua captura relaciones no lineales de características y objetivos que la correlación no tiene
  Explicar por qué la información se puede captar correlaciones de errores de características no lineales-relaciones objetivo
- Comparar la regularización de L1 (selección integrada) con la RFE (selección de envoltura) y evaluar sus compensaciones computacionales
  Comparar L1 正则化 (嵌入选择) con RFE (包装选择), evaluar su cálculo de peso
- Construir una línea de selección de características que combine múltiples métodos y demuestre una mejor generalización en los datos retenidos
  Construir un conjunto de múltiples métodos de características de la selección de tubos, mostrando la generalización de la mejora en los datos dejados


> **【中文解读】**
> Tráfico Selección de muchos rasgos selecciona los subconjuntos más útiles. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recarga. Tráfico de recorte. Tráfico de recorte. Tráfico de recorte. Tráfico de recorte. Tráfico de recorte. Tráfico de recorte.

> **【拓展：特征选择在工业界的重要性】**
> En el modelo de control de los efectos financieros, los requisitos de regulación pueden explicarse y deben ser explicados por cada característica por qué se ha elegido. En el modelo de control de los efectos financieros, los requisitos de regulación deben ser explicados por cada característica. En el modelo de control de los efectos financieros, los requisitos de regulación deben ser explicados por cada característica. En el modelo de control de los efectos financieros, los requisitos de regulación deben ser explicados por cada característica. En el modelo de control de los efectos financieros, los requisitos de regulación deben ser explicados por cada característica. En el programa de selección de características no importantes, el peso se reducirá a cero, al mismo tiempo que se realizan la selección de características y el entrenamiento de modelos. En el análisis de la expresión genética, se seleccionaron 50 genes clave entre 20.000 genes que no solo mejoraron el rendimiento del modelo, sino que también proporcionaron indicios para el estudio de mecanismos de enfermedad. En el programa ganador del Premio Netflix, la selección de características reducirá a cientos de millones de características.
...
> Tienes 500 características. El modelo se ha adaptado lentamente, no hay nadie que pueda explicar lo que ha aprendido.
...
> Esto es el funcionamiento real de la dimensión de la maldición. Con el aumento de la cantidad de características, la explosión de la masa del espacio de características. Los puntos de datos se vuelven raros. La distancia entre los puntos se vuelve más rápida. El modelo necesita más datos en el nivel de índice para encontrar el modelo real.
...
> La selección es una solución. Elimina el ruido. Elimina el reducto. Mantenga las características que realmente llevan el objetivo. El resultado es: un entrenamiento más rápido.
...
> **【中文解读】**
> El método de selección de características tiene tres grandes tipos de ventajas: la técnica de selección de características (transversal, diferenciación, valor, información, análisis de la información) y la técnica de recopilación (transversal, recopilación, recopilación, recopilación, etc.) y la técnica de selección de características (transversal, diferenciación, valor, información, etc.); la técnica de recopilación (transversal, recopilación, recopilación, recopilación, recopilación, recopilación, recopilación, recopilación, recopilación, recopilación, etc.); la técnica de selección de características (transversal, recopilación, recopilación, recopilación, recopilación, etc.); la técnica de selección de características (transversal, recopilación, recopilación, etc.); la técnica de selección de características (transversal, recopilación, etc.); la técnica de selección de características (transversal, etc.); la técnica de selección de características (transversal, etc.); la técnica de selección de la técnica de selección de características (transversal, etc.); la técnica de recopilación de la mejor equilibrio de la información (transversal, etc.).
...
> Cada método de selección de características pertenece a una de las tres categorías siguientes:
...
> **过滤法**Utiliza estadística de la medición independiente de cada característica de la evaluación.
...
> **嵌入法**En el proceso de entrenamiento de modelos, la selección de características. La regularización se dividirá en cero. El árbol de decisión se dividirá en las características más útiles. La selección ocurrirá en el proceso de preparación, no como un paso individual.

### El umbral de variación

El filtro más simple. Si una característica apenas varía entre muestras, casi no lleva información.

> El más simple de los filtros. Si una característica en el modelo es casi invariable, casi no lleva información.
...
> 设置一个值(如0.01);; eliminación de cuadro es inferior a cada característica de este valor;; esto es completamente sin necesidad de ver la variable objetivo para poder mover la característica de la constante o la constante aproximada;;
...
> ¿Cuándo utilizar: como un preprocesamiento previo a otros métodos, para capturar características obvias de ningún uso en un coste cercano a cero.

Limitación: una característica puede tener una alta variación y seguir siendo ruido puro.

> Limitaridad: un rasgo puede tener un alto nivel de ruido pero sigue siendo puro ruido. Value Footnote Footnote 
...
> 互信息衡知道特征 X的值可在多大程度上减少对目标 Y的不确定性──
...
> Si X y Y 独立,p(x,y) = p(x) * p(y), por lo tanto, para los números de los elementos para cero,I(X;Y) = 0。X 告诉你关于Y的信息越多,互信息越高。
...
> En comparación con la correlación, la información entre sí captura relaciones no lineales. Una característica puede tener una correlación con el objetivo de cero, pero debido a que la relación es de segunda o periódica, la información entre sí es muy alta.
...
> 对于连续特征,先离散分盒 (en inglés: "sección de cuadro") 基于直方图的估计 (en inglés: direct square chart) ⋅分盒数影响估计 (en inglés: "sección de cuadro de cuadro") ⋅分盒数影响估计 (en inglés: 太少分盒丢失信息,太多盒增加噪音──常见选择:sqrt(n) 个分箱或 Sturges 规则 (1 + log2(n)) ⋅
...
> RFE es una forma de empaque. Utiliza las características del modelo para la importancia de la sucesión de ramas:

1. Entrenar el modelo con todas las características
   Utiliza todos los rasgos del modelo de entrenamiento
2. Características de rango por importancia (coefficientes para modelos lineales, reducción de impurezas para árboles)
   按重要性排列特征 (en la actualidad, el modelo de la línea es un número de modelos, el modelo de la árbol es un número de modelos que no es puro)
3. Eliminar la característica menos importante
   Movimiento de las características más no importantes
4. Repita hasta que el número deseado de características permanezca
   重复 hasta el número de características necesarias restantes
...
> RFE  considera la interacción de características, ya que el modelo ve todos los rasgos restantes juntos.
...
> Alfa parámetro de control de características por el grado de aceleración de las ramas de corte.
...
> ¿Por qué exactamente para cero?L1 惩罚 en el espacio de peso crear 形束区域──最优解倾向于落在形角上,在那里一个或多权重为零──L2 正则化(Ridge) crear 圆形束,权重缩小但很少变为零──
...
> Es la opción de características de inserción: el modelo se elimina en el proceso de entrenamiento de las características que el modelo ignora.
...
> Limitaridad: sólo se aplica a modelos lineales.
...
> Esto da un número de puntos de importancia de la integración de cada característica.
...
> Nota: la importancia del modelo de árboles tiene muchas características de valor único. Una lista de ID de tiempo es importante, ya que se divide perfectamente en cada muestra.

### Importancia de la permutación

Un método modelo-agnóstico:

> Un tipo de método sin relación con el modelo:

1. Entrenar el modelo y registrar el rendimiento de referencia en los datos de validación
   训练模型并记录 la base de datos de la prueba
2. Para cada característica: mezclar sus valores al azar, medir la caída en el rendimiento
   Para cada característica: con el desorden de su valor, la capacidad de medición disminuye
3. Cuanto mayor sea la caída, más importante será la característica
   La baja es más grande, la característica es más importante.

Si la mezcla de una característica no daña el rendimiento, el modelo no depende de ella.

> Si un rasgo no afecta a la prestación, el modelo no depende de él. Si la prestación se desmorona, este rasgo es clave.
...
> La importancia de la sustitución evita el desvio de la importancia del modelo de árbol. Pero es muy lento: cada característica se evalúa una vez por completo, para estabilidad se requiere repetir varias veces.
...
> **【中文解读】**
> Desde el método de selección de rasgos de la forma de realizar la forma de hacer tres tipos de rasgos: la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de la forma de hacer tres tipos de rasgos de rasgos de la forma de hacer tres tipos de rasgos de rasgos de la forma de hacer tres tipos de rasgos de rasgos de la forma de hacer tres tipos de rasgos de rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de las rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos de rasgos

> **【拓展：特征选择在 LLM 时代的新意义】**
> Aunque el nombre de aprendizaje profundo se denomina "características de aprendizaje automático", pero la selección de características sigue siendo clave en los siguientes escenarios: 1) la configuración de datos  características que pueden mejorar el rendimiento y la velocidad de entrenamiento de XGBoost/LightGBM; 2) los requisitos explicables  en el ámbito médico y financiero se necesitan explicar qué características se utilizan; 3) el espacio de inserción  incluso el transformador, también se necesita incorporar  "características de selección"  en la dimensión  el mecanismo de atención es en esencia una opción de características dinámicas)  En el informe técnico de OpenAI, el GPT-4 mencionó que el entrenamiento utiliza estrategias de selección de datos basadas en la importancia.
```figure
f3-feature-prune
```
...
> Sabemos que la realidad es que el rasgo 0-4 es de información (¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡
...
> El archivo de código se ejecuta en un mismo conjunto de datos de composición de todos los cinco métodos, y se imprime una tabla de comparación que muestra qué características seleccionaron cada método.

## Usalo con el marco de ejecución

Con scikit-learn, la selección de características se integra en la línea de producción:

> Usando el lenguaje de aprendizaje, rasgos de selección en tubos:
...
> Desde el punto de vista de la realidad, se muestra con precisión lo que ocurre dentro de cada método.`var(X, axis=0)`Y se aplica a ocultar. La información entre sí es la frecuencia conjunta y la frecuencia marginal en la tabla de la computadora. La RFE es un ciclo de entrenamiento, ordenamiento y recorte. La L1 es un ciclo de reducción de la escala de los pasos de la forma más suave. La importancia de la acumulación de la división se reduce.
...
> La versión de la tienda aumentó la capacidad de producción de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos de tubos.
...
1. **Forward selection**En cada paso, añade la característica que mejorará el rendimiento del modelo más. Detenerse cuando agregue características ya no ayuda. Comparar las características seleccionadas con los resultados de RFE. ¿Cuál es más rápido? ¿Cuál da mejores resultados?
   1. Produjo un conjunto de datos de 100 características, de las cuales 10 se relacionan con el objetivo, 90 son ruidos)  Comparar la diferencia entre valores, información y L1
...
2. **Stability selection**: ejecuta la selección de características L1 50 veces, cada vez en una submuestra aleatoria del 80% de los datos, con valores alfa ligeramente diferentes. Cuente la frecuencia con la que se selecciona cada característica. Las características seleccionadas en > 80% de las carreras son "estables". Comparar características estables con la selección de L1 de una sola carrera. ¿Cuál es más confiable?
   2. 实现后向消除 (), de todas las características comenzando, de manera individual, de eliminación (),
...
3. **Multicollinearity detection**La función de correlación de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de datos de un par de par de datos de un par de par de datos de un par de par de datos de un par de par de datos de un par de par de datos de un par de par de datos de un par de par de par de datos de un par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de par de
   3. En el mismo conjunto de datos, comparar L1 y RFE resultados de selección ¿Eligen las mismas características? ¿Cuándo será diferente?
...
> **【中文解读】**
> Estrategia de selección de características: 1) Previo uso de diferencia de valor elimina las características de la cantidad constante; 2) uso de información entre sí; 2) uso de información entre sí; 2) uso de datos entre sí para seleccionar características relacionadas con el objetivo; 3) uso de RFE o L1 para analizar la interacción entre características.

> **【拓展：递归特征消除（RFE）的工业应用】**
> RFE es ampliamente utilizado en la genómica para seleccionar entre 50 y 100 genes con mayor capacidad de predicción entre 20.000 expresiones genéticas, no sólo para mejorar el rendimiento del modelo, sino también para el descubrimiento de signos de enfermedades. En el control financiero, RFE ayuda a seleccionar entre cientos de características de candidato para seleccionar las características finales.
...
- [An Introduction to Variable and Feature Selection (Guyon & Elisseeff, 2003)](https://jmlr.org/papers/v3/guyon03a.html)- la encuesta fundamental sobre los métodos de selección de características, todavía ampliamente referenciada
  [Guyon & Elisseeff: An Introduction to Variable and Feature Selection (2003)](https://jmlr.org/papers/v3/guyon03a.html)- Títulos de selección
...
- [Stability Selection (Meinshausen & Buhlmann, 2010)](https://arxiv.org/abs/0809.2932)-- combina la submuestreo con la selección de características para obtener resultados robustos y reproducibles
  [Feature Engineering and Selection](http://www.feat.engineering/)- Libros gratis en línea
