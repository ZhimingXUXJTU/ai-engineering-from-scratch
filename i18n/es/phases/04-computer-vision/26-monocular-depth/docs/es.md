...
> **【中文解读】**La profundidad de imagen es una imagen de un solo canal, cada imagen representa el valor de la distancia de la cámara. Desde un solo plano de imagen RGB previsión de profundidad de imagen se consideró imposible, pero en 2026 el ViT  codificador + de la resolución de la clase ligera ya ha podido alcanzar una precisión cercana al valor real.

> **【拓展：深度估计的应用】**单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在自动驾驶 (en inglés) 单目深度估计在语音) 
...
> La profundidad es el eje que falta en la visión de computadora en 2D. Dado RGB, sabes la posición de los objetos en la imagen; no sabes cuánto lejos están.
...
>  Profundidad de la estimación  de un solo RGB  Proyecto de profundidad  pasado producido模糊、 no fiable de la salida── hasta 2026 años de grandes prep prep prep prep codeadores cambiaron este punto: Profundidad Cualquier cosa V3 Uso结  DINOv2 骨干并产生跨室内、室外、医学和卫星领域泛化的深度图──Marigold redefinirá la profundidad como condición de la difusión de la cuestión──ZoeDepth regresar a la verdadera distancia pública─
...
> La profundidad es también el puente entre la detección 2D y la comprensión 3D: se va a detectar imágenes del marco multiplicado por la profundidad, usted ya puede elevar los objetos 2D a 3D puntos de nube.
...
- **Relative depth** ordenado `z`"El pixel A está más cerca que el pixel B, pero la relación de distancias no está anclada a metros".
  En inglés:**相对深度** tiene orden `z`值,没有真实世界单位──"¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿
...
> MiDaS y profundidad Cualquier cosa V3  producir en relación con la profundidad。Marigold  producir en relación con la profundidad。ZoeDepth、UniDepth 和 Metric3D  producir en relación con la profundidadModelo de medida a la cámara interior sensible; en relación con el modelo 则不敏感。
...
> Profundidad Cualquier cosa V3 结编码器, sólo entrenar DPT 风格的解码器──编码器提供丰富特征;解码器将插值回图像分辨率并回归深度──
...
> Una imagen 2D contiene muchos puntos de vista relacionados con la profundidad:

- **Perspective** Las líneas paralelas en 3D convergen en 2D.
  En inglés:**透视**3D en el medio de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la línea de la 3D en la 2D en la 2D.
...
- **Occlusion order** Los objetos más cercanos ocultan los más lejanos.
  En inglés:**遮挡顺序**Objeto cercano ocultado Objeto distante 
- **Size constancy** objetos conocidos (coches, humanos) dan una escala aproximada.
  En inglés:**大小恒常性** Ya conocido objeto 车、人) dar una medida aproximada.
- **Atmospheric perspective** Los objetos distantes aparecen más nebulosos y más azules en escenas al aire libre.
  En inglés:**大气透视** Los objetos en el exterior aparecen más azules en el exterior.
...
> ViT, entrenado en miles de millones de imágenes, incorporará estas pistas. Tiene suficiente datos y una sólida base de datos, sin necesidad de ninguna profundidad visual.
...
> Este es un modelo de 2026 que necesita profundidad.
...
> Marigold(Ke 等,CVPR 2024) va a la profundidad de la estimación de nuevo marco para la condición de la imagen a la expansión de la imagen.
