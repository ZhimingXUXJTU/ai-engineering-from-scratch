# 3D Gaussian Splatting desde cero desde la realización de 3D
...
> **【中文解读】**3D 高(3DGS) utiliza millones de 3D 高球 para representar escenarios. Cada高 tiene una posición, dirección, aceleración, opacidad y colores relacionados con la vista.

> **【拓展：3DGS vs NeRF】**El 3D Gaussian Splating es un reemplazo real de la NeRF. La NeRF se ha producido lentamente pero de alta calidad.
...
> NeRF almacenará el escenario como el peso de la silla de MLP. Cada imagen de la silla de MLP se realiza cientos de veces a lo largo de la línea.
...
> 3D 高(Kerbl、Kopanas、Leimkühler、Drettakis,SIGGRAPH 2023) sustituyó a todos estos. La escena es un conjunto de 3D 高──染是100+ fps de GPU光化── entrenamiento sólo requiere unos minutos.
...
> El modelo de mente es muy simple, las matemáticas tienen una parte suficiente, la mayoría de las presentaciones se dan a partir de la luz y se dan a cabo con proyección y función de la bola.
...
> 旋转 + 缩放构建 3x3 协方差矩阵:`Sigma = R S S^T R^T` Éste es el formato de la bola en 3D La función de la bola hace que el color cambie según la dirección de observación Alta luz La luz de la luz La luz de la luz La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La forma de la bola La función de la bola La forma de la bola En 3D La función de la bola hace que el color cambie según la dirección de observación Alta luz La luz de la luz La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La luz de la bola La forma de la bola La forma de la bola La forma de la bola La forma de la bola La forma de la bola La forma de la bola La forma de la bola La forma de la bola La forma de la bola La es la bola La es la forma de la bola La es la forma de la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la que sólo el color La es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es la es
...
> Un escenario típico tiene 100-500 millones de puntos altos. Cada uno de ellos almacena alrededor de 60 puntos altos.
...
> Esto es**与 NeRF 的体积渲染方程相同**, sólo se basa en un conjunto de raros y pequeños objetos, no en una muestra de densidad de luz. Esta ecuación es la razón por la cual la calidad de la radiación coincide con la NeRF.
...
> Cada paso de proyección, distribución de partículas, alfa, síntese, evaluación de los parámetros de alta densidad es muy pequeño.`(mu, q, s, alpha, c_lm)`                                                                                                                                                                                                                                                              

### Densificación y poda

Un conjunto fijo de Gaussianos no puede cubrir una escena compleja.

> El entrenamiento consiste en dos mecanismos de adaptación:
...
- **Clone**un Gaussian en su posición actual cuando su magnitud de gradiente es alta pero su escala es pequeña  la reconstrucción necesita más detalles aquí.
  En inglés:**克隆** Cuando el nivel es alto pero se reduce, en la posición actual, el desarrollo de una nueva construcción de altas altitudes requiere más detalles.
- **Split**un gaussian a gran escala en dos más pequeños cuando su gradiente es alto  un gaussian grande es demasiado suave para encajar en la región.
  En inglés:**分裂**Cuando la gran escala es alta, se divide en dos más pequeñas un gran nivel de calma no se adapta a la zona
- **Prune**Los gaussianos cuya opacidad cae por debajo de un umbral no están contribuyendo.
  En inglés:**修剪** la opacidad es inferior a la valor de 高不贡献,修剪掉──
...
> 密集化每N 次代运行一次──场景通常从约10万初始高斯 (en inglés: SfM 点播种) 增长到训练结束时的100-500万──
