# Segmentación semántica  U-Net 语义分分  U-Net
...
> **【中文解读】**语义分分就是分类对每个像素. U-Net 通过配对下采样编码器和上采样解码器, y entre ellos conectarse y saltar para lograr esto.

> **【拓展：U-Net 的广泛应用】**U-Net fue diseñado inicialmente para la división de imágenes médicas, pero se ha convertido en una infraestructura de muchos campos: Distribución estable.
...
> Por ejemplo, el tamaño de la imagen se puede ver en el cuadro de la imagen.`H x W`de entrada, salida es forma`H x W`(语义) o `H x W x N_instances`(ejemplo) de la cantidad de imágenes. Es por cada imagen de millones de predicciones, no una.

> **【中文解读】**La división de los segmentos de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de la red de televisión de televisión de la red de televisión de la red de televisión de televisión de la red de televisión de televisión de la red de televisión de televisión de la red de televisión de televisión de la red de televisión de televisión de televisión de la red de televisión de televisión de televisión de la red de televisión de televisión de televisión de televisión de televisión de la red de televisión de televisión de televisión de televisión de televisión de la red de televisión de televisión de televisión de televisión de televisión de la red de televisión de televisión de televisión de televisión de televisión de televisión de la televisión de televisión de televisión de la televisión de televisión de televisión de televisión de televisión de televisión de la televisión de televisión de televisión de televisión de la televisión de la televisión de televisión de la televisión de televisión de televisión de la televisión de Estados de Estados de Estados de Estados de Estados de Estados de Estados de Estados de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de Estados Unidos de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América de América
...
> La estructura de la división es la razón por la cual impulsa casi todos los productos de previsión visual: medicina (imagen) 瘤掩码 (título de tumor) 自动驾驶 (autónoma) 道路 (道路) 车道 (obstrucciones) 卫星 (autónoma) 建筑轮 (estructura) 作物边界 (object boundary) 文档解析 (archivo) 布局区域 (área) 机器人 (机器人) 可抓取区域) . Estas tareas no pueden ser resueltas en el cuadro de dibujo que rodea a un objeto; necesitan una ronde precisa──
...
>  La estructura del problema se dice simple pero no se resuelve fácil: necesitas la red para ver al mismo tiempo la imagen en su totalidad.
...
- **Semantic**dice "este píxel es carretera, ese píxel es coche". Dos coches uno al lado del otro se derrumban en una sola mancha.
  China Translation:语义分割说" este es un camino, ese es un coche"── dos vehículos vecinos se unen en una región──
- **Instance**dice "este píxel es el coche #3, ese píxel es el coche #5." Ignora las cosas de fondo ("cosas" = cielo, carretera, césped).
  En el caso de los vehículos de la tierra, el sistema de distribución de las cosas es el sistema de distribución de las cosas.
- **Panoptic**unifica ambos: cada píxel obtiene una etiqueta de clase, cada instancia obtiene un ID único, cosas y cosas ambos segmentados.
  Todo el paisaje se divide en dos: cada imagen obtiene una categoría de etiquetas, cada caso obtiene una identificación única, el contexto y el objeto del paisaje se dividen.

Esta lección abarca la semántica. La siguiente lección (Máscara R-CNN) abarca la instancia.

> En el curso de la enseñanza de la lengua, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el profesorado de la Universidad de San Francisco, el cual se encuentra en el centro de la Universidad de San Francisco.
