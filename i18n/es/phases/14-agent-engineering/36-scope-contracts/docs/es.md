# Los contratos de alcance y las limitaciones de tareas.
...
> ¿ Qué es esto ?**【前置】**Estudiar en el campo de la investigación y la investigación de la investigación y la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la ciencia de la ciencia de los resultados de la investigación de la investigación de la investigación de la investigación de la investigación de la investigación de la ciencia de la ciencia de la ciencia de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los científicos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de los proyectos de
> ¿ Qué es esto ?**【类比】**El contrato de alcance = 装修合同──"sólo broche客厅墙、不动家具、不改变水电"──Agent 不知道边界("反正都是这个项目的代码,我顺手把那个bug也修了"), el contrato de alcance 让 Agent 知道哪些文件可以改、哪些不能,越界就报警──
...
> El agente se extenderá. La tarea es "rehabilitar el error de registro". Diferencias en el proceso de registro, la función de correo auxiliar, la función de base de datos, la lectura y la publicación de guiones. Cada contacto tiene razones razonables en el momento actual.
...
> 范围蔓延 工作中最缺乏监督的失败模式,因为 Agent 诚实地叙述每一步──修复不是更严格的提示──修复是磁盘上的契约,说明承诺的内容,以及将结果与承诺进行比较检查──


> **【中文解读】**范围契约定义 Agent can do what and cannot do what──: 1) 文件范围Agent puede modificar qué documentos y catálogos; 2) 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作范围 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 操作 
...
> 范围契约(Consejos de alcance) define el operativo del agente 边界―― mediante el claro designamiento del agente 可以和不可以做什么, prevenir越界操作――
