...
> **El 84 % de los estudiantes ya usa herramientas de IA. Solo el 18 % se siente preparado para usarlas de forma profesional.** Este plan de estudios cierra esa brecha.
>
> 523 lecciones. 20 fases. ~342 horas. Python, TypeScript, Rust, Julia. Cada lección entrega un artefacto reutilizable: un prompt, una skill, un agente, un servidor MCP. Gratis, código abierto, MIT.
>
> No solo aprendes IA. La construyes. De principio a fin. A mano.
...
Tres formas de empezar. Elige una.
...
Gratis, con licencia MIT, 523 lecciones. Gracias a los patrocinadores y colaboradores que hacen posible este trabajo. [Ver todos los patrocinadores y colaboradores](../../BACKERS.md).
...
MIT. Úsalo como quieras: bifúrcalo, enséñalo, véndelo, publícalo. La atribución se agradece, pero no es obligatoria.
