...
> Mỗi tín hiệu là sự gia tăng của sóng âm.
...
- Thực hiện DFT từ đầu và xác minh nó so với O(N log N) Cooley-Tukey FFT
  Từ zero thực hiện DFT 并 với O(N log N) của Cooley-Tukey FFT 验证
- Giải thích các tỷ lệ tần số: lấy âm lượng, pha và quang phổ điện từ tín hiệu
  解释 tần số系数: từ tín hiệu中提取幅度、相位和功率谱(Power Spectrum)
...
- Kết nối phân hủy tần số Fourier với các mã hóa vị trí biến đổi và các lớp convolution CNN
  将里叶频率分解与变压器 位置编码和CNN 卷积层联系


> **【中文解读】**
> Bất kỳ tín hiệu nào có thể được phân chia thành âm thanh, âm thanh, hình ảnh, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện thoại, điện
...
> 音频录制 là một chuỗi đo áp suất thay đổi theo thời gian. Giá cổ phiếu là một chuỗi giá trị thay đổi theo thời gian.
...
> Nhưng nhiều mô hình trong thời gian không thể nhìn thấy. Các tín hiệu âm thanh này là âm thanh thuần túy hay dây? giá cổ phiếu này có chu kỳ hàng tuần? hình ảnh này có cấu trúc lặp lại?
...
> 里叶变换将数据从时域转换到频域――它接收一个信号并将其分解成不同频率的正弦波――每个正弦波有幅度(有多强) 和相位(从哪里开始) ―― 里叶变换告诉你两者──
...
> Điều này rất quan trọng đối với ML, bởi vì định dạng của suy nghĩ không tồn tại.

## Khái niệm cốt lõi

> **【中文解读】**
> 里叶变换的核心思想: bất kỳ tín hiệu nào có thể phân chia thành các tần số khác nhau của âm thanh và sóng.DFT Đặt tín hiệu thời gian thành tần số频域 mỗi tần số cho bạn biết" tần số này có nhiều năng lượng"―― đây giống như 镜 phân chia ánh sáng trắng thành彩虹: tần số nhìn thấy là tín hiệu hỗn hợp, tần số nhìn thấy là các thành phần khác nhau――

> **【拓展：FFT 的计算影响力】**
> FFT được xem là một trong những thuật toán số quan trọng nhất thế giới trong thế kỷ 20. Gauss đã phát hiện ra chiến lược phân phối vào năm 1805, nhưng Cooley-Tukey trong nghiên cứu năm 1965 mới cho phép FFT được áp dụng rộng rãi. Ngày nay, mỗi lần 4G / LTE 通话、 mỗi张 JPEG 照片、 mỗi MP3 bài hát đều trải qua FFT 处理. Trong lĩnh vực AI, mô hình tiếng nói thì thầm lên mỗi giây âm thanh tính khoảng 100 lần FFT, ống xử lý hình ảnh của Stained Diffusion cũng sử dụng rất nhiều các hoạt động trong phạm vi频域.
...
> **X[0]：直流分量（DC Component）。**Đây là tổng hợp của tất cả các mẫu với giá trị trung bình tương đương.
...
> **X[N/2]：Nyquist 频率。**Sử dụng N 个样本能表示的最高频率──超过此频率会产生混叠
...
> **X[k]（N/2 < k < N）：负频率。**Đối với giá trị thực của tín hiệu, X[N-k] = conj(X[k])。 tần suất âm là hình ảnh của tần suất chính xác。 đó là lý do tại sao thông tin hữu ích ở trước N/2 + 1 个系数。
...
> Sự khác biệt duy nhất với DFT: chỉ số là正(非负), và có một yếu tố kết hợp 1/N.
...
> Trái lại, DFT là hoàn hảo tái tạo. Không có thông tin bị mất. Bạn có thể quay lại từ thời gian đến frequencies, không có bất kỳ sai lầm nào.
...
> DFT được định nghĩa ở trên là O(N^2) của: đối với mỗi n 个输出系数, bạn đối với n 个输入样本求和;; đối với n = 100 万, đó là 10 ^ 12 lần运算;;
...
> 快速里叶变换(FFT) với O(N log N) 计算 kết quả tương tự.

> **【中文解读】**
> Số lượng tính toán của DFT là O(N^2), nhưng FFT  thông qua phân phối chiến lược để hạ xuống đến O(N log N)。 Đối với tín hiệu của N=100.000, DFT  cần hàng tỷ lần vận hành, FFT chỉ cần khoảng 2000.000 lần  tăng tốc 50.000 lần!

Quá trình Cooley-Tukey (FFT phổ biến nhất) hoạt động bằng cách chia và chinh phục:

> Cooley-Tukey 算法 (FFT) thông qua分治 (Divide and Conquer) 工作:

1. Chia tín hiệu thành các mẫu được lập chỉ số bằng và không cùng.
   Để phân chia tín hiệu thành chỉ số số đôi và chỉ số số kỳ lạ mô hình.
2. Xét DFT của mỗi nửa theo cách tái tạo.
   递归计算每一半的 DFT──
3. Kết hợp hai DFT nửa kích thước bằng cách sử dụng "twivel factors" e^(-2*pi*i*k/N).
   Sử dụng "旋转因子" (twiddle factor) e^(-2*pi*i*k/N) 合并两个半尺寸的DFT──
...
> Đối称性 nghĩa là mỗi tầng quay trở lại làm O N) 的工作,共享 log2N) 层──总计:O N log N)。
...
> Đây là một trong những kết quả quan trọng nhất trong xử lý tín hiệu, liên quan trực tiếp đến CNN.
...
- Đối với các hạt nhân lớn, FFT convolution nhanh hơn đáng kể.
  Đối với khối lượng hạt nhân lớn, FFT 卷积快得多.
- Đây chính xác là những gì xảy ra trong các lớp convolutional với các lĩnh vực thụ thể lớn.
  Đó là điều xảy ra trong một khu vực có cảm giác lớn.

> **【拓展：卷积定理在 CNN 中的实际应用】**
> 标准 3x3 卷积直接计算比FFT 快,但当感受野变大时FFT 优势显现――ConvNeXt 和 Global Convolution 网络在7x7或更大的卷积中使用FFT 加速――FNet (Lee-Thorp et al., 2021) 更大胆地使用FFT 替代变压器的自注意,在GLUE基准上达到 92% 的BERT 精度,但训练速度快7 倍――频域复制的杂度是O(N) 而时域卷积是O(N^2)。
...
> 注意:DFT 计算 là vòng lặp 卷积 (信号会环绕) ⋅ đối với vòng lặp (线性卷积) ⋅无环绕), trong toán trước sẽ có hai tín hiệu bổ sung零到长度 N + M - 1⋅
...
> DFT giả định tín hiệu là chu kỳ của nó sẽ xem N 个样本 như một chu kỳ tín hiệu lặp lại vô hạn. Nếu tín hiệu không có cùng giá trị ở bắt đầu và kết thúc, biên giới sẽ xảy ra không liên tục, biểu hiện như giả định của hàm lượng cao.

Windowing làm giảm rò rỉ bằng cách giảm tín hiệu xuống 0 ở cả hai đầu trước khi tính toán DFT.

> 窗函数 (Windows) thông qua trong tính toán DFT  trước khi các tín hiệu sẽ dần giảm xuống đến zero để giảm rò rỉ.
...
> Parseval 定理说明 tổng năng lượng trong hai lĩnh vực là giống nhau.
...
> Mỗi chiều đối với (2i, 2i+1) với tần số khác nhau túng túng. Tần số từ cao ((dimension 0,1) đến thấp ((final dimension)呈几何间隔―― đây là một cách duy nhất cho mỗi vị trí cung cấp qua tất cả các频段.

Các tính chất chính mà nó cung cấp:

- **Uniqueness:**Không có hai vị trí có mã hóa giống nhau.
  **唯一性：**Không có hai vị trí có mã giống nhau.
...
> 标准 CNN 实现使用直接卷积 (小的3x3卷积核更快) ⋅ nhưng đối với khối lượng lớn hoặc toàn局卷积, dựa trên FFT phương pháp là đáng kể nhanh hơn. Một số cấu trúc như FNet hoàn toàn sử dụng FFT thay thế sự chú ý, để đạt được độ phức tạp của O ⋅ N log N) thay vì O ⋅ N ^ 2.
...
> 单次 FFT 给你整个信号的频率内容, nhưng không cho bạn biết những频率 này xuất hiện vào thời điểm nào.
...
> 短时里叶变换(STFT) thông qua tính toán FFT trên cửa sổ chồng lên của tín hiệu để giải quyết vấn đề này. Kết quả là biểu đồ tần số: một biểu hiện 2D của một trục với thời gian, tần số cho trục khác.
...
> 频谱图是音频 ML 模型的标准输入表示;;语音识别模型;;Whisper、DeepSpeech) trên 频谱图的Mel-Spectrogram) 频率映射到 频谱图的Mel刻度,更好地匹配人类音高感知;;

> **【中文解读】**
> 单次 FFT chỉ có thể nhìn thấy thành phần tần số của toàn bộ tín hiệu, nhưng không biết mỗi tần số xuất hiện vào "什么时候" .
...
> Nếu tín hiệu chứa tần số cao hơn fs/2 (tần số Nyquist), thì tốc độ fs 采样 sẽ tạo ra một số lần hỗn hợp.
...
> Đó là lý do tại sao mô hình chuyển đổi có chứa các bộ chuyển động chống trộn, trong khi thử nghiệm trước khi di chuyển Nyquist trên tần suất. Trong ML, khi không có các đặc điểm chuyển động thấp thích hợp, một số cấu trúc sẽ xuất hiện trộn qua các lớp phân tích chống trộn để giải quyết vấn đề này.
...
> 常见误解: trước FFT 补零 có thể nâng cao tần số phân giải. Thực tế không thể. 补零 trong hiện có tần số bin 插值, cho bạn một hình ảnh tần số trơn tru hơn.
...
> Sự phân giải tần số thực sự chỉ phụ thuộc vào thời gian quan sát T = N / fs。 để phân biệt hai tần số của delta_f, ít nhất cần dữ liệu T = 1 / delta_f 秒── không thể thay đổi giới hạn cơ bản này──

> **【拓展：频谱图在语音 AI 中的标准地位】**
> OpenAI Whisper 模型将音频转换为 log-Mel 频谱图后输入编码器──Mel 刻度模拟人耳对频率的感知(低频区分更细)──Whisper sử dụng 80 个 Mel 波器组、25ms 窗口、10ms 步长──一段 30秒的音频产生约3000 x 80频谱图阵──Google's WaveNet、Meta's EnCodec cũng được sử dụng để biểu thị các đặc điểm giữa các频谱图或频域──
...
> 频谱图矩阵形状是 (n_frequencies, n_time_frames) ⋅ mỗi hàng là một cửa sổ thời gian ⋅ đây là âm thanh ML 模型的输入──
...
> 术语速查:DFT(离散里叶变换)、FFT(快速里叶变换 O(N log N))、Inverse DFT(逆 DFT)、Frequency bin (频率槽) 、DC component(直流分量 X[0])、Nyquist frequency(奈奎斯特频率 fs/2)、Power spectrum(功率谱X[k]2)、Phase spectrum(相位谱)、Spectral leakage(频谱泄漏)、Window function function function function function (Hann/Hamming)、Twiddle factor (Twiddle factor) 旋转因子)、Convolution the卷积定理:时卷积=频域乘法)、Circular/Linear convolution循环/环积分 (环节积) Parse's the energy ≠恒定orem (恒定orem) ⇒
