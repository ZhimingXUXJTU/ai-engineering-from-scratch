# Transformers Diffusion & Rectified Flow                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
...
> **【中文解读】**U-Net không phải là bí mật của mô hình phổ biến. Với Transformer thay thế U-Net, thay thế dòng dòng trực tuyến.

> **【拓展：DiT 是 2024-2026 的趋势】**Diffusion Transformer(DiT) 将 Transformer's可扩展性带入扩散模型──Sora(视频生成)、Stable Diffusion 3、FLUX 都采用DiT 架构──Relict Flow 将扩散过程简化为直线插值,训练和推理更高效──
...
> Chương 10  Học tập sử dụng U-Net để tạo ra DDPM. Chương trình này được xây dựng trong năm 2020-2023: U-Net + beta 调度 + 噪音预测损失. Nó tạo ra Stable Diffusion 1.5 và 2.1 và DALL-E 2.
...
> Mỗi mô hình văn bản đến hình ảnh tiên tiến nhất năm 2026 đã vượt qua nó. Sản phẩm Stable Diffusion 3、FLUX、SD4、Z-Image、Qwen-Image、Hunyuan-Image không sử dụng U-Net. Chúng sử dụng Transformer DiT (DiT) ・SD3 và FLUX cũng sử dụng toàn dòng thay thế điều chỉnh tiếng ồn DDPM, nó sẽ từ đường dẫn âm thanh của dữ liệu, và thông qua sự phù hợp hoặc biến số biến thể thực hiện 1-4 bước.
...
> Sự thay đổi này rất quan trọng, bởi vì nó dựa trên việc phát triển hình ảnh tạo ra trở nên có thể kiểm soát được 提示精确 (SD3/SD4  giải quyết văn bản 染) và các nguyên nhân của sản xuất nhanh chóng  hiểu DiT + 整流就是理解 2026 năm tạo hình ảnh技术──
...
- **DiT**(Peebles & Xie, 2023)  thay thế U-Net bằng một biến thể giống như ViT trên các bản vá ẩn.
  Trung ngữ翻译:**DiT**(Peebles & Xie,2023)  dùng loại ViT của Transformer  thay thế U-Net  xử lý biến đổi lượng bổ bổ bổ¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬
- **MMDiT**(SD3, Esser et al., 2024)  hai dòng với trọng lượng riêng biệt cho các mã thông báo văn bản và hình ảnh chia sẻ sự chú ý chung.
  Trung ngữ翻译:**MMDiT**(SD3,Esser, v.v.2024)  hai dòng có quyền xử lý trọng lượng văn bản và biểu tượng, chia sẻ tập trung chú ý.
- **FLUX**(Black Forest Labs, 2024)  đầu tiên N khối dòng hai như SD3, sau đó khối kết nối và chia sẻ trọng lượng (nguyên dòng duy nhất) để hiệu quả ở độ sâu cao hơn.
  Trung ngữ翻译:**FLUX**(Black Forest Labs,2024) 前 N 个块像 SD3 一样双流,后续块拼接并共享权重(单流) để nâng cao hiệu quả của tầng sâu。
- **Z-Image**(2025)  DiT đơn dòng hiệu quả ở các tham số 6B thách thức "tăng bằng mọi chi phí".
  Trung ngữ翻译:**Z-Image**(2025) 60 tỷ tham số cao hiệu quả đơn dòng DiT, thách thức "không tính chi phí mở rộng" của tư tưởng.
...
> DDPM sẽ định nghĩa quá trình tiến tới như tiếng ồn随机微分方程 (SDE), trong đó có:`x_t`渐渐被损坏──学习到的反向是第二个SDE,通过1000小步求解──

Phong trào được sửa chữa xác định một **straight-line**sự phân cực giữa dữ liệu sạch và tiếng ồn sạch:

> 整流定义 giữa dữ liệu sạch và âm thanh tinh khiết**直线**插值:
...
> 训练网络预测速度 `v_theta(x_t, t) = epsilon - x_0` Từ khô thông tin đến tiếng ồn hướng về phía trước`dx_t/dt`()  khi lấy, tốc độ ngược chiều积分 này từ tiếng ồn hướng đến dữ liệu nhận được ODE gần hơn thẳng đường, do đó, lượng bước tích cần thiết giảm rất nhiều
...
> SD3 sẽ được gọi là**整流流匹配** FLUX、Z-Image 和大多数 2026 年模型使用相同目标──典型推理:20-30 步 Euler(确定性)vs 旧 DDPM 方案的50+ 步 DDIM──蒸/turbo/schnell/LCM 变体降至1-4 步──
...
> DT  thông qua**自适应层归一化**Để điều kiện hóa các bước thời gian và các loại / văn bản: từ điều kiện`scale`和 `shift`, trong LayerNorm 后应用──比 U-Net FiLM 风格调制更干净, là các tùy chọn mặc định của mỗi hiện đại DiT──
...
> DDPM + U-Net 可行──DiT + 整流流**更好、更快、扩展更干净**Sự chuyển đổi này tương tự như chuyển đổi từ RNN sang Transformer trong NLP: hai cấu trúc đều giải quyết được vấn đề tương tự, nhưng Transformer còn có khả năng mở rộng và cuối cùng là chủ yếu.
