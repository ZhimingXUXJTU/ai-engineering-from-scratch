# Phân tích ngữ nghĩa  U-Net 语义分割  U-Net
...
> **【中文解读】**语义分割就是分类每个像素. U-Net 通过配对下采样编码器和上采样解码器, và kết nối nhảy nối giữa chúng để đạt được điều này.

> **【拓展：U-Net 的广泛应用】**U-Net ban đầu được thiết kế để phân chia hình ảnh y tế, nhưng đã trở thành cơ sở hạ tầng của nhiều lĩnh vực: Stable Diffusion Sử dụng U-Net như một mạng lưới không gây nhiễu trung tâm, phân chia đường trong tự lái, phủ diện đất của hình ảnh vệ tinh.
...
> 分类 mỗi张图像输出一个标签――检测 mỗi张图像输出几个框―― chia từng像素输出一个标签―― đối với kích thước nhỏ`H x W`                                                                                                                                                                                                                                                              `H x W`(语义) hoặc `H x W x N_instances`(ví dụ) của 张量── đó là mỗi 张图数百万预测, chứ không phải là một ‖

> **【中文解读】**Các phân loại xuất ra một nhãn, kiểm tra xuất ra một số khung, chia ra các sản phẩm của mỗi hình ảnh nhãn. Vấn đề cốt lõi của phân chia là: vừa phải nhìn thấy toàn cảnh trên các hình ảnh bên dưới, vừa phải giữ lại các chi tiết của các hình ảnh bên ngoài.
...
> Căn cấu phân là nguyên nhân thúc đẩy hầu hết các sản phẩm trực quan dự đoán dày đặc: hình ảnh y học (tương tự lái)  đường, đường, đường, rào cản (tương tự lái)  vệ tinh (tương tự lái)  đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường, đường,
...
> Ưu điểm của cấu trúc nói lên đơn giản nhưng giải quyết không đơn giản: bạn cần mạng để xem toàn cảnh của hình ảnh cùng một lúc.
...
- **Semantic**"Đây là đường, đó là xe". Hai xe cạnh nhau sụp đổ thành một khối.
  Trung ngữ翻译:语义分割说"这个像素是路,那个像素是车"―― hai xe lân cận được hợp nhất thành một khu vực――
- **Instance**nói "đây là xe #3, đó là xe #5. " Không quan tâm đến các thứ nền ("thông" = bầu trời, đường, cỏ).
  Trung文翻译:实例分割说"这个像素是第三辆车,那个像素是第五辆车"──忽略背景类别("stuff" = 天空、道路、草地)──
- **Panoptic**kết hợp cả hai: mỗi pixel nhận được một nhãn lớp, mỗi instance nhận được một ID độc đáo, thứ và thứ cả hai được phân đoạn.
  Trung ngữ翻译:全景分割统一了两者:每个像素获得类别标签,每个实例获得唯一ID,背景和前景物体都被分割──
