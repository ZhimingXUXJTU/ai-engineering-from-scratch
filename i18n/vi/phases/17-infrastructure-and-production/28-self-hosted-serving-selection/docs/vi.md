# Chọn dịch vụ tự chủ  llama.cpp, Ollama, TGI, vLLM, SGLang ‬ 自托管 选择 服务 SGLang vLLM
...
> **【中文解读】**Bài viết này giới thiệu về các khuôn khổ tự quản lý và lựa chọn dịch vụ.
...
>  **【前置】**本节是阶段17 收官课,整合 04/06/07/09/18 的引擎知识 四大自托管引擎选型矩阵 四大自托管引擎选型矩阵 四大自托管引擎选型矩阵 四大自托管引擎选型矩阵 四大自托管引擎选型矩阵 四大自托管引擎选型矩阵 四大自托管引擎选型矩阵 四个自托管引擎的
>  **【类比】**Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng: Ứng dụng:
> 🤔 **【困惑】**Q: 我的场景该选哪个? chỉ có CPU→llama.cpp;AMD/非 NVIDIA→vLLM(TRT-LLM 锁 NVIDIA);Agent 多轮→SGLang;通用→vLLM。2026 流水线:dev=Ollama、staging=llama.cpp、prod=vLLM/SGLang,全用 GGUF/HF 权重一致。
...
- Chọn một công cụ phần cứng (CPU / AMD / NVIDIA Hopper / Blackwell), quy mô (1 người dùng / 100 / 10,000), và tải trọng công việc (chăm thoại chung / đại lý / ngữ cảnh dài).
  Trung文翻译:给定硬件 ((CPU/AMD/NVIDIA Hopper/Blackwell) ), quy mô và tải trọng chọn máy.
- Hãy nêu tên tình trạng chế độ bảo trì TGI 2026 (11 tháng 12 năm 2025) và lý do tại sao nó hướng các dự án mới về vLLM hoặc SGLang.
  Trung文翻译:说出 2026 年 TGI 维护模式状态(2025 年 12 月 11 日) 以及它为什么影响使用 HuggingFace 默认设置的团队──
- Mô tả đường ống phát triển/phân đoạn/phân đoạn sử dụng cùng một trọng lượng GGUF hoặc HF trên toàn bộ.
  Trung ngữ翻译: mô tả sử dụng cùng một GGUF hoặc HF trong suốt vòng đời 权重的开发/预发布/生产流水线。
- Giải thích tại sao "chỉ CPU" buộc llama.cpp và "AMD" loại trừ TRT-LLM.
  Trung ngữ翻译:解释为什么" chỉ CPU"强制使用 llama.cpp,而"AMD" loại trừ TRT-LLM。

## Vấn đề  vấn đề giới thiệu

> **【中文解读】**Sự lựa chọn của động cơ phân tích phụ thuộc vào ba chiều: Hardware: CPU / AMD / NVIDIA Hopper / Blackwell) √ quy mô: 1 người dùng / 100 / 10,000) √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ √ 
...
> **【拓展：2026 年推理引擎选择决策】**2026 年推理引擎的硬件优先决策树:(1) chỉ có CPU → llama.cpp(唯一有竞争力的选项);(2) AMD GPU → vLLM(ROCm 支持),TRT-LLM 不支持 AMD;(3) NVIDIA Hopper → vLLM 或 SGLang 或 TRT-LLM(三选一);(4) NVIDIA Blackwell → TRT-LLM 吞吐最高;(5) Apple Silicon → llama.cpp(Metal 后端) △ quy mô决策:1 用户→Ollama,10-100→LLM 单,100-10K→LLM sản xuất-stack 或 SangGL,10K+→ sản xuất-stack + 分离式 + LMC。
...
> **【中文解读】**TGI 陷:HuggingFace TGI vào năm 2025 vào ngày 11 tháng 12 vào trong mô hình bảo trì chỉ sửa lỗi, không còn có chức năng cập nhật. Trong lịch sử TGI có mức độ có thể nhìn thấy và HF sinh thái tích hợp.

> **【拓展：工作负载驱动的引擎选择】**工作负载维度驱动引擎选择:(1) 通用聊天/问答 → vLLM(广泛默认);(2) Agent 多轮对话(工具、规划、记忆)→ SGLang RadixAttention 主导;(3) RAG 重前复用 → SGLang;(4) 代码生成 → vLLM 足够,SGLang 缓存略好;(5) 长上下文(128K+)→ vLLM + 分块预填充,SGLang + 分层 KV──Ollama 适合开发但不是生产共享服务的理想选择Go HTTP 序列化增加开销并发行比 vLLM 简单、Openmetry 支持滞后.
...
> **【拓展：自托管 vs 托管的决策】**Bản quản lý và quản lý là quyết định độc lập. Lý do của tự quản lý: 1) 数据驻留数据不能离开组织; 2) tự定义微调LoRA/QLoRA 适配器需要本地部署; 3) Tổng quy mô có chi phí quản lý hơn 5 triệu đô la mỗi năm khi tự quản lý thường kinh tế hơn; 4) mô hình lĩnh vực không có sẵn trên nền tảng quản lý.
...
> 本课产 出 `outputs/skill-engine-picker.md`Với những hạn chế, anh ta chọn một động cơ và viết kế hoạch di cư.

## Tập luyện bài tập

1. Đi chạy`code/main.py`với phần cứng / quy mô / tải công việc của bạn.
   Trung文翻译:用你的硬件/规模/工作负载运行 `code/main.py`◊ Xuất khẩu có phù hợp với dự kiến không?
2. Bộ phận hạ tầng của anh là 12 H100 và 8 MI300X AMD.
   Trung ngữ翻译: Your infrastructure is 12块 H100 và 8块 MI300X AMD。 dùng động cơ gì? Tại sao TRT-LLM không thể chọn?
3. Một nhóm muốn sử dụng TGI vào năm 2026 bởi vì "đó là những gì chúng ta biết".
   Một nhóm người nghĩ đến sử dụng TGI vào năm 2026 bởi vì "Đây là những gì chúng tôi quen thuộc".
4. Ollama dev to vLLM prod: những thay đổi nào trong định lượng, cấu hình và khả năng quan sát?
   Trung ngữ翻译:Ollama 开发到vLLM 生产:量化,配置和可观测性有什么变化?
