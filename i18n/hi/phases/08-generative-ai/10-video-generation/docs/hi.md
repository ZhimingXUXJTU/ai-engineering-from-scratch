...
> **【中文解读】**图像是2D 张量,视频是3D 张量,理论相同但计算量高10-100倍──Sora 证明可行, 2026 तक कई व्यावसायिक उत्पाद(Veo 2、Kling、Runway) 1080p उत्पन्न करने में सक्षम है 视频──

> **【拓展：Sora 的影响】**ओपनएआई का सोरा (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI का सोरा) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (OpenAI) (Opening)) (Opening)) (OpenAI) (Opening)) (Open) (Open) (Open) (Open) (Open) (Open) (Open) (Open) _ Open) (Open) _ Open) (Open) _ Open) (Open) _ Open) (Open) _ Open) _ Open) _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
> 10 सेकंड 1080p 24fps  वीडियो 频频是 240  1920×1080×3 像素, लगभग 1.5 GB 原始数据──像素空间扩散不可行──你需要:

1. **Spatiotemporal compression.**एक VAE जो वीडियो को कोड करता है, फ्रेम नहीं, अंतरिक्ष-समय पैच के अनुक्रम में।
   **时空压缩。**将视频(而非) को समय空补丁序列 के लिए编码为时空补丁序列的 VAE──
2. **Temporal coherence.**फ्रेम को सामग्री, प्रकाश व्यवस्था और वस्तु पहचान को सेकंड में साझा करना चाहिए। नेट को गति का मॉडल बनाना चाहिए।
   **时间连贯性。** बीच में सामग्री साझा करने की आवश्यकता  प्रकाश और वस्तु के रूप में
...
>  हल इन की संरचना है**Diffusion Transformer (DiT)** समय-अकाश पैच, बड़े पैमाने पर डेटासेट पर प्रशिक्षण हेतु प्रयोग किया जाता है 
...
> 3D VAE 编码视频──潜在表示形状为 `[T, H, W, C]`│ 切分为 │`[t_p, h_p, w_p]`10 सेकंड 1080p वीडियो संपीड़न के लिए लगभग 2-100,000 पैचों
...
> ट्रांसफार्मर 处理展平的补丁 序列── प्रत्येक补丁有3D 位置编码(时间 + y + x)──注意力通常分解为:

- **Spatial attention**प्रत्येक फ्रेम के पैच के भीतर।
  **空间注意力**में प्रत्येक के पैच में
- **Temporal attention**एक ही स्थान पर फ्रेम के पार।
  **时间注意力**跨 के समान अंतरिक्ष स्थान──
- **Full 3D attention**16-100 गुना अधिक महंगा है; केवल कम रिज़ॉल्यूशन या अनुसंधान में इस्तेमाल किया जाता है।
  **完整 3D 注意力** 16-100 गुना; केवल कम रिज़ॉल्यूशन या अध्ययन में उपयोग में

> **【中文解读】**视频生成的核心技术:(1) 3D VAE 将视频压缩为时空潜在表示;(2) 将潜在表示切分为时空补丁;(3) DiT(Diffusion Transformer) 3D 位置编码 का उपयोग करके पैच 序列 को संसाधित करने के लिए;(4) ध्यान आमतौर पर अंतरिक्ष ध्यान और समय ध्यान में विभाजित किया जाता है ताकि कम गणना मात्रा हो सके।

> **【拓展：Sora 架构与 DiT 在视频中的应用】**सोरा का मूल उद्देश्य वीटी के पैचकरण के विचार का विस्तार वीडियो क्षेत्र में करना है। वीडियो वीडियो "टाइम空 पैच 序列" के रूप में देखा जाएगा।
...
> बड़े ग्रंथ संपादक के साथ अंतर ध्यान करना।
...
## 2026 उत्पादन परिदृश्य 2026 उत्पादन की शैली
...
> खुले स्रोत के भार से छवियों के क्षेत्र में अधिक तेजी से अंतर कम हो रहा है
...
> 质量平价下 प्रति सेकंड वीडियो लागत में 2024 से 2026 के बीच 20 गुना की कमी आई है।
