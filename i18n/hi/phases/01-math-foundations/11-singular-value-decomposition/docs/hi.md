# अद्वितीय मूल्य विघटन .

> SVD रैखिक बीजगणित की स्विस सेना की चाकू है. हर मैट्रिक्स में एक है. हर डेटा वैज्ञानिक को एक की जरूरत है.
> एसवीडी रैखिक संख्याओं का एक "रिज़िशियन सैन्य चाकू" है। प्रत्येक रैक में एक है। प्रत्येक डेटा वैज्ञानिक को एक की आवश्यकता है।
...
- पावर पुनरावृत्ति के माध्यम से एसवीडी को लागू करें और यू, सिग्मा और वी ^ टी के ज्यामितीय अर्थ की व्याख्या करें
  代实现 SVD, व्याख्या U、Sigma 和 V^T के几何含义
- छवि संपीड़न के लिए ट्रंक एसवीडी लागू करें और संपीड़न अनुपात बनाम पुनर्निर्माण त्रुटि मापें
   अनुप्रयोग कटौती SVD  छवि संपीड़न, पुनः निर्माण त्रुटि के साथ माप संपीड़न
- अधिक निर्धारित न्यूनतम वर्गों प्रणाली को हल करने के लिए एसवीडी के माध्यम से मूर-पेनरोज के छद्म उलट गणना
  SVD के माध्यम से  गणना मूर-पेनरोज 伪逆来求解超定最小二乘系统
- एसवीडी को पीसीए, सिफारिश प्रणाली (लैटिनेंट फैक्टर) और एनएलपी में लैटिनेंट सेमैन्टिक विश्लेषण से जोड़ें
  एसवीडी को पीसीए 推系统 (अवशिष्ट कारक) और एनएलपी में संभावित अर्थ विश्लेषण से जोड़ना

> **【中文解读】**
> SVD है रैखिक संकेतक के "瑞士军刀" किसी भी矩阵都可分解为U * Sigma * V^T──截断 SVD को संपीड़ित किया जा सकता है छवि, उपयोगकर्ता-电影评分矩阵 के SVD को छिपे हुए कारक (SVD) के केंद्र में पाया जा सकता है),文档-词频矩阵 के SVD को विषय (LSA) में पाया जा सकता है।

> **【拓展：SVD 在 AI 中的位置】**
> - **推荐系统**: नेटफ्लिक्स ऑपरेशन का विजेता समाधान उपयोगकर्ता-वस्तु रेटिंग रैक के SVD विभाजन है
> - **图像压缩**: 截断SVD केवल अधिकतम कुछ विभेदक मानों को बनाए रखता है, जिससे बहुत कम डेटा के साथ निकटतम छवि को पुनर्प्राप्त किया जा सकता है।
> - **LSA (潜在语义分析)**: एनएलपी में सबसे पहले थीम मॉडल विधि, पर文档-词矩阵做 SVD 发现隐含主题──

## समस्या  समस्या परिचय

> **【中文解读】**आपके पास 1000×2000 का एक रैंक है। यह रैंक को तीन तत्वों में विभाजित करता है।

शायद यह उपयोगकर्ता-फिल्म रेटिंग है. शायद यह एक दस्तावेज-अवधि आवृत्ति तालिका है. शायद यह एक छवि के पिक्सेल मान हैं. आपको इसे संपीड़ित करने, इसे निरस्त करने, इसमें छिपी संरचना खोजने, या इसके साथ न्यूनतम वर्गों की प्रणाली को हल करने की आवश्यकता है। Eigendecomposition केवल वर्ग मैट्रिक्स पर काम करता है। फिर भी, यह मैट्रिक्स के लिए आवश्यक है रैखिक रूप से स्वतंत्र स्ववेक्टरों का एक पूरा सेट है।
> शायद यह उपयोगकर्ता-फिल्म रेटिंग है, शायद यह दस्तावेज़-शब्द आवृत्ति है, शायद यह छवि चित्र है। आपको इसे संपीड़ित करने की आवश्यकता है, शोर निकालने की आवश्यकता है, छिपे हुए संरचना को खोजने की आवश्यकता है, या इसके साथ न्यूनतम दो गुणा का पता लगाने की आवश्यकता है।
...
> SVD किसी भी रचने के लिए उपयुक्त है। किसी भी आकार, किसी भी क्रम, बिना शर्त के। यह रचने को तीन तत्वों में विभाजित करेगा, यह पता चलता है कि रचने के लिए अंतरिक्ष क्या किया है। यह रैखिक तत्वों में सबसे सामान्य है।

## अवधारणा का मूल अवधारणा

> **【拓展：SVD 是 LoRA 的数学根基】**LoRA 微调的核心假设:权重更新矩阵 ΔW 是低排的──SVD 告诉我们, किसी भी矩阵 को U·Σ·V^T में विभाजित किया जा सकता है, जिसमें Σ के बीच का अजीब मान बड़े आकार के क्रम में हो──LoRA केवल अधिकतम k 个奇值对应的分量 (~range-k近似) को बरकरार रखता है, पैरामीटर mn 减少到 k m+n)── यह SVD का सिद्धांत से अनुप्रयोग में प्रत्यक्ष परिवर्तन है──

### SVD के ज्यामितीय अर्थ

प्रत्येक मैट्रिक्स, आकार के बावजूद, क्रमशः तीन ऑपरेशन करता हैः घूमना, पैमाने, घूमना। एसवीडी इस विघटन को स्पष्ट बनाता है।
> प्रत्येक रक्शा, चाहे वह किस प्रकार का हो, क्रमशः तीन ऑपरेशन निष्पादित करता हैः घूर्णन, संकुचन, घूर्णन।
...
- प्रत्येक अक्ष के साथ सिग्मा स्केल (ट्रेच या कंप्रेसेस)
  सिग्मा 沿 प्रत्येक अक्ष संकुचित (拉伸或压缩)
...
> 想像一下: आप SVD को矩阵 सौंपते हैं, यह आपको बताता हैः "यह矩阵 एक समूह गेंद का प्रवेश प्राप्त करता है, पहले V^T 旋转, फिर से सिग्मा 拉伸成球, फिर से यू 旋转球──"अद्भुत मूल्य है 球各轴的长度──"
...
> U की पंक्तियों को बाईं ओर की अनूठी तरंग, V की पंक्तियों को दाईं ओर की अनूठी तरंग, सिग्मा के कोण रेखा तत्वों को अनूठी मूल्य कहा जाता है।

### बाएं एकल वेक्टर, एकल मान, दाएं एकल वेक्टर

एसवीडी के प्रत्येक घटक का एक विशिष्ट ज्यामितीय अर्थ होता है।
> एसवीडी के प्रत्येक भाग का एक विशिष्ट ज्यामितीय अर्थ होता है।
...
> **右奇异向量（V 的列）：**构成输入空间 (R^n) के सही交基──它们是输入空间中矩阵映射到输出空间正交方向的方向──
...
> **奇异值（Sigma 的对角线）：**缩放因子──第 i 个奇异值告诉你矩阵沿着第 i 个右奇异向量方向拉伸多少──奇异值为零意味着矩阵完全压了该方向──
...
> **左奇异向量（U 的列）：**构成输出空间 (R^m) के正交基──第 i 个左奇异向量是第 i个右奇异向量(缩放后)落在输出空间中的方向──
...
> यह आपको किसी भी रैंकिंग ऑपरेशन के प्रतिबिंब प्रदान करता है।

### बाहरी उत्पाद रूप

एसवीडी को रैंक-1 मैट्रिक्स के योग के रूप में लिखा जा सकता हैः
> SVD को क्रम-1 में लिखा जा सकता हैः
...
> इस प्रकार निम्न क्रम निकटता का आधार है। प्रत्येक अतिरिक्त एक स्तर संरचना है। पहला सबसे महत्वपूर्ण मॉडल को पकड़ता है, दूसरा सबसे महत्वपूर्ण मॉडल को पकड़ता है। इस प्रकार के सुझावों के आधार पर, यह और प्रत्येक क्रमबद्ध क्रम में सर्वोत्तम निकटता प्रदान करता है।
...
### अपने स्वयं के संरचना के साथ संबंध और गुणों के विघटन के संबंध

SVD और eigendecomposition गहरे संबंध में हैं। A के सिंगलर मान और वेक्टर सीधे A^T A और A^T के स्वमान और स्वमान से आते हैं।
> SVD तथा विशेषता मूल्य गहराई से संबंधित है। ए का विस्मय मूल्य एवं वेटमेंट सीधे ए^टी ए तथा ए^टी के विशेषता मूल्य एवं विशेषता वेटमेंट से आता है।
...
2. आप एटी ए के अपने स्वयं के संयोजन के माध्यम से एसवीडी की गणना कर सकते हैं, लेकिन यह स्थिति संख्या को वर्ग करता है और संख्यात्मक सटीकता खो देता है। समर्पित एसवीडी एल्गोरिदम इससे बचते हैं।
   ए^टी ए के गुण मूल्य को घटाने के माध्यम से एसवीडी की गणना की जा सकती है, लेकिन यह वर्ग शर्त संख्या, हानि संख्या मूल्य सटीकता है।
3. जब A वर्ग और सममित सकारात्मक अर्ध-परिभाषित है, तो SVD और eigendecomposition एक ही बात है।
   जब ए है, तो आभास और आभास के लिए सही आधे निश्चित समय, एसवीडी और विशेषता मूल्य विघटन एक ही बात है।

### कम रैंक अनुमानित SVD: कम रैंक अनुमानित
...
> इकार्ट-युंग-मिरस्की 定理指出,A के सर्वोत्तम क्रम-क 近似(在 Frobenius 和谱范数下) केवल पहले के 个奇值 और उसके लिए应向量 प्राप्त करने के माध्यम सेः
...
> यह सिर्फ एक "अच्छा" निकटता नहीं है। यह एक उत्कृष्ट निकटता है।
...
> यदि विस्मयकारी मूल्य तेजी से घटता है, तो छोटा के के द्वारा अधिकांश रैंकों को पकड़ना संभव है।

### SVD के साथ छवि संपीड़न SVD संपीड़न छवि के साथ
...
> 灰度图像是像素强度矩阵──800x600 के चित्रों में 480,000 个值──SVD का उपयोग इससे बहुत कम मूल्य के साथ किया जा सकता है।
...
> 关键洞见: प्राकृतिक छवियों के विचित्र मूल्य तेजी से घटते हैं, पहले कुछ विचित्र मूल्य में एक विशाल संरचना को पकड़ते हैं, बाद में विवरण और शोर को पकड़ते हैं, 50 में कटौती आमतौर पर मूल चित्र के समान ही छवियों का उत्पादन करती है, जबकि 85% भंडारण को बचाती है।

### सिफारिश प्रणाली के लिए एसवीडी एसवीडी के लिए सिफारिश प्रणाली
...
> नेटफ्लिक्स 竞赛使之出名──你有一个大部分条目缺失的用户电影评分矩阵──
...
> 核心思想:评分矩阵是低排的──用户的品味并非完全独立──存在少数隐因子──动作vs文艺、老片vs新片)

(भरी) रेटिंग मैट्रिक्स पर एसवीडी इसे निम्न में विघटित करता हैः
> के लिए) मूल्यांकन रक्छाँ करने के लिए SVD 分解为:

- यूः लटेंट फैक्टर स्पेस में उपयोगकर्ता प्रोफाइल / 隐因子空间中的用户画像
- सिग्मा: प्रत्येक लटेंट कारक का महत्व / प्रत्येक隐因子 का महत्व
- V^T: लटेंट फैक्टर स्पेस में फिल्म प्रोफाइल / 隐因子空间中的电影画像
...
> उपयोगकर्ता के लिए फिल्म का पूर्वानुमान रेटिंग है उसके उपयोगकर्ता छवि और फिल्म छवि के बिंदुओं की संख्या (((加权奇异值) ▽低排近似填充缺失条目──

### एनएलपी में एसवीडीः लातेंट सेमेटिक एनालिसिस
...
> LSA मूल ग्रंथों से भाषाई समानता को पकड़ने के सबसे पहले सफल तरीकों में से एक है। यह प्रभावी है क्योंकि समानार्थी शब्द अक्सर समान ग्रंथों में दिखाई देते हैं, एसवीडी उन्हें एक ही गुप्त आयाम में वर्गीकृत करेगा। आधुनिक शब्द में सम्मिलित होने वाले शब्द (Word2Vec、GloVe) इस विचार के बाद के लिए दृश्यमान हैं।

### शोर को कम करने के लिए एसवीडी।

शोर डेटा में सिग्नल शीर्ष एकल मानों में केंद्रित है और शोर सभी एकल मानों में फैलता है। ट्रंकटिंग शोर तल को हटा देता है।
> शोर डेटा में संकेत शीर्ष पर अजीब मान पर केंद्रित है, शोर सभी अजीब मानों में विखरा है।
...
> यह संकेत प्रसंस्करण, वैज्ञानिक माप और डेटा सफाई के लिए प्रयोग किया जाता है। जब तक आपके पास अतिरिक्त शोर प्रदूषण वाली मैट्रिक्स हैं, तब तक SVD का काटना एक सिद्धांतवादी संकेत और शोर से अलग करने का तरीका है।

### SVD के माध्यम से Pseudoinverse
...
> मूर-पेनरोज 伪逆 A+ 将矩阵求逆推广到非方阵和奇异矩阵──SVD 使计算变得简单──
...
> 伪逆求解最小二乘解问题── यदि Ax = b 没有精确解(超定系统),则 x = A+ b 是最小二乘解──

### संख्यात्मक स्थिरता लाभ संख्यात्मक स्थिरता लाभ
...
> आधुनिक एसवीडी 算法 सीधे ए 操作 पर, नहीं बनाता ए^टी ए। यही कारण है कि इसे हमेशा इस्तेमाल किया जाना चाहिए।`np.linalg.svd(A)`और `np.linalg.eig(A.T @ A)`

### पीसीए से संपर्क करें

यह एक समानता नहीं है, यह सचमुच एक ही गणना है।
> पीसीए यानि केंद्रीकृत डेटा के लिए एसवीडी करना है। यह एक प्रकार की गणना नहीं है, यह पूरी तरह से एक ही गणना है।
...
> इसका मतलब है कि पाठ 10 में आप सीखते हुए सामग्री को कम करने का मूल स्तर एसवीडी है। पीसीए मशीन सीखने में एसवीडी का सबसे आम अनुप्रयोग है।
...
### चरण 1: बिजली पुनरावृत्ति का उपयोग करके स्क्रू से SVD
...
> सोचः 代在 A^T A 上上找最大奇异值及其向量,然后收缩矩阵,重复找下一个奇异值──
...
### चरण 2: परीक्षण और NumPy के साथ तुलना करें.
...
### चरण 3: छवि संपीड़न डेमो चरण 3: छवि संपीड़न प्रदर्शन
...
> 完整可运行的演示在 `code/svd.py`中──运行 यह SVD को देखने के लिए उपयोग किया जाता है छवि संपीड़न、推系统、潜在语义分析和降噪──
...
> `code/svd.jl`中的 जुलिया 版本使用 जुलिया 原生 `svd()`函数和 `LinearAlgebra`包演示相同概念──
...
- `outputs/skill-svd.md`- वास्तविक परियोजनाओं में एसवीडी को कब और कैसे लागू किया जाए, यह जानने की क्षमता
  वास्तविक परियोजनाओं में एसवीडी का कौशल दस्तावेज कैसे और कैसे लागू किया जाए
...
1. पावर इटरेशन का उपयोग किए बिना स्क्रैच से पूर्ण एसवीडी को लागू करें। इसके बजाय, वी और एकल मान प्राप्त करने के लिए एटी ए की स्वयं संरचना की गणना करें, फिर U = A V सिग्मा^{-1} की गणना करें। अपने पावर इटरेशन संस्करण और नंबरपी के साथ संख्यात्मक सटीकता की तुलना करें।
   代用从零实现完整SVD──改为计算A^T A के लक्षण मूल्य विघटन प्राप्त करने के लिए V 和奇异值,然后计算U = A V Sigma^{-1}──比较数值精度──
...
2. एक वास्तविक ग्रेस्केल छवि लोड करें (या इसे ग्रेस्केल में परिवर्तित करें) इसे रैंक 1, 5, 10, 25, 50, 100 पर संपीड़ित करें। प्रत्येक रैंक के लिए संपीड़न अनुपात और सापेक्ष त्रुटि की गणना करें। उस रैंक को खोजें जहां छवि दृश्य रूप से स्वीकार्य हो जाती है।
   एक वास्तविक ग्रेड छवि को लोड करें। 1、5、10、25、50、100 संपीड़न का उपयोग करके प्रत्येक क्रम के संपीड़न अनुपात और सापेक्ष त्रुटि का गणना करें।

3. एक छोटी सी सिफारिश प्रणाली बनाएं। कुछ ज्ञात प्रविष्टियों के साथ 10x8 उपयोगकर्ता-फिल्म रेटिंग मैट्रिक्स बनाएं। पंक्ति के माध्यम से यादृच्छिक प्रविष्टियों को भरें। एसवीडी की गणना करें और रैंक-3 अनुमान को पुनर्निर्माण करें। यादृच्छिक रेटिंग का अनुमान लगाने के लिए पुनर्निर्माण मैट्रिक्स का उपयोग करें।
...
4. 3 सिंथेटिक विषयों के साथ 100x50 दस्तावेज़-अवधि मैट्रिक्स बनाएं। प्रत्येक विषय में 5 संबद्ध शब्द हैं। शोर जोड़ें। एसवीडी लागू करें और सत्यापित करें कि शीर्ष 3 एकल मान बाकी से बहुत बड़े हैं। 3 डी लटेंट स्थान में दस्तावेज़ों का प्रोजेक्ट करें और जांचें कि एक ही विषय क्लस्टर से दस्तावेज एक साथ हैं।
   创建一个有3个合成主题的100x50 文档词矩阵──每个主题有5个关联词──加噪声──应用 SVD 验证前3个奇异值远大于其余的──

5. एक स्वच्छ निम्न-रैंक मैट्रिक्स (रैंक 3, आकार 50x40) उत्पन्न करें और विभिन्न स्तरों (सिग्मा = 0.1, 0.5, 1.0, 2.0) पर गौशियन शोर जोड़ें। प्रत्येक शोर स्तर के लिए, 1 से 40 तक के द्वारा परिमार्जन करके और स्वच्छ मैट्रिक्स के खिलाफ पुनर्निर्माण त्रुटि को मापकर इष्टतम ट्रंकशन रैंक खोजें।
   生成干净的排列-3 矩阵(50x40),加不同级别的高高噪音── प्रत्येक शोर级别,扫描 के माध्यम से सबसे अच्छा कटौती के क्रम में से एक को खोजने के लिए।
...
- [Gilbert Strang: Linear Algebra and Its Applications, Chapter 7](https://math.mit.edu/~gs/linearalgebra/)- एसवीडी के लिए आवेदनों के साथ गहन उपचार
  एसवीडी का पूर्ण प्रसंस्करण एवं अनुप्रयोग
...
- [We Recommend a Singular Value Decomposition](https://www.ams.org/publicoutreach/feature-column/fcarc-svd)- अमेरिकन मैथमेटिकल सोसाइटी से उपलब्ध अवलोकन
  एएमएस के एसवीडी में प्रवेश विवरण
- [Netflix Prize and Matrix Factorization](https://sifter.org/~simon/journal/20061211.html)- सिफारिशों के लिए एसवीडी पर साइमन फंक की मूल ब्लॉग पोस्ट
  साइमन फंक  ABOUT SVD 推 के मूल ब्लॉग
- [Latent Semantic Analysis](https://en.wikipedia.org/wiki/Latent_semantic_analysis)- एसवीडी के मूल एनएलपी अनुप्रयोग
  एनएलपी में एसवीडी का मूल अनुप्रयोग
- [Numerical Linear Algebra by Trefethen and Bau](https://people.maths.ox.ac.uk/trefethen/text.html)- एसवीडी एल्गोरिदम को समझने के लिए स्वर्ण मानक
  एसवीडी 算法的 स्वर्ण मानक को समझना
