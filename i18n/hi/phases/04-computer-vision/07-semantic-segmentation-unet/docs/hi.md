# अर्थशास्त्र विभाजन  यू-नेट  भाषाई विभाजन  यू-नेट

> U-Net इसे एक डाउनसैम्पलिंग एन्कोडर को अपसैम्पलिंग डिकोडर के साथ जोड़े और उनके बीच के कनेक्शन को सिंक करने से काम करता है।

> **【中文解读】**语义分割就是 प्रत्येक प्रतिबिंब पर विभाजन करना। यू-नेट 通过配对下采样编码器和上采样解码器,并连接它们之间跳跃连接实现这一点.

> **【拓展：U-Net 的广泛应用】**यू-नेट मूल रूप से चिकित्सा छवि विभाजन डिजाइन के लिए था, लेकिन कई क्षेत्रों में बुनियादी ढांचे में बदल गया हैः स्थिर प्रसार यू-नेट का उपयोग करना  के रूप में केंद्रीय शोर निकालने नेटवर्क  ऑटोमोटिव ड्राइविंग में सड़क विभाजन  सैटेलाइट छवियों के भूमि कवर 分类 
...
> 分类每张图像输出一个标签――检测每张图像输出几个框――分分每像素输出一个标签――对于大小为`H x W`                                                                                                                                                                                                                                                              `H x W`(语义) या `H x W x N_instances`(उदाहरण) के 张量──那是每张图像数百万预测,而不是一个──

> **【中文解读】**विभाजन की मूल समस्या यह है कि एक टैग को आउटपुट करें, एक टैग को आउटपुट करें, एक टैग को आउटपुट करें, एक टैग को आउटपुट करें, एक टैग को आउटपुट करें, एक टैग को आउटपुट करें।
...
> विभाजन की संरचना लगभग सभी गहन भविष्यवाणी विजन उत्पादों को संचालित करने के कारण हैः चिकित्सा छवि (瘤掩码) 自动驾驶 (道路,车道,障碍) 卫星 (建筑轮,作物边界) 文档解析 (布局区域) 机器人 (机器人) 可抓取区域)  ये कार्य वस्तु के आसपास के चित्र के फ्रेम में पारित नहीं किए जा सकते हैं; उन्हें सटीक रूपरेखा की आवश्यकता है
...
> 架构问题说起来简单但解决起来不简单:你需要网络同时看图像的全局上下文 (आपको एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही समय में एक ही एक छवि को प्राप्त करते हैं।
...
- **Semantic**यह कहता है "यह पिक्सेल सड़क है, वह पिक्सेल कार है". दो कारें एक दूसरे के बगल में एक ब्लाब में गिर जाते हैं।
  中文翻译:语义分割说" यह विण है मार्ग, वह विण है गाड़ी"── आसन्न दो वाहन एक क्षेत्र में एक साथ जुड़ा हुआ है──
- **Instance**यह कहता है "यह पिक्सेल कार # 3 है, यह पिक्सेल कार # 5 है। " पृष्ठभूमि सामग्री ("सामग्री" = आकाश, सड़क, घास) को अनदेखा करता है।
  中文翻译:实例分割说" यह चित्रण तीसरी गाड़ी है, यह चित्रण पांचवीं गाड़ी है"──忽略背景类别(" Stuff" = 天空、道路、草地)──
- **Panoptic**दोनों को एक करता हैः प्रत्येक पिक्सेल एक वर्ग लेबल मिलता है, प्रत्येक उदाहरण एक अद्वितीय आईडी मिलता है, सामान और सामान दोनों खंडित.
  中文翻译:全景分割统一了两者: प्रत्येक像素获得类别标签, प्रत्येक उदाहरण获得唯一 ID,背景和前景物体都被分割──

यह पाठ अर्थशास्त्र को कवर करता है। अगला पाठ (मास्क आर-सीएनएन) उदाहरण को कवर करता है।

> 本课覆盖语义分割──下一课(मास्क आर-सीएनएन)覆盖实例分割──
