...
> **【中文解读】**आप चौथे वर्ग में शून्य से GPT-2 Small को बनाया है। 2026 साल के अग्रिम खुला स्रोत मॉडल में केवल पांच बदलाव किए गए हैंः RMSNorm  बदलते LayerNorm、SwiGLU  बदलते GELU、RoPE  बदलते सीखने की स्थिति कोडिंग、GQA/MLA  बदलते पूरे ध्यान、 बड़े पैमाने पर MoE── 95% को कवर कर चुके हैं।

> **【拓展：DeepSeek架构】**डीपसेक-वी3 का प्रमुख नवाचारःएमएलए (MLA) 多头潜在注意力,压缩KV-cache) 无助损失的MoE 负载均衡、MTP (MTP) 多代币 预测) 和DualPipe 训练── इन संरचनाओं को समझने का विकल्प 2025-2026 के बड़े मॉडल के विकास दिशा को समझने की कुंजी है──

>  **【前置】**学本节前请先掌握:Phase 10·04(Pre-Training Mini GPT) 理解原始 GPT 架构;Phase 10·05(स्केलिंग);Phase 10·12(इन्फरेंस ऑप्टिमाइजेशन) 理解 KV कैश 才能懂 MLA──本节是后续 15-22 节(架构创新详解) 的概览──

>  **【类比】**देखें 2026 开源模型 = 看不同品牌的电动车──Llama 3 = 特斯拉(务实,GQA + RoPE 标准配置);DeepSeek-V3 = 比亚迪(堆料王,MLA + MoE + MTP + DualPipe 全套);मिश्रण = 大众 ID(MoE 老牌);Qwen = 小(多尺寸覆盖);Gemma = 沃尔沃(精简安全)──底层都是变压器(电动车底盘),差异在 5-6个关键模块──
...
- Llama 3, Mistral, Mixtral, Gemma 2, Qwen 2.5 और DeepSeek-V3 के config.json को पढ़ें और प्रत्येक क्षेत्र की व्याख्या करें
  阅读 Llama 3、Mistral、Mixtral、Gemma 2、Qwen 2.5 和 DeepSeek-V3 का कॉन्फ़िग.json 并解释每个字段
- GPT-2 छोटे के मुकाबले प्रत्येक मॉडल द्वारा किए गए विशिष्ट वास्तुकला परिवर्तन का नाम दें और इसे पहले सिद्धांतों से सही ठहराते हैं
  प्रत्येक मॉडल के संबंध में जीपीटी-2 छोटे के विशिष्ट संरचनात्मक संशोधनों का वर्णन करें, और मूल सिद्धांतों से तर्क करें
- किसी भी खुले मॉडल के लिए गणना पैरामीटर, KV कैश आकार, और सक्रियण स्मृति केवल इसके कॉन्फ़िग से
  केवल विन्यास से किसी भी ओपन सोर्स मॉडल के तत्वों की संख्या गणना करें  KV  कैश आकार और सक्रियण内存
- विलंबता, मेमोरी और क्षमता प्रतिबंधों को देखते हुए एक तैनाती लक्ष्य के लिए सही खुला मॉडल चुनें
  देरी, स्मृति और क्षमता के बंधन के आधार पर, तैनाती के उद्देश्य के लिए उपयुक्त ओपन सोर्स मॉडल चुनें
...
> आपने चौथे वर्ग में 350 पंक्तियों के numpy पर लिखा है GPT-2 के आकार के मॉडल पर। लामा 3 405B में 200 पृष्ठों की तकनीकी रिपोर्ट है। आपका इंटिच्युट आपको बताता है कि वे पूरी तरह से अलग चीजें हैं। वास्तव में नहीं। 200 पृष्ठ एक ही वस्तु का वर्णन करते हैं, केवल 5-6 पूर्ण गतिशील संशोधन, विस्तार के बारे में एक हजार कार्यान्वयन विवरणों के साथ।
...
> इस वर्ग में एक अंतर है। प्रत्येक प्रमुख ओपन सोर्स मॉडल परिवार के लिए, हम जीपीटी-2 के बीच क्या बदला है, क्यों बदला है, कीमत क्या है, इसकी तुलना करते हैं।
...
> 实际收益是: Meta 发布 Llama 5 或 DeepSeek 发布 V4 时,你不需要新的心智模型──你看配置,看哪些已知旋被调整,就知道下游影响是什么──2026年架构是一个有限的工具箱──每个新模型选择不同的子集──

## अवधारणा का मूल अवधारणा

> **【中文解读】**本课对比开源 LLM के वास्तुकला演进:GPT 系列 密集变压器)→ लामा 2/3(RMSNorm、SwiGLU、RoPE、GQA)→ मिस्ट्रल(滑动窗口注意力)→ मिश्रित(MoE 稀疏激活) ◊ समझना इन वास्तुकला अंतरों को चयन योग्य मॉडल का आधार है。

> **【拓展：架构演进的趋势】**2024-2025 के वास्तुकला रुझानःRoPE  घूर्णन स्थिति编码已取代绝对位置编码,GQA(分组查询注意力) KV-cache को कम किया 大小,SwiGLU 替代 ReLU 性能 बढ़ी,RMSNorm 替代 LayerNorm 计算开销️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️️
...
> **【拓展：开源模型的选型指南】**2024-2025 साल खुला स्रोत मॉडल चयन प्रकार: सामान्य वार्तालाप चयन Llama-3-70B, प्रक्षेपण मिशन चयन DeepSeek-R1,代码生成选 DeepSeek-Coder-V2,长上下文选 Qwen-2.5-72B(128K 上下文),轻量级选 Llama-3-8B या Qwen-2.5-7B──
...
> 本课产 出 `outputs/skill-open-model-picker.md`                                                                                                                                                                                                                                                              
...
2. डीपसेक V3 में शीर्ष 8 रूटिंग के साथ 256 विशेषज्ञों का उपयोग किया जाता है। सक्रिय विशेषज्ञों के अनुपात को कुल विशेषज्ञों के बीच गणना करें और Mixtral 8x7B के शीर्ष 2 की तुलना करें। 8. फ्लोप प्रति क्षमता के बारे में घना (25%) से घना दुर्लभ (3%) तक की शिफ्ट क्या है?
   चीनी अनुवादःDeepSeek V3 256 专家前-8 路由──计算激活专家与总专家的比率, Mixtral 8x7B के शीर्ष-2 से 8 तुलना── दुर्लभ से 25% तक अधिक गहन दुर्लभ तक 3% तक प्रति FLOP 容量 में परिवर्तन का क्या अर्थ है?
...
3. FP8 और BF16 में 128k संदर्भ में Llama 3 405B के लिए KV कैश की गणना करें। FP8 में यह BF16 संख्या का आधा है। आप एक एकल 8xH100 नोड पर कितने समानांतर अनुक्रमों को सेवा दे सकते हैं (80GB प्रत्येक = 640GB कुल, वज़न स्मृति को घटाकर)?
   中文翻译:计算 Llama 3 405B 在 128K 上下文下 FP8 和 BF16 के KV 缓存──FP8 BF16 का एक आधा है──单个8xH100 节点(每张 80GB = 总共 640GB,减权重内存)能服务多少并行序列?
...
4. जेम्मा 2 पूर्ण ध्यान और स्लाइडिंग विंडो-अटेंशन परतों का आदान-प्रदान करता है। केवी कैश के लिए गणित लिखें जब आधे परतें पूर्ण संदर्भ के बजाय 4096 टोकन स्लाइडिंग विंडो का उपयोग करती हैं। कुल संदर्भ में 8k पर यह कितनी स्मृति बचाता है?
   चीनी भाषा अनुवादःGemma 2 交替全注意力和滑动窗口注意力层──写出一半层使用4096-token 滑动窗口而不是全上下文时 KV 缓存的数学公式──在 8K 总上下文省多少内存?
...
5. एक हालिया सीमा मुक्त मॉडल खोजें जो इस पाठ के लिखने के बाद जारी किया गया था. यह पहचानें कि उसने किन छह बटनों को चुना और क्या उसने सातवें बटन को पेश किया। पाठ्यक्रम एक नए वास्तुकला जहाज के क्षण में पुराना महसूस करेगा - लक्ष्य आपके मानसिक मॉडल को पुनर्निर्माण किए बिना अपनी मेज को अपडेट करना है।
   चीनी अनुवादः खोज एक लेख इस पुस्तक के लेखन के बाद प्रकाशित नवीनतम अग्रणी ओपन सोर्स मॉडल── पहचानें कि यह छह चक्रों में से कौन से चुनता है और क्या सातवें चक्र को पेश किया गया है── पाठ्यक्रम नई संरचना के प्रकाशन के दौरान समय बीतता है लक्ष्य आपके रूप को अपडेट करना है और मानसिक मॉडल का पुनर्निर्माण नहीं करना है──
