# प्री-ट्रेनिंग एक मिनी GPT (124M पैरामीटर) 预训练迷你 GPT(1.24 亿参数)
...
> **【中文解读】**GPT-2 Small 1.24 अरब पैरामीटर 12 लेयर ट्रांसफार्मर ✓ 12 ✓ ध्यान केंद्रित ✓ 768 ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓ ✓

> **【拓展：大模型三阶段】**大模型训练三阶段:(1) 预训练(海量无标注数据,学习语言表示)→ (2) SFT(指令微调,学会跟随指令)→ (3) RLHF/DPO(对齐人类偏好)。本课是第一阶段,GPT-2是所有GPT 系列的原型──

>  **【前置】**学本节前 कृपया पहले समझेंः(1) चरण 10·01-03(分词器、数据管线) 理解 टोकन आईडी 序列如何输入模型;(2) ट्रांसफार्मर 架构(Phase 05) 自我注意、LayerNorm、FFN;(3) numpy 矩阵运算、反向传播手算(Phase 03 微积分与链式法则);(4) 交叉损失函数的梯度推导──本课**用 numpy 实现**, अब PyTorch ऑटोग्राड पर निर्भर नहीं, खुद को लिखने के लिए सक्षम होना चाहिए`backward()`
...
- GPT-2 वास्तुकला (124M पैरामीटर) को स्क्रैच से लागू करेंः टोकन एम्बेडमेंट, पोजिशनिंग एम्बेडमेंट, ट्रांसफार्मर ब्लॉक और भाषा मॉडल हेड
  शून्य से पूर्ण GPT-2 架构 (GPT-2 架构) 124M 参数):टोकन 嵌入、位置嵌入、Transformer 块和语言模型头
- क्रॉस-एंट्रोपी हानि के साथ अगले टोकन भविष्यवाणी का उपयोग करके पाठ कॉर्पस पर जीपीटी मॉडल को प्रशिक्षित करें
  उपयोग निम्न टोकन 预测和交叉损失在文本语料上训练 GPT 模型
...
> **【中文解读】**इस वर्ग में शुद्ध नम्बरी का प्रयोग किया गया है GPT-2 Small के शून्य से प्राप्त होने पर ((124M 参数) 😇 आप देखेंगे कि 1.24 अरब 参数 अगले टोकन का पूर्वानुमान करने के लिए कैसे आगे बढ़ते हैं, 损失 गणना, 逆向传播, 权重更新 के प्रशिक्षण चक्र के माध्यम से  यह PyTorch 黑盒 नहीं है प्रत्येक矩阵 गुणाकार सभी दृश्यमान हैं
...
> आप जानते हैं कि ट्रांसफार्मर क्या है। आप चित्रों को देख सकते हैं। आप "ध्यान ही आपको चाहिए" का पाठ पढ़ सकते हैं और "बहु-मुख्य ध्यान" के साथ एक बॉक्स को सफेद बोर्ड पर चित्रित कर सकते हैं।
...
> GPT-2 Small में 124,438,272 个参数 हैं (含权重共享) ⋅ प्रत्येक घटक प्रशिक्षण चक्र से निर्धारित होता हैः पूर्ववर्ती प्रसार、 गणना हानि、反向传播、更新权重── 12 ट्रांसफार्मर ब्लॉक, प्रत्येक ब्लॉक 12 个注意力头,768 维嵌入空间,50,257 词表── प्रत्येक बार उत्पन्न टोकन, सभी 1.24 बिलियन घटक श्रृंखलाओं में शामिल एक रक्जन गुणा विधि, टोकन आईडी 序列 को अगले टोकन के लिए परिवर्तित करेगा 概分布率──
...
> यदि आपने कभी इस मॉडल को स्वयं नहीं बनाया है, तो आप एक ब्लैक बॉक्स का उपयोग कर रहे हैं। आप एपीआई को अनुकूलित कर सकते हैं, इसे छोटा कर सकते हैं। लेकिन जब मॉडल का भ्रम उत्पन्न होता है, तो आप खुद को दोहरा सकते हैं या निर्देशों का पालन करने से इनकार कर सकते हैं, तो आप नहीं जानते कि क्यों।
...
> इस वर्ग में शून्य से निर्माण GPT-2 Small── कोई PyTorch नहीं── numpy के साथ। प्रत्येक रैंक गुणा है तो सब कुछ देखा जा सकता है। प्रत्येक रैंक आपके कोड द्वारा गणना की जाती है।
...
> निम्नलिखित टोकन आईडी से नीचे टोकन 概率 की पूरी गणना हैः
...
> यह संपूर्ण मॉडल है। कोई गुच्छा नहीं है। कोई चक्र नहीं है। केवल 12 बार सम्मिलित होता है।

>  **【类比】**GPT 像一台"流水线打字机":纸带送进代币 ID → 印章 1(代币嵌入)盖出 768 维向量 → 印章 2(स्थिति嵌入) 叠加位置 → 12道工人(ट्रांसफॉर्मर ब्लॉक) चरणबद्ध रूप से इस向量 को संशोधित करें → 末端喷墨头(LM सिर) में 50257 个候选词上喷概率分布 → 选择最高概率的词输出 → 把新词同时再送回纸带开头,循环──一切秘都在那12道工人头上如何"修改"量而自我注意力就是工人只用12眼睛注意力) 的看序列里其他代币能力──
...
> 12 个块 में से प्रत्येक एक ही मोड को अनुसरण करता है।
...
> शेष अंतर कनेक्शन महत्वपूर्ण है। बिना उनमें, तराजू में विपरीत दिशा में प्रसारित होता है जब 1 ब्लॉक तक गायब हो जाता है।

> **【中文解读】**GPT 架构的核心是变体 解码器块的堆积──每个块包含:LayerNorm → 多头自注意力 →残差连接 → LayerNorm → 前网络(MLP)→残差连接──GPT-2 使用预规(先归化再注意力),而非原始变体的后规──残差连接是关键没有它,梯度在12层反向传播后会消失,无法训练深层网络──

> **【拓展：GPT 系列的架构演进】**GPT-2 छोटा(124M,12 层 768 维)→ GPT-2 मध्यम(355M,24 层 1024 维)→ GPT-2 बड़ा(774M,36 层 1280 维)→ GPT-2 XL(1.5B,48 层 1600 维)→ GPT-3(175B,96 层 12288 维) ✿ संरचना मूल रूप से समान है, केवल स्तर संख्या और आयाम लगातार विस्तारित है。 GPT-4 के विशिष्ट तत्वों का खुलासा नहीं हुआ है, लेकिन अनुमान के अनुसार लगभग 120 层 और MoE(मिश्र विशेषज्ञ) संरचनाओं का उपयोग किया गया है。
...
> ध्यान दें कि प्रत्येक टोकन को पहले के प्रत्येक टोकन को देखने के लिए, प्रत्येक टोकन पर कितना ध्यान देना है।

प्रत्येक टोकन स्थिति के लिए, इनपुट से तीन वेक्टरों की गणना करेंः
- **Query (Q)**"मैं क्या खोज रहा हूँ?
  中文翻译:**查询（Q）**:"मैं क्या तलाश कर रहा हूँ? "
- **Key (K)**"मैं क्या शामिल है?
  中文翻译:**键（K）**:"मैं क्या शामिल है? "
- **Value (V)**: "मैं किस जानकारी को लेकर हूँ?
  中文翻译:**值（V）**:"मैं क्या सूचना ले कर आया हूँ? "
...
> कारण छुपावे से जीपीटी  आत्म-वापसी मॉडल बन जाता है। स्थान 5 पर 0-5 की स्थिति को ध्यान में रखा जा सकता है, लेकिन 6、7、8 आदि को ध्यान में नहीं रखा जा सकता है। यह मॉडल को प्रशिक्षण के दौरान भविष्य के टोकन को देखने से रोकता है।
...
> **多头注意力**एक सिर से दूसरे को दूसरे को दूसरे के पास से दूसरे को दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास से दूसरे के पास जा सकता है।
...
> इसके अलावा, वर्ग में (d_k) sqrt(64) = 8 है संकुचित। इसके बिना, बिंदु积在高维向量上会变得很大,将软max 推进梯度接近零的区域── यह मूल "ध्यान है All You Need"论文 की महत्वपूर्ण अंतर्दृष्टि में से एक है।
...
> KV 缓存 ने इस समस्या को हल किया है। प्रत्येक टोकन का K 和 V 后存储它们── उत्पन्न टोकन N+1 时, आपको केवल नए टोकन का Q का गणना करने की आवश्यकता है और सभी पिछले टोकन 缓存 के K 和 V को खोजने की आवश्यकता है। यह K 和 V 计算 के प्रत्येक टोकन का व्यय O(N) 降至 O(1) ;; ध्यान का अंश गणना अभी भी O(N है, क्योंकि आप सभी पिछले स्थानों को ध्यान में रखते हैं, लेकिन इनपुट पर अतिरिक्त矩阵 गुणा को टालने से बचते हैं।
...
> 对于12层12头的GPT-2,KV 缓存每 token 存储2(K + V) x 12层 x 12头 x 64维 = 18,432 个值。对于1024 टोकन के क्रम के लिए, FP32 में लगभग 75MB है。对于128层的Llama 3 405B,单个序列 केKV 缓存可超过10GB──这就是为什么长上下文推理是内存受限的──
...
> जब आप LLM में प्रोम्प्ट भेजते हैं , तो यह दो अलग-अलग चरणों में होता है
...
> **预填充（Prefill）**और पूरे प्रॉम्प्ट को संसाधित करने की प्रक्रिया करें। सभी टोकन  ज्ञात हैं, इसलिए मॉडल एक साथ सभी स्थानों का ध्यान गणना कर सकता है। यह चरण गणना घनी प्रकार के GPU का है। पूर्ण संचलन को एक रैंक गुणा करके करें। A100 पर 1000 टोकन के प्रॉम्प्ट को संसाधित करने के लिए, पूर्व-भरण लगभग 20-50ms की आवश्यकता होती है।
...
> **解码（Decode）**个别生成代币――每个新代币依赖所有前代币―― इस चरण में 瓶是从 GPU内存读取模型权重和KV缓存,而不是矩阵运算本身――GPU के गणना核心 में अधिकांश समय内存读取等待中――GPT-2, प्रत्येक解码步骤 के लिए समय लगभग समान है, चाहे矩阵乘法 में कितना FLOP की आवश्यकता हो, क्योंकि内存宽度 सीमित है――
...
> यह अंतर उत्पादन प्रणाली के लिए महत्वपूर्ण है। प्रीफिलिंग टनटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटोटो
...
> सीखने की दर को समायोजित करना आपके विचार से अधिक महत्वपूर्ण है। GPT-2 में पहले 2,000 चरणों में 0 से पूर्व गर्मी से लेकर शिखर मूल्य तक सीखने की दर, फिर शेष स्ट्रिंग वक्र रेखा पर गिरावट आएगी। उच्च सीखने की दर से मॉडल फैलता शुरू होगा। निरंतर उच्च सीखने की दर से बाद के चरण में प्रशिक्षण झोंझोल होगा।
...
> **【中文解读】**GPT-2 का पैरामीटर वितरणः टोकन 嵌入层占 38.6M(50257 x 768),12 个 ट्रांसफार्मर 块各占 7.1M,最终 LayerNorm 只有 1.5K;;权重共享(重量绑定) 让输出投影层复用 टोकन 嵌入矩阵,减少38M 参数的同时还提升性能因为输入和输出被强制使用相同表示空间──
...
> टोकन 嵌入将 50,257 个可能的 टोकन, क्रमशः एक 768 维向量 में映射为一个.
...
> पहले एक ही ध्यान दें। कारण छिपाएं, पहले एक ही स्थान पर ध्यान दें।
...
> 768 维输入分为12 个 64 维的头―― प्रत्येक头独立计算注意力――拼接结果并投影回 768 维――
...
> reshape-transpose-reshape का संचालन है多头注意力中最困惑的部分──过程如下:(बैच, seq_len, 768) 张量变为 (बैच, seq_len, 12, 64), फिर (बैच, 12, seq_len, 64) 现在 12个头各有自己的 (seq_len, 64) 矩阵来运行注意力──注意力之后,我们反转过程:(बैच, 12, seq_len, 64) 变为 (बैच, seq_len, 12, 64) 变为 (बैच, seq_len, 768) ⇒
...
> एक पूर्ण ट्रांसफार्मर 块:LayerNorm、带残差的多头注意力、LayerNorm、带残差的前网络──
...
> पूर्व नेटवर्क 768 维输入 विस्तार होगा 3,072 维(4 倍), अनुप्रयोग गैर-线性, फिर प्रोजेक्शन वापस 768 । यह विस्तार-संकुचन मॉडल मॉडल को एक "बड़ा" आंतरिक अभिव्यक्ति प्रत्येक स्थान पर काम करते हैं।
...
> ध्यान दें`logits = x @ self.embedding.token_embed.T`◊输出投影复用代币 嵌入矩阵(转置) ◊ यह न केवल बचत तत्वों की तकनीक है── इसका मतलब है कि मॉडल टोकन को समझने के लिए एक ही आयाम अंतरिक्ष का उपयोग करता है️嵌入) और पूर्वानुमान टोकन️输出) ◊
...
>  124M 参数 के वास्तविक प्रशिक्षण के लिए, आपको GPU और PyTorch की आवश्यकता है।  यह प्रशिक्षण चक्र शुद्ध नंबरी  संचालन के छोटे मॉडल पर प्रदर्शन तंत्र में होता है।
...
> 损失初始接近 ln(vocab_size)  256 个 टोकन के लिए字节级词表,即 ln(256) = 5.55。随机模型给每个 टोकन 分配等概率──随着训练进行,损失下降,因为模型学会预测常见模式:"t" 后面是"th",句号后面是空格等──
...
> उत्पादन में, आप एडम का उपयोग करेंगे  अनुकूलक संयोजन gradient accumulation  सीखने की दर पूर्व ताप और gradient cutting                                                                                                                                                                                                                                                
...
> 生成 प्रयोग प्रशिक्षित अच्छा मॉडल व्यक्तिगत पूर्वानुमान टोकन── प्रत्येक पूर्वानुमान से आउटपुट वितरण में采样((या贪心地取 argmax)──
...
> `tokens[-seq_len:]`窗口是必要的,因为模型有最大上下文长度 ((GPT-2 为 1024) ⋅ एक बार बाहर निकल जाने पर, आपको सबसे पुराना टोकन त्यागना होगा।
...
> छोटे भाषाओं और छोटे मॉडल पर, उत्पन्न पाठ का मात्रा आधा-सीरहित है। यह प्रशिक्षण पाठ से कुछ बाइट-स्तर के मॉडल तक सीखता है, लेकिन GPT-2 की तरह 40GB में प्रशिक्षण डेटा और पूर्ण 124M पैरामीटर संरचना पर नहीं किया जा सकता है।
...
> 本课产 出 `outputs/prompt-gpt-architecture-analyzer.md` एक विश्लेषण किसी भी GPT 风格模型架构选择的提示──输入模型卡或技术报告, यह घटक वितरण, ध्यान डिजाइन और संकुचित निर्णयों को विभाजित करेगा──
