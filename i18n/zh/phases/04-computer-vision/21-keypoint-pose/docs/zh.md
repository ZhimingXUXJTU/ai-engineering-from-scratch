...
> **【中文解读】**姿势是一个有序的关键点组. 姿势估计广泛应用于运动分析,人机交互和AR镜子.

> **【拓展：姿态估计的应用】**身运动身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身身
...
> 关键点任务隐藏在许多名称下:人体姿态(17个身体关节) 面部特征点(68个点) 、手部(21个点) 、动物姿态、机器人物体姿态、医学解剖标志──每个都有相同的结构:检测物体上的 K 个离散点并输出它们的 (x, y) 坐标──

姿势估计是运动捕捉,健身应用,体育分析,手势控制,动画,AR试验和机器人抓取的基础. 2D 案例已经成熟; 3D 姿势 (从单个摄像头来估计世界坐标中的联合位置) 是当前的研究界限.

> 姿势估计是动作捕捉,健身应用,运动分析,手势控制,动画,AR 试穿和机器人抓取的基础.

工程问题是规模.一个单个图像,一个人姿势是一个20ms的问题.在人群中30fps的多人姿势是一个不同的问题,不同架构.

> 工程问题是规模――单个图像、单个人的姿态是一个20ms的问题――人群中30fps的多人姿态是一个不同结构的不同问题――
...
- **Top-down**首先检测到人,然后在每种作物上运行一个人均关键点模型.
  翻译: 中文**自顶向下**首先检测人体框,然后对每个剪切区域运行单人关键点模型――精度最高;随人数线性扩展――
- **Bottom-up**一个前进传输预测所有关键点加上一个关键字段;组组它们.不论群众规模如何,持续时间.
  翻译: 中文**自底向上**一次前向传播预测所有关键点加关联场;然后分组──无论群体大小是常数时间──

顶部 (HRNet,ViTPose) 是精度领导者;下部 (OpenPose,HigherHRNet) 是拥挤场景的吞吐量领导者.

> 自顶向下 (HRNet、ViTPose) 是精度领导者;自底上 (OpenPose、HigherHRNet) 是拥挤场景的吞吐量领导者.

### 热图回归

没有退缩`(x, y)`直接预测一个`H x W`热地图每一个键点,一个位于真实位置的高斯斑点.

> 不直接回归`(x, y)`而是为每一个关键点预测一张`H x W`热力图,在真实位置中心放置高斑点.
...
> 标准人体姿势数据集:每人17个关键点,PCK(正确关键点百分比) 和OKS(目标关键点相似度)作为度量──OKS 是关键点版的IoU,是COCO mAP@OKS 报告内容──
...
> 每个关键点的热力图沿着通道轴堆积,形成完整的目标张量.

### 步骤2: 小键点头

通过U-Net的模型,输出K热图频道.

> 一个 U-Net 风格模型,输出 K 个热力图通道.
