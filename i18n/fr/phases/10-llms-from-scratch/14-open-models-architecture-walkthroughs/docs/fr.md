# Modèles ouverts: architecture, parcours.
...
> **【中文解读】**Vous avez construit GPT-2 Small en 4e classe. Le modèle de source ouverte de 2026 a seulement fait cinq modifications: RMSNorm  remplacement LayerNorm、SwiGLU  remplacement GELU、RoPE  remplacement de l'apprentissage position codé、GQA/MLA  remplacement de l'attention  massive MoE── la mathématique acquise couvre 95%。

> **【拓展：DeepSeek架构】**La formation de DeepSeek-V3 est essentielle pour comprendre ces structures et les choix de leur structure.

>  **【前置】**學本節前 請先掌握:Phase 10·04(Pre-Training Mini GPT) 理解原始 GPT 架构;Phase 10·05(Scaling);Phase 10·12(Inference Optimization) 理解 KV cache 才能懂 MLA。本节是后续 15-22 节(架构创新详解) 的概览──

>  **【类比】**Regarde 2026 开源模型 = 看不同品牌的电动车──Llama 3 = 特斯拉(务实,GQA + RoPE 标准配置);DeepSeek-V3 = 比亚迪(堆料王,MLA + MoE + MTP + DualPipe 全套);Mixtral = 大众 ID(MoE 老牌);Qwen = 小(多尺寸覆盖);Gemma = 沃尔沃(精简安全)──底层都是 Transformer(电动车底盘),差异在 5-6 个关键模块──
...
- Lisez le config.json de Llama 3, Mistral, Mixtral, Gemma 2, Qwen 2.5, et DeepSeek-V3 et expliquez chaque champ
  L'expérience de l'expérience de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de recherche de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l'équipe de l
- Nommez le changement architectural spécifique réalisé par chaque modèle par rapport à GPT-2 Small et justifiez-le à partir des premiers principes
  Il est possible de décrire les modifications de la structure spécifique de chaque modèle par rapport au GPT-2 Small, et de les analyser à partir des principes fondamentaux.
...
- Choisissez le bon modèle ouvert pour une cible de déploiement compte tenu des contraintes de latence, de mémoire et de capacité
  Selon la limite de retard, de mémoire et de capacité, le modèle open source approprié pour le déploiement de l'objectif est choisi.
...
> Vous avez écrit 350 pages de numpy sur un modèle en forme de GPT-2 à la quatrième classe. Llama 3 405B a un rapport technique de 200 pages. Votre intuition vous dit qu'ils sont complètement différents. En fait, ils ne sont pas. Les 200 pages décrivent le même objet, seulement cinq ou six modifications à plein régime, plus mille détails sur l'expansion.
...
> Pour chaque famille de modèles à source ouverte, nous avons listé ce que GPT-2 a modifié, pourquoi il a modifié, le prix est quoi.
...
> Le résultat réel est que lorsque Meta publie Llama 5 ou DeepSeek, vous n'avez pas besoin d'un nouveau modèle mental.

## Le concept de base.

> **【中文解读】**Le programme de formation en sciences de l'université est basé sur la formation de la formation en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de l'université en sciences de sciences et de sciences de sciences de sciences de sciences de sciences de sciences et de sciences de sciences de sciences de sciences et de sciences de sciences de sciences et de sciences de sciences de sciences de sciences et de sciences de sciences.

> **【拓展：架构演进的趋势】**Tendance de l'architecture 2024-2025: RoPE  rotation position codé a remplacé l'absence de position codé, GQA 分组查询注意力) réduit le KV-cache 大小, SwiGLU 替代 ReLU 升级性能, RMSNorm 替代 LayerNorm 降低计算开销──MoE 混合专家) par rare activation réduit le coût de la spéculation, MoE de DeepSeek-V3 par activation d'environ 37B/671B 参数──
...
> **【拓展：开源模型的选型指南】**2024-2025 année ouverte modèle sélection type: généraliser le dialogue sélection Llama-3-70B, faire le choix des tâches DeepSeek-R1, codes générer sélection DeepSeek-Coder-V2,长上下文选 Qwen-2.5-72B(128K 上下文),轻量级选 Llama-3-8B 或 Qwen-2.5-7B──
...
> 本课产 出 `outputs/skill-open-model-picker.md` donner des objectifs de déploiement (GPU type, appartenance, durée, budget) et de mise en place des tâches (Chatting, code, hypothèse, longueur de texte), elle propose un modèle open source, un programme quantifié de la dixième classe et un modèle de la douzième classe, et donne des hypothèses précises sur six axes de construction.
...
1. Lisez la configuration Qwen 2.5 72B de HuggingFace. Comptez les paramètres totaux à partir de zéro. Comparer à la valeur HF déclarée et identifier d'où provient tout delta (arrondissement de tête, facteur de partage de KV, etc.).
   Le nombre total de composants de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure de la structure
...
2. DeepSeek V3 utilise 256 experts avec un routage top-8. Comptez le ratio d'experts actifs à des experts totaux et comparez-le avec le top-2 de Mixtral 8x7B de 8.
   Qu'est-ce que cela signifie pour le taux de conversion de la capacité de FLOP de Mixtral 8x7B entre le top-2 sur 8 comparativement.
...
3. Computez le cache KV pour Llama 3 405B dans un contexte de 128k en FP8 et BF16. À FP8 c'est la moitié du nombre BF16. Combien de séquences parallèles pouvez-vous servir sur un seul nœud 8xH100 (80 Go chacun = 640 Go total, moins poids mémoire)?
   Le nombre de KV de la BF16 est de 3 405B en 128K.
...
5. Trouvez un modèle ouvert de frontière récent qui a été publié après la rédaction de cette leçon. Identifiez lequel des six boutons qu'il a choisi et si il a introduit un septième bouton. Le programme sera obsolète dès qu'une nouvelle architecture sera lancée - l'objectif est de mettre à jour votre table sans reconstruire votre modèle mental.
   Le but de la publication de ce nouveau modèle est de renouveler votre image et de ne pas reconstruire votre modèle mental.
