...
> **【中文解读】**La 3D est le modèle le plus fort du pont 2D à 3D. La révolution de 2023 est la 3D Gaussian Splating. La tendance de production de 2024-2026 est de développer plusieurs aspects de la diffusion + 3D, de recréer la superposition, de la seule suggestion de mots ou de photos à la production d'objets et de scènes 3D.
...
> 3D  Contenu très difficile:

- **Representation.**Les réseaux voxel, les champs signés à distance, les champs neuraux de rayonnement, les Gaussiens 3D.
  **表示方式。**Il y a aussi des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles, des étoiles.
- **Data scarcity.**ImageNet possède 14 millions d'images. Le plus grand ensemble de données 3D propre (Objaverse-XL, 2023) a environ 10 millions d'objets, la qualité la plus faible.
  **数据稀缺。**ImageNet a 14 millions d'images. La plupart sont de qualité inférieure.
- **Memory.**Une grille de 5123 voxels est de 128 M voxels; une scène utile NeRF a besoin de 1 M d'échantillons / rayons.
  **内存。**Le nombre de personnes physiques en ligne est de 1,28 milliard de personnes.
- **Supervision.**Pour une image 2D, vous avez les pixels. Pour 3D, vous avez généralement une poignée de vues 2D et vous devez passer à 3D.
  **监督。**Les images 2D ont des images. Les images 3D sont généralement de petite taille.
...
> Le schéma de l'année 2026 est divisé en deux étapes: d'abord utiliser un modèle de propagation pour générer des images en 2D, des images en 2D, des images en 3D, des images en 2D, des images en 2D, des images en 3D, des images en 2D, des images en 2D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 2D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, des images en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en 3D, en:

> **【中文解读】**Le défi principal de la production en 3D est de détecter le mode de production en 2D. Le principal projet de 2026 est de deux étapes: d'utiliser un modèle de diffusion pour générer des images en 2D, de refaire un projet en 3D.

> **【拓展：3D Gaussian Splatting 的革命性影响】**3DGS(2023) remplacer NeRF  devenir la principale méthode de reconstruction 3D. Il utilise des millions de scènes 3D, avec une vitesse de coloration rapide de 100 fois supérieure, une qualité équivalente ou meilleure.
...
> Dans le jeu ou dans le commerce électronique, le jeu est en mode 3D: Meshy 4 ou Rodin Gen-1.5 输出可直接用于 Unity/Unreal 的 PBR 网格──
