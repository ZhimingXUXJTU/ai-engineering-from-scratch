# Test A/B des caractéristiques du LLM  GrowthBook, Statsig et le problème des vibrations ✓
...
> **【中文解读】**Ce chapitre présente les méthodes de l'évaluation scientifique de la fonction de l'application de la loi.
...
>  **【前置】**Les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les cours de formation sont les suivants: les suivants: les phases 17; les phases 17; les phases: les phases 17; les phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phases: phrases: phrases: phrases: phrases: phrases: phrases: phrases: phrases: phras: phrases: phras: phrases: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras: phras
>  **【类比】**LLM A/B 测试 = "Use a method scientifique au lieu de la prise de poids"。 Key difference:eval 问"模型能做吗";A/B 问"用户在乎吗"。两者都要──测什么:快措辞、模型选择、生成参数(temperature/top-p)。案例:聊天机器人变体+70%对话长度+30% 留存;Nextdoor AI 标题+1% CTR;Khanmigo 在延迟 vs 数学准确率间舍──平台:Statsig((AI 11 milliards d'acquisition,全功能) 、GrowthBook 开源源厂 原生、贝叶斯频率+被序贯引擎) ∼
**Time:** ~60 minutes | **时间:** ~60 minutes

## Objectifs d'apprentissage

- Distinguer les évaluations ("le modèle peut-il faire le travail") des tests A/B ("les utilisateurs se soucient").
  Le modèle peut faire ce travail ?" et A/B 测试("user está乎吗")
- Nombrez trois axes testables (prompte, modèle, paramètres) et choisissez la métrique pour chacun.
  Le modèle est le modèle de chaque étiquette.
...
- Choisissez Statsig ou GrowthBook en fonction de la posture de stockage SQL et de la position d'acquisition d'entreprise.
  Traduction anglaise: selon le stockage-SQL 态势和企业收购立场选择 Statsig 或 GrowthBook。

## Le problème , l' introduction du problème

> **【中文解读】**Les tests A/B sont-ils faits pour un programme de formation LLM à durée indéterminée ? Les tests A/B répondent: "Le modèle peut-il faire cette chose ?" Les tests A/B répondent: "L'utilisateur est à l'écoute ?" Les deux sont nécessaires.

> **【拓展：LLM A/B 测试的真实案例】**Le projet de loi de 2026 A/B 测试的生产案例:(1) 聊天机器人奖励模型变体+70% 对话长度、+30% 留存率;(2) Nextdoor AI 主题行实验奖励函数优化后 +1% CTR;(3) Khan Academy Khanmigo在延迟对数学准确率轴上代.
...
> **【中文解读】**CUPED (en anglais seulement: CUPED) est une technique de réduction de la différence de base de l'essai A/B. Le principe est de réduire la différence de base de l'essai précédent avant la période de comparaison.
...
> **【拓展：Statsig vs GrowthBook 选型】**Statsig vs GrowthBook de 2026 année par rapport à:Statsig 2025 septembre été acheté par OpenAI à 1,1 milliard de dollars, est un SaaS complet, avec des drapeaux de fonctionnalités +  expérience d'analyse + 可观测性), intégrées en séquence et CUPED, adapté à la recherche de l'équipe de produits liés à la croissance.
...
> **【拓展：LLM 非确定性对 A/B 测试的影响】**L'incertitude de l'LLM affecte les statistiques des tests A/B. Les mêmes suggestions génèrent des sorties différentes, la puissance traditionnelle  calculer la hypothèse de l'observation de la valeur IID. Dans l'LLM non-certaine, la quantité d'échantillons valide inférieure à la valeur nominale  nécessite une quantité d'échantillons requise multipliée par 1,3-1,5 fois  en tant que sécurité. Les tests séquentiels  permettent de s'arrêter à l'avance lorsque le gagnant est déterminé, économisant 20-40% du temps d'expérience par rapport à la quantité d'échantillons fixe .
...
> 本课产 出 `outputs/skill-ab-plan.md`- Étant donné le changement de fonctionnalité, la charge de travail, la ligne de base, les choix de la plateforme, les portes, la taille de l'échantillon.
...
1. On court .`code/main.py`Pour une élévation de 5% prévue avec conversion de 3% de référence, quelle taille d'échantillon pour 80% de puissance ?
   Le mot " l' économie " est traduit par " l' économie ".`code/main.py`◊ prévision 5% 提升、基线 3% 转换率, combien de échantillons sont nécessaires?
2. Choisissez Statsig ou GrowthBook pour un client local réglementé par les soins de santé.
   Traduction anglaise: Pour le personnel de la santé publique, le personnel de la santé publique doit être informé de la situation.
3. Conçonnez une A/B qui teste GPT-4 contre GPT-3.5 sur le coût par billet résolu.
   Le design a un en cours de réparation sur le seul coût de l'industrie GPT-4 vs GPT-3.5 A/B.
4. Votre canary passe mais A/B montre une conversion de -1,2%.
   Le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et le taux de conversion est de -1,2% et de -2, respectivement.
