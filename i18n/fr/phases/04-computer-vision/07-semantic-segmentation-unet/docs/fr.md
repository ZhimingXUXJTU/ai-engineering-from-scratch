# Segmentation sémantique  U-Net  Sémantique séparation  U-Net
...
> **【中文解读】**Le système de décomposition est basé sur le système de décomposition de chaque image.

> **【拓展：U-Net 的广泛应用】**U-Net est d'abord conçu pour la division d'images médicales, mais est devenu une infrastructure dans de nombreux domaines: diffusion stable U-Net comme un réseau de désinformation au cœur du réseau, la division routière dans la conduite autonome, la couverture des images satellites.
...
> Répartition de chaque image en sortie d'un label.`H x W`Les données de l'entrée et de la sortie sont en forme.`H x W`(语义) ou `H x W x N_instances`(exemple) de la quantité de l'image. C'est pour chaque image des millions de prédictions, et non pour une seule.

> **【中文解读】**Le problème central de la division est de: à la fois voir la situation globale sur la scène suivante, à la fois conserver les détails de la situation locale sur la scène suivante, à la fois la manière de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon dont la façon de la façon de la façon de la façon de la façon de la façon de la façon de la façon dont la façon de la façon de la façon de la façon de la façon dont la façon de la communication est.
...
> La structure de la division est la cause de la propulsion de presque tous les produits de prévision visuelle: médecine (images) 瘤掩码 (tombées) 自动驾驶 (automobile) 道路 (道路) 车道 (obstacles) 卫星 (structures)                                                                                                                                                                                                                           
...
> Le problème de l'architecture est simple mais il n'est pas simple à résoudre: vous avez besoin d'un réseau pour voir l'ensemble de l'image en même temps.
...
- **Semantic**"Ce pixel est la route, ce pixel est la voiture". Deux voitures côte à côte s'effondrent en une seule tache.
  Le mot chinois traduit par " cette image est un chemin, cette image est une voiture " est traduit par " deux véhicules adjacents sont regroupés en une région ".
- **Instance**dit " ce pixel est la voiture n°3, ce pixel est la voiture n°5. " Ignore les choses de fond (" choses " = ciel, route, gazon).
  Le mot "je suis le troisième véhicule" est un mot qui signifie "je suis le troisième véhicule".
- **Panoptic**Unifie les deux: chaque pixel obtient une étiquette de classe, chaque instance obtient un identifiant unique, les choses et les choses sont à la fois segmentées.
  Chaque image obtient une catégorie de marque, chaque cas obtient une unique identité, le contexte et l'objet de la vue sont divisés.

Cette leçon couvre la sémantique.

> Le programme de formation en sciences de la santé et de la santé est un programme de formation en sciences de la santé et de la santé.
