...
> **【中文解读】**基础模型只会预测下一个代币――它不会遵循指令、回答问题或拒绝有害请求――SFT(监督微调) 连接"代币 预测器"和"有用助手"的桥梁──Claude、ChatGPT、Llama Chat 都经过这个步骤──

> **【拓展：SFT→ChatGPT】**ChatGPT'in eğitim süreci:GPT-3.5 预训练 → SFT(insanların konuşma verileri ile işaretlenmiş)→ RLHF(insanların tercih ettiği verilerle birlikte)。SFT temel modellerin konuşma yardımcılarının anahtar adımlarına dönüştürülmesi。

>  **【前置】**Önemli bir eğitim programı yaparak, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının öğrendiği bir programı geliştirmek için, öğrenci sınıfının geliştirdiği bir programdır.
...
>  **【类比】**SFT = 给"博学学"上课──预训让会说所有人话(语言能力),但不会对话(你说"你好",它说"今日天气不错"纯统计接龙)──SFT, "问答" 示范教它"问你好应答你好"从统计变成会谈──

> ️ **【易错点】**SFT 数据准备的 3 个坑:(1) **指令格式不统一**`User:`- Ne ?`Assistant:`- Evet .`<|user|>`- Ne ?`<|assistant|>`,模型学不会统一格式;务必固定模板((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((**拒绝样本不足**100.000 sohbette sadece 50 条 "hassas istekleri reddet" model reddedilmez; en az 5-10%                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ** catastrophic forgetting**SFT 数据太狭 (全是客服对话), model genel kullanım kabiliyetini unuttu; karışmak 20-30% 通用数据 (Alpaca、FLAN)保住基础能力──

## Öğrenme hedefleri

- Temel dil modelini talimatları takip eden bir asistan olarak dönüştüren denetlenmiş ince ayarlama (SFT) uygulaması
  实现监督微调(SFT),将基础语言模型转换为指示跟随助手
- Sistem, kullanıcı ve yardımcı rolleri ile sohbet şablonları kullanarak eğitim verilerini biçimlendirin ve yardımcı olmayan tokenlerde maske kaybı
  Sistem/kullanıcı/asistan 角色的聊天模板格式化训练数据,并对非助手代币 进行损失掩码
- SFT'nin neden gerekli olduğunu açıklayın: Temel modeller soruları cevaplamak yerine metni devam ettirir
  SFT neden gerekliliğini açıklayın: temel model soruları cevaplamadan metni devam ettirmek.
- SFT kalitesini, temel model ile ince ayarlanmış model cevaplarını, uzun süreli bir talimat kümesi üzerinde karşılaştırarak değerlendirin.
  SFT kalitesini değerlendirmek için, bırakılan talimat kitlesinde temel modelle küçük modelleştirilmiş modellerin karşılaştırılması

> **【中文解读】**Bu ders temel modelini talimat takip yardımcı olarak dönüştürür.
...
> 4. sınıfta bir model eğitilmiştir. ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒ ⇒    ⇒ ⇒                                                                                                                                                                                                          
...
> 现在试试这个:输入 "Fransa'nın başkenti nedir?" 基础模型不会回答 "Paris." It will continue模式──它可能生成 "Almanya'nın başkenti nedir? İspanya'nın başkenti nedir?"
...
> İşte GPT-3 (basal model, 2020 yıl 6 ay yayınlandı) ve ChatGPT (geleneksel model) arasındaki fark. Aynı yapı, aynı önceden eğitim.
...
> Stanford Alpaca  kanıtlamak için milyonlarca örnek gerekmez. 2023 yıl 3 月, onlar sadece 52,000 条 GPT-3.5 生成の指示-回复を微調した Llama 7B 〜 総コスト:600 ドル── sonuçta bir talimat takip edebilir 、 sorulara cevap ve sohbet chat makinesi 〜 ChatGPT gibi değil İyi, ama 600 ドル ve birkaç saat eğitim göz önünde bulundurarak, şaşırtıcı bir şekilde yaklaşmıştır──
...
> Meta'nın Llama 2 Chat ilk SFT 阶段 sadece yaklaşık 27.000 条 yüksek kaliteli örnek kullanılmıştır.

> **【中文解读】**GPT-3(2020.6) ve ChatGPT(2022.11) arasında sadece 20.000 ila 100.000 条精心构建的(指示,回复) 对应.Stanford Alpaca 52,000 条 GPT-3.5 生成的命令数据微调 Llama 7B,成本 sadece 600 $──Meta'nın Llama 2 Chat sadece yaklaşık 27.000 条高质量标注数据──核心洞察:质量比数更重要27.000 条熟练标注者编写的样本胜过100万条互联网噪声数据──

> **【拓展：Llama 2 的 SFT 数据质量标准】**Meta açıklama Llama 2 Chat'ın SFT verileri, profesyonel etiketleme ekibi tarafından yazılmış, her verinin çok sayıda kez gözden geçirilmesi yapıldı. Bu, erken yöntemlerle birlikte İnternetten QA'yı ele almak için yapılan bir karşılaştırma şeklindeydi. OpenAI'nin ChatGPT'nin SFT aşamasını eğitmek için büyük miktarda yapay etiketleme yüksek kaliteli sohbet verileri kullandığı söylenmektedir.
...
> 监督微调延续预训的相同训练循环前向传播、计算损失、反向传播、更新权重但在不同类型的数据上──你用结构化对话代替原始文本进行训练:
...
> Model zaten biliyor ki Paris Fransa'nın başkentidir. Bu konuyu, eğitim sırasında Wikipedia, kitap ve web sayfalarından öğrenmiş oldu.

Bunu şöyle düşünün: önceden eğitim model bilgisini verir. SFT model davranışlarını verir.

> Bu yüzden, model bilgisini ödemek için, bir eğitim ver.

> **【中文解读】**SFT'nin özelliği devamlı hazırlık eğitim döngüsüdür, ancak veriler orijinal metinden yapılandırılmış sohbetlere dönüştürülmüştür.

### Veriler biçimi

Endüstriyi üç format yönetiyor. Her biri aynı bilgileri kodlıyor -- kim ne dedi -- farklı sınırlayıcılarla.

> Yapıların ana biçimleri üçtür. Her kod aynı bilgiyi kullanır.
...
> 简单且广泛使用──`input`字段是可选的许多命令不需要额外上下文──Stanford, GPT-3.5 tarafından üretilen, 600 美元lık bir üretim biçiminde 52.000 numune yayınladı.
...
> 支持多轮对话──"den" 字段惯例使用"人" 和 "gpt",无论实际模型是什么──Vicuna, ChatGPT sohbet kayıtlarından elde edilen 70,000 个 ShareGPT sohbet üzerinde eğitim──
...
> 使用特殊 token(`<|im_start|>`- Evet.`<|im_end|>`Bu simgeler, küçük bir düzen içinde, sözcüklerin bir kısmına eklenmiştir.

Üç format da aynı şeyi başarıyor: modeline "Bu talimat, bu cevap, bu örneği öğrenin" diyorlar.

> Üç çeşit biçimde aynı şeyi yap: anlatın model "Bu bir emir, bu bir cevap, öğrenin bu model".
...
> 模型在预训中已经学到了语言――它已经见过数十亿问题后跟答、命令后跟完成、人与人对话的例子――这些模式已经编码在权重中──
...
> SFT  bu potansiyel yeteneği odakladı. Artık model gerektirmez. Bu nedenle, SFT'nin soruları cevaplaması veya devam etmesi gerektiği sonucuna varmak için, SFT'nin bir kaç bin örnekten sonra model öğrendi: yardımcı rolün belirtilmesi zaman, yararlı bir cevap oluşturmak için.
...
> Bu yüzden 27 bin örnek yeterlidir. İngilizce öğretmek için değil. Dünyadaki gerçekleri öğretmek için değil.

### Gizli Kayıp

Bu SFT'de en önemli teknik ayrıntı ve çoğu öğretim bunu atlatır.

> Bu SFT'de en önemli teknik ayrıntıdır, çoğu ders atladı.
...
> 预训时,你对每一个代币 计算损失――模型学习预测序列中的每一个下一个代币――SFT 时,你对每一个*回复*代币 计算损失――指令代币 提供上下文,但模型不会因"预测"而不准确而受惩罚――
...
> Neden? Çünkü model öğrenci* üretmesini istemiyorsun. Ve bu da bir şey demek istiyor. Eğer bir işaret simgesi 计算损失 karşısında, "Fransa'nın başkenti nedir?" diyerek bir model tahmininde bulursun.

Pratikte bir kayb maskası oluşturursunuz: 1 cevap simgesi için, 0 talimat simgesi için.

> 實踐中,你创建一个损失掩码:回复代币为 1,指令代币为 0――平均之前每个代币的损失将乘以这个掩码――
...
> Sadece .`[ASST]`后的符号 贡献损失──模型在前向传播中看到完整对话(正确回复产生命令需要), ancak sadece预测回复的好坏来更新权重──

### Eğitim Hiperparametre

SFT, eğitim öncesiyle çok farklı hiperparametre kullanıyor. Siz sıfırdan eğitim vermiyorsunuz.

> SFT kullanımı süperparametre hazırlık ile tamamen farklıdır.
...
> SFT'nin öğrenme oranı 15 kat daha düşüktür. Bu çok önemlidir.

> **【中文解读】**损失掩码 SFT'de en önemli teknik ayrıntılardır. 预训时对所有代币 计算损失, SFT时仅对助手的回复代币 计算损失. 指示代币, aşağıda bulunanı sunmak için kullanılır, ancak 损失计算否则模型会学习"生成指令"而不是"回应指令"──训练超参数也截然不同:SFT'in öğrenme oranı,预训练比15倍低(2e-5 vs 3e-4),灾难性遗忘的避免──

> **【拓展：SFT 的数据规模与成本】**SFT veri miktarı ön eğitimden çok daha küçük: Lama 2 Chat 27,000 条  Alpaca 52,000 条  Vicka 70,000 条 sohbet ile. Maliyet çok düşük. Alpaca'nın SFT veri üretimi maliyeti sadece 600 dolar.
...
> 两时代的模型看每训练样本两次――小型数据集上超过3时代的模型开始逐字复现训练样本而不是泛化――
...
> 微调可能破坏通用能力──命令跟随数据上训练太久,模型会失失写代码、数学或创意文本的能力──它变得非常擅长训练数据的特定形式,但在其他方面变得很糟糕──

Üç hafifleme:

> Üç çeşit çözüm stratejisi:
...
> NVIDIA A100 80GB GPU'sını kullanarak 10,000 条 yüksek kaliteli talimatları kullanarak 7B modelini yaklaşık 1 saat gerektiriyor.
...
> 对于我们的迷你 GPT(4层,128维), eğitim neredeyse hemen hemen ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅                                                                                                                                                                                                                                
...
> 合成 talimat verileri oluşturmak.  Sınav AI ve Antropik gibi şirketler tarafından üretilen bu verileri yazmak için işçi işaretçilerini işe aldı.
...
> Stanford Alpaca'nın 52.000 tane kullanması çok azdır. Ama 8 tane veya 52.000 tane olursa olsun, mekanizma aynıdır:分词、掩码、只对回复计算损失──

### Adım 2: Çat Şablonu ile simgeleme

Görev- yanıt çiftlerini özel rol işaretleyicileri ile simgelik diziler haline getir.

> Bu, bir karakter için belirtilmiş bir simge dizisi olarak değiştirilmesini sağlar.
...
> 损失掩码对命令令令令 全为 0,对回复令令令 全为 1──`RESP_START`Token Özönlü Gizleme 0'dur, çünkü bu bir ayırıcıdır, geri dönüş içerikinin bir parçası değildir.

### Adım 3: Gizli çapraz entropy kaybı

Standart çapraz entropi, ancak kayb maskasıyla çarpılır.

> 标准交叉, ama çarpı kaybı mask码, sadece 回复 token 贡献梯度
...
> - Evet .`num_response_tokens`- Hayır .`seq_len` Eğer toplam dizi uzunluğu dışında, daha uzun bir emir oluşur.
...
> Dördüncü sınıfın MiniGPT'si. Eğitim döngüsü, ön eğitim ile neredeyse aynı görünüyor, ancak formüle edilme ve gizlenme kayıpları vardır.
...
> Öğrenme oranı 2e-5, Llama 2 Çat 一致──与预训练的 3e-4 相比小 15倍──梯度被掩码: 指令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令令
...
> SFT'nin tüm anlamı davranış değişimindedir. Bu, bir kontrol modeli ile nasıl bir şekilde giriş biçimindeki talimatlara karşı yanıt verildiğini ölçmek için kullanılır.
...
> Sadece 8 örnekte, tekrarlama anlamlı olmayacaktır. Bu beklenilen bir şeydir. Önemli olan, model bir şekilde tekrarlama işaretinden sonra daha fazla emir üretmeye devam etmek yerine, çıkış üretir.
...
> SFT'nin genel kullanım yeteneğini bozarsa, orijinal metinde kayıplar artacaktır.
...
> Gerçekte, tüm antrenman süreci boyunca bu göstergeyi takip etmelisiniz. Eğer orijinal metin kaybı %10-15'den fazla artıyorsa, SFT'nin çok gelişmiş olduğunu gösterir.
