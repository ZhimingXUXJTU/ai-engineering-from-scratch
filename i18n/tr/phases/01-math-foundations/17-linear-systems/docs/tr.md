...
> 解 Ax=b matematikte en eski sorudur, bugün hala sinir ağını yönetiyor.
...
> Her antrenmanın bir geri dönüşü, her hesaplama en az iki katlılık, her hesaplama bir çözüme bağlı sistem.`y = Wx + b`, bu da bir taraftan 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を評価する. 線性系を修正する. 線性系を修正する. 線性系を修正する. 線性系を解くする. 線性系を解くする.
...
> 方程 Ax = b 无处不在──A 已知系数矩阵, b 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已知输出向量, x 已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已已
...
> Bu ders, bu denklemin tüm ana yöntemlerini sıfırdan kurmakla çözmek için kullanır. Bazı yöntemlerin neden hızlı ve bazılarının neden istikrarlı olduğunu, bazılarının neden sadece denklem sistemlerine uygulanabileceğini ve bazılarının neden bir çok sabit sistemle işleyebileceğini ve neden denklemin koşullarının sayısı cevaplarınızın anlamlı olup olmadığını belirleyeceğini anlayacaksınız.

## Konsepten bir şey.

> **【中文解读】**
> Ax = b'nin geometrik anlamı: Her bir denklem bir süper düzlem tanımlar, çözümü tüm süper düzlemlerin birleştiği noktalardır.

> **【拓展：线性系统在推荐系统中的规模】**
> Netflix Ödülü yarışmasında, matron çözümü sorunu 480.000 kullanıcı ve 17.770 filmle ilgiliydi. Bu yaklaşık 500.000 x 17.770 matron yüksek verimli matron çözümü algoritması gerektirir. Netflix Büyük Ödülü, büyük çapta matron çözümü algoritması geliştirilmesine yardımcı oldu.
...
> 线性方程组有几何解释──每个方程定义一个超平面──超平面──解是所有超平面的交点──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
> Matrix dilinde kullanılırken, "ön çözülme" A'nın tersine, "ön çözülme" sistem uyumsuzluğu anlamına gelir.
...
> **行视角。**A'nın her satırı bir eşittir. Her eşittir bir süper eşittir.

**Column picture.**A'nın her sütunu bir vektördür. soru şu olur: A'nın sütunlarının hangi doğrusal kombinasyonu b'yi üretir?

> **列视角。**A'nın her bir sırası bir yöntürtür. Sorun şu hale dönüşüyor: A'nın sırasının hangi yönlü birliği (Linear Combination) b'yi oluşturabilir?
...
> 列视角更根本── A'nın 列空间 (Column Space) içinde, sistem çözülmüştür.
...
> Yüksek tüketim oranı hesaplama miktarı O (n^3) ⋅ 1000x1000 sistemleri için yaklaşık olarak 10 milyar kez geçerli bir işlem gerektirir.

> **【中文解读】**
> Yüksek giderleme yasası fikri çok basit: matrajı üst üçgen biçimine dönüştürmek için bir adım atmak, sonra son satırdan "önümüze" başlamak için çözüm bulmak için bir adım atmak, önemli bir adımdır.
...
> 没有主元选取,高斯消元法可能失败或产生垃圾结果──如果主元为零,你会分为零──如果主元很小,你会放大舍进差──
...
> Sınırlı bir nokta işleminde, başlıca değer seçilen sürüm geçerli sayı kaybedebilir.
...
> Neden doğrudan gidermek yerine çözülür? Çünkü bir L ve U olduğunda, herhangi bir yeni b için Ax = b sadece O  n ^ 2 gerektirir:
...
> O(n^3) için bir kez ödenir. O(n^3) için bir kez ödenir.

Bölümsel dönüşümle, PA = LU elde edersiniz. Burada P, satır değişimlerini kaydeden bir değişim matrisi.

> kullanılır, elde edilir PA = LU, içinde P is recorded行交换的置换矩阵 (Permutation Matrix) ⋅

> **【拓展：LU 分解在大规模科学计算中的角色】**
> sınırlı değer analizi (FEA) içinde, yapısal mekanik yoğunluk matçları genellikle nadir milyonlu aşama matçlarıdır. SuperLU ve MUMPS等库 geçerek nadir LU'yu bu sistemleri çözebilir. Bir kez parçalanmasından sonra çok sayıda çözüm süresi 100-1000 倍 azalır. Hava tahminleri modeli her 6 saatte bir kez yenilenebilir.

### QR parçalanması

QR parçalanma faktörleri A'yı ortogonal bir matris Q ve üst üçgenli bir matris R: A = QR'ye dönüştürür.

> QR 分解将 A 分解为一个正交矩阵(Ortogonal Matrix) Q 和一个上三角矩阵 R:A = QR。

Ortogonal bir matrisin Q^T Q = I özelliği vardır. Sütunları ortonomal vektörlerdir.

> Doğrudan çarpı ırkın doğası var Q^T Q = I. ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇
...
> QR en az iki katlı sorun çözme çağının sayı değerinin LU daha daha sabitleştirilmesi için.
...
> Her adım, önceki yönlerin tümünü ortadan kaldırır, sadece yeni düz yönleri bırakır.
...
> A = A^T'nin karşılaştırılması ve doğru olması için, tüm özelliklerin değerini A = L^T'ye ayırmak için L = L^T'yi ayırmak gerekir.
...
> Cholesky LU'dan 快两倍, sadece depolama alanının yarısını gerektirir. Sadece düz düz düz matron olarak adlandırılmak için uygundur, ancak bu matron bulunmaz:
...
- Gaussian süreçlerinde çekirdek matrisi simetrik pozitif kesin.
  Yüksek süreçte nükleer matron doğru olarak belirlenmiştir.
- En az bir konveks fonksiyonun Hessian'ı simetrik pozitif kesin.
  凸函数在极小值处的 Hessian 矩阵 is对称正确──
...
> Yüksek bir süreçte, Cholesky'yi kullanarak K'yi çözün ve sonra K alfa = y'yi çözün. Cholesky'nin nedeni de bir sıralama biçimi verir: log det(K) = 2 * toplamı(log(diag(L)))。

> **【中文解读】**
> Cholesky 分解是 LU 分解的"特殊优惠版" yalnızca doğru düzgün矩阵 olarak adlandırılır, ancak hız LU'nun iki katıdır. İyi haber şu ki ML'de her yerde doğru düzgün矩阵 olarak adlandırılır: 方差矩阵、核矩阵、X^T X、Hessian 矩阵。GPTQ 等 modeller ölçüm yöntemlerinde de Cholesky 分解 Hessianı işlemek için kullanılır.
...
> Eğer A m x n 且 m > n ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N ∈ N                                                                                                                                                                                                                                                              
...
> Bu bağlantı kesin. Bu bağlantı, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, x'in bir çizgisinde, ve x'in bir çizgisinde, x'in bir çizgisinde, x'in ın ın ın ın ın ın ın ın ın ın ın                                                                                                                                                                                                                           
...
> Bu da bir dönüş yolu.`sklearn.linear_model.LinearRegression.fit()`(Yada QR veya SVD'nin benzer fiyat biçimi ile)

Matris'e düzenleme terimi lambda * I ekleyin ve bir kıyıs geri dönüşü elde edin:

> Ridge Regression'u tekrar elde edeceğim.
...
> Doğruluk, matç koşullarının sayısını daha iyi hale getirir (sadece doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyu doğruyuyuyuyu doğ

> **【拓展：条件数与深度学习训练稳定性】**
> Transformer trenöründe derece patlama/kaybolma sorunu koşul sayısı ile yakından ilişkili olacaktır. Reddar bağlantı ((ResNet) ve katman birleştirme ((LayerNorm) özünde her katmanın koşul sayısını iyileştirir. Araştırmalar, X^T X'in koşul sayısının 10^10'dan fazla olduğu zaman, float32 精度下线性归归的结果可能完全不可靠──混合精度訓練 ((FP16/BF16) koşul sayısına daha duyarlı olması, bu kayıp ölçeklendirme gerektirmesi nedeninin nedeni olduğunu göstermektedir.

### Pseudoinverse (Moore-Penrose)

Pseudoinverse A+, metrik inversiyonunu kareler olmayan ve tekerlekli metriklere genelleştirir.

> 伪逆(Pseudoinverse) A+矩阵求逆推广到非方阵和奇异矩阵── herhangi bir矩阵 A için:
...
> Sigma+ her bir değişik değerden alınır ve değiştirilir. A = U Sigma V^T ise A+ = V Sigma+ U^T。
...
> 条件数(Kondisyon Numarı) küçük değişikliklere karşı hassasiyet derecesini ölçmek için:
...
> ML'de,当特征近似共线 (Collinear) 时会出现病态条件──正则化 (正则化) 添加 lambda * I) 条件数将从 sigma_max / sigma_min 改善为 (sigma_max + lambda) / (sigma_min + lambda) ⋅
...
> 共梯度法 (Conjugate Gradient, CG) A'da doğru zaman araması için A = b── en çok n defa 代就能找到精确解 (精确算术) ama A'nın özellikleri değerleri bir araya gelirse, genellikle daha hızlı olarak elde edilir.
...
- Büyük ölçekli optimizasyon (Newton-CG yöntemi)
  Büyük ölçekli optimization (Newton-CG  metodu)
...
> **【中文解读】**
> 共梯度法 is a large scale rare疏系统的救星──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存储整个矩阵的内存──它不需要存的内存的内存的内存──它不需要存的内存的内存的内存的内存的内存的内存.
...
> Bu dersten her yöntem şu anda ML üretimi içinde ortaya çıkıyor:
...
> **线性回归。**解析解求解正规方程 X^T X w = X^T y。通过 Cholesky(n 较小时) veya QR((需要数值稳定性时) veya SVD(矩阵可能不满秩时)完成。
...
> **岭回归。**X^T X 上加 lambda * I。正则化系统 (X^T X + lambda * I) w = X^T y 总是可以通过Cholesky 求解,因为当 lambda > 0 时 X^T X + lambda * I 是对称正确的──
...
> **高斯过程。**预测 平均值需要求解 K alpha = y,其中 K 是核矩阵。Cholesky 分解 K 是标准方法。对数边际似然使用 log det(K) = 2 sum(log(diag(L)))。
...
> **神经网络初始化。**Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Çeviri: Ç Çeviri: Çeviri: Ç Ç Ç Ç Ç Ç Ç Ç Ç Ç Ç Ç Ç Çvivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivivi
...
> **预处理。**Büyük ölçekli optimizer kullanımı tamamıyla Cholesky veya tamamıyla LU  olarak                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           

**Feature engineering.**X^T X'in koşul numarası, özelliklerin üst çizgisi olup olmadığını söyler.

> **特征工程。**X^T X'in koşul sayısı, özelliklerin ortak olduğunu söyler.
...
> Bu bölümleri bir araya getirmek ve gerçek veriler üzerinde linear geri dönüş ve geri dönüş yapmak için:
...
- Normal denklemlerin ve sklearn'ın Hattı Gerileme'nin aynı ağırlıkları ürettiğini gösteren bir çalışma göstergesi
  Normal ve Sklern'in Linear Regression  Aynı ağırlık gösterisi oluşur
