# Jamba  Transformador SSM híbrido  Jamba  Transformador SSM misturado
...
> **【中文解读】**Transformador Usando segunda complexidade de atenção para trocar qualidade, SSM Usando linhação tempo de cálculo e números constantes de qualidade de troca de eficiência mas o tamanho é pouco diferente.

> **【拓展：SSM+Transformer→未来架构】**純SSM 和純Transformer 在长上下文任务上各有局限性──混合架构──Jamba、Mamba-3) combina as vantagens dos dois, possivelmente é a principal direção do modelo 2026-2027 长上下文.

> - Não .**【前置】**学本节前请先掌握:Fase 07(Transformers); estado espacial模型(SSM, Mamba) conceito;MoE(Mixura de Especialistas)。本节是SSM 和 Transformer 混合架构的代表作────
> - Não .**【类比】**Jamba = "长短记忆组合"──Transformer = 短期记忆(精确但贵,每件事都需要注意力);Mamba = 长期记忆(粗略但便宜,用状态压缩历史)──1:7 比例 = 偶尔做精确记忆,大多数时候用快速压缩记忆──两者结合在 256K 上下文 下既精确又便宜──
...
- Descreva como é que a recorrência de um MSS se apresenta a um nível elevado e por que permite a inferência de memória constante.
  Explicar o que é a regresso do SSM em termos macroscópicos e por que pode realizar o teorema de persistência constante
...
- Nomear as três inovações Mamba-3 (discretizamento exponencial-trapezoidal, atualização de estado com valor complexo, MIMO) e o problema que cada uma delas visa.
  Explicar três inovações do Mamba-3 (Index gradient dispersion, MIMO) e suas questões específicas
...
> O modelo de estado espacial é linear. Esta diferença é muito significativa após a acumulação: 256k tokens, transformador de atenção.
...
> 純SSM 模型(Mamba、Mamba-2) em pequena escala 困惑度, mas em estado de seguimento missão atrasada, em certos acima abaixo abaixo atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás atrás
...
> 显而易见的修复:两者都用──在需要精确回忆的地方放 Transformer层──其他地方使用SSM层──调整比例──Jamba é o primeiro modelo de nível de produção de este esquema em grande escala de entrega 混合参数52B 总参数,12B 活跃,256k 上下文,单张 80GB GPU)──Jamba 1.5 将家族扩展到398B 总参数 / 94B 活跃参数──Mamba-3ICLR 2026) é a melhor linha de produção de este tipo de esquema, a estrutura mista pode ser reconstruída em torno dele──

Esta lição lê os três artigos e produz o modelo mental para "escolher a relação certa".

## O conceito central.

> **【中文解读】**Jamba é um conjunto de sistemas de Mamba (Mamba) e de sistemas de Mamba (Mamba) que são desenvolvidos por AI21 Labs.

> **【拓展：SSM 与 Transformer 的融合趋势】**Mamba 等 SSM 推理复杂度是O(1)(固定状态),而Transformer 是O(n)(KV-cache 随序列增长)。Jamba 将两者结合:SSM 处理长程依赖(高效),注意力处理需要精确回溯的任务(准确)。 Essa estrutura misturada pode ser a futura direção do推理。
...
> **【拓展：Mamba/SSM 的优势与局限】**Mamba 推理复杂度 O(1),远优于Transformer 的 O(n) ・・・ mas SSM 在精确回溯任务上弱于注意力──Jamba 混合策略是折中方案──
...
> 本课产 出 `outputs/skill-hybrid-picker.md` Foram definidas as regras de carga de trabalho (construção de longo prazo, conjunto de tarefas, orçamento de memória), que são recomendadas entre a mistura de Transformador e SSM, e fornecem uma explicação clara sobre o peso de memória e qualidade.
...
1. Corra .`code/main.py`Para calcular o cache KV em contexto de 256k para um transformador puro de 32 camadas (escondido 4096, 32 cabeças) e para um híbrido Jamba-1 da mesma forma. Verifique a redução de memória ~8x que o papel AI21 afirma.
   Tradução: 运行`code/main.py`計算 32 層純變壓器(隱藏 4096.32 头) 和相同形的Jamba-1 混合模型在 256K 上下文下 KV 缓存──验证 AI21 论文声称的约8倍内存减少──

2. Modifique a calculadora para modelar um híbrido 1:3 (4 Mamba: 1 Atenção) e um híbrido 1:15 (14 Mamba: 1 Atenção).
   Chinese: Modified kalkulator 模模 1:3 混合(4 Mamba: 1 Atenção) e 1:15 混合(14 Mamba: 1 Atenção) ・・・ desenhar KV 缓存与比率的关系──在什么比率下 KV 缓存等于 SSM 状态内存?
...
3. Leia a Seção 3 do artigo Jamba (arXiv:2403.19887). Explique por que a AI21 usa Mamba-1 em vez de Mamba-2 apesar de Mamba-2 ser mais rápido.
   Tradução do idioma japonês: 阅读 Jamba 论文第 3 节──解释为什么 AI21使用 Mamba-1而非更快的 Mamba-2──提示:混合消融部分有文档记录──
...
4. Calcule o parâmetro de sobrecarga de MoE-cada outra camada no Jamba 1.5 Large (398B total, 94B ativo). Compare a relação ativa com a DeepSeek-V3 (37B/671B) e explique por que a arquitetura do Jamba empurra a relação ativa para cima.
   Chinese Translation:计算 Jamba 1.5 Large(398B 总计,94B 激活) 中每隔一层 MoE 的参数开销──将激活率与DeepSeek-V3(37B/671B) Comparar, explicar por que a estrutura de Jamba impulsionar a taxa de activação mais alta──
...
5. Leia a Seção 3 do documento Mamba-3 (arXiv:2603.15569). Explique em três frases por que uma atualização de estado com valor complexo é equivalente a uma incorporação rotativa dependente de dados.
   Chinese Translation: read Mamba-3 论文第 3 节──用三句话解释为什么复数值状态更新等于数据依赖的旋转嵌入──将答案与第7阶段第04课的RoPE推导联系起来──
