# Video Compreensão  Modelagem Temporal  vídeo Compreensão  时序建模
...
> **【中文解读】**视频 é um conjunto de sequências de imagens, juntamente com as suas leis físicas.
...
> 30 segundos 30fps de vídeo é 900 张图像―― simplesmente olhando, o vídeo é dividir imagens em 900 vezes, então aglutinar―― quando o movimento é praticamente todos os dias visível, mas quando o movimento é definido por si mesmo, é um fracasso grave: "Pegar as coisas de esquerda para direita" em cada um parece ser dois objetos estáticos―
...
> A questão central de cada arquitetura de vídeo é: quando é construída a estrutura, e como é construída?
...
> Este curso tem um significado mais curto do que o curso de imagem estática. O mecanismo central da imagem já está em vigor, o vídeo compreende principalmente sobre histórias de tempos: tomada de modelos, construção e aglutinação.
...
> A partir de então, o núcleo nuclear será substituído por um núcleo 2D (H, W) que será substituído por um núcleo 3D (T, H, W).
...
- Requer uma escolha cuidadosa de padrões de atenção ou balões de corrida.
  O tempo de execução é muito mais longo.
...
> Os 10 segmentos de 30 fps têm 300; serão todos 300 para qualquer modelo são um desperdício.

- **Uniform sampling**Escolha quadros T uniformemente ao longo do clip.
  Tradução:**均匀采样**在片段中等间距选 T ──2D+pool 的默认方式──
- **Dense sampling**Janela de quadro T contíguo aleatório. Comum para convas 3D porque o movimento requer quadros vizinhos.
  Tradução:**密集采样**随机连续 T 窗口──3D 卷积常用,因为运动需要相邻──
- **Multi-clip** amostrar várias janelas de quadro T do mesmo vídeo, classificar cada uma, previsões médias no momento do teste.
  Tradução:**多片段** de um mesmo vídeo  de várias janelas,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de uma mesma categoria,  de um mesmo tipo,  de um mesmo tipo,  de uma mesma categoria, 

T é geralmente 8, 16, 32 ou 64. T superior = mais sinal temporal em mais computação.

> T normalmente é 8、16、32 ou 64。T 越大 = 更多时序信号, mas calcular quantidade é maior。

### Avaliação

Dois níveis:
- **Clip-level accuracy**O modelo vê um clip de quadro T, relata top-k.
  Tradução:**片段级精度**模型看一个T 片段, relatório top-k――
- **Video-level accuracy** previsões médias de nível de clipe em vários clips por vídeo; mais altas e mais estáveis.
  Tradução:**视频级精度** Prevê-se uma média de mais de um vídeo; mais alta e mais estável.
...
- **Kinetics-400 / 600 / 700** o conjunto de dados de ação de finalidade geral. 400 mil clips; URLs do YouTube (muitos já mortos).
  Chinese:Kinetics-400/600/700通用动作数据集──40万片段;YouTube 链接(muitos já foram errados)──
...
- **UCF-101**- Não .**HMDB-51** mais velhos, menores, ainda relatados.
  Tradução do português:UCF-101、HMDB-51较老、较小,仍在报告──
- **AVA** ação *localização* no espaço e no tempo; mais difícil do que a classificação.
  Tradução do inglês para o português:AVA时空动作定位;比分类更难──
...
> 均采样和密集采样器, utilizados para a lista de
...
> Em cada dia, a 2D ResNet-18 é executada, e depois, a classe é dividida.
...
> Uma mil milhões de parâmetros,ImageNet  pré-treinamento, de cada vez mais executado ̇ média ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇ ̇
...
> Além de`time_kernel` manter a amplitude de valor ativo quase inalterável Isto é importante para não danificar a estatística de reintegração de lote na primeira fase de propagação.
...
> A partir daí, o volume 3D será dividido em 2D (espaço) e 1D (tempo).
...
> 完整的R(2+1) D 网络就是将ResNet-18 中的每个3x3卷积换为 `Conv2Plus1D`- Não.
