# Segmentação semântica  U-Net  语义分割  U-Net
...
> **【中文解读】**语义分分就是分类每个像素. U-Net 通过配对下采样编码器和上采样解码器,并连接它们之间的跳跃连接实现这一点.

> **【拓展：U-Net 的广泛应用】**U-Net foi originalmente concebido para a divisão de imagens médicas, mas tornou-se uma infraestrutura de muitos campos: Difusão estável Usando U-Net como um núcleo de rede de ruído, divisão de estradas em autônomo, cobertura de terra de imagens satélites, seu módulo de codificador-descódigo + ligação de salto foi amplamente copiado.
...
> Portagem de imagem em cada imagem: Output of a tag.`H x W`de entrada, saída é forma`H x W`(语义) ou `H x W x N_instances`(exemplo) de张量──那是每张图像数百万预测,而不是一个──

> **【中文解读】**O problema central da divisão é: tanto para ver a imagem em geral como para manter os detalhes locais. Esta imagem é de maneira ou de forma humana.
...
> A estrutura de divisão é a causa de que ele impulsiona quase todos os produtos de previsão visual: medicina imagem (瘤掩码) 自動駕駛 (道路,车道,障碍物) 卫星 (卫星) 建筑轮,作物边界 (object boundary) 文档解析 (布局区域) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 机器人) 机器人 (机器人) 机器人 (机器人) 机器人 (机器人) 
...
> 架构问题说起来简单但解决起来不简单:你需要网络同时看图像的全局上下文 (tudo que é um tipo de cenário) e de imagens locais detalhes (concretamente qual imagem é de estrada ou de estrada) 标准CNN 通过空间缩缩获得上下文,但这会丢弃细节――U-Net é simultaneamente obter os dois design――
...
- **Semantic**Diz: "este pixel é estrada, aquele pixel é carro". Dois carros ao lado colapsa em uma única mancha.
  Chinese Translation:语义分割说" esse é um caminho, aquele é um carro".
- **Instance**diz "este pixel é carro #3, esse pixel é carro #5. " Ignora as coisas de fundo ("coisas" = céu, estrada, grama).
  Chinese: 中文翻译:实例分割说" esse é o terceiro veículo, esse é o quinto veículo"──忽略背景类别("stuff" = 天空、道路、草地)──
- **Panoptic**Unifica ambos: cada pixel recebe um rótulo de classe, cada instância recebe um ID único, coisas e coisas ambos segmentados.
  Chinese Translation: 全景分割统一了两者:每个像素获得类别标签, cada instante obtém uma única ID,背景和前景物体都被分割──

Esta lição abrange a semântica.

> 本课覆盖语义分割──下一课(Máscara R-CNN) 覆盖实例分割──
