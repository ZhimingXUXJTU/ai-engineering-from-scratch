# Detecção de pontos-chave e avaliação de posição .
...
> **【中文解读】**姿态 é um conjunto de pontos-chave organizados (como 17 个关节点) ⋅ 关键点检测器 é, em essência, um gerador de calor para cada ponto-chave ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅ ⋅      ⋅                                                                                                                                                                                 

> **【拓展：姿态估计的应用】**OpenPose、MediaPipe、YOLO-Pose é um instrumento de avaliação de postura comum.
...
> 关键点任务隐藏在许多名称下: 个体姿态(17 个体关节) 面部特征点(68 个点) 、手部(21 个点) 、 animal姿态、机器人物体姿态、医学解剖标志── cada um tem a mesma estrutura: K 个离散点并输出它们的 (x, y) 坐标──
...
> gestão estimativa é a base para a captura de movimento, aplicação de fitness, análise de movimento, controle de movimentos, animação, AR  tentativa de atravessar e máquina de capturar.

A questão da engenharia é escala. Uma imagem única, uma pessoa só é um problema de 20ms.

> 工程問題是尺寸──单图片、单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿態──单人姿态──单人姿态──单人姿态──单人姿态──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人姿──单人──单人姿──单人──单人姿──单人姿──单人姿──单人──单人──单人姿──单人──单人──单人──单人姿──多人──多人──多人──多人──多人──人──人──人──人──人──人──人──人──人──人────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
- **Top-down** detectar as pessoas primeiro, em seguida, executar um modelo de ponto chave por pessoa em cada colheita.
  Tradução:**自顶向下** Primeiro inspecte o quadro humano, em seguida, para cada área de corte de cada um dos principais pontos de execução.
- **Bottom-up** uma passagem avançada prevê todos os pontos-chave mais um campo de associação; agrupá-los.
  Tradução:**自底向上** Uma vez antes de uma vez, todos os pontos-chave são adicionados; depois, os grupos de pessoas são grandes e grandes.

Top-down (HRNet, ViTPose) é o líder de precisão; bottom-up (OpenPose, HigherHRNet) é o líder de throughput para cenas lotadas.

> Desde o topo até o baixo (HRNet、ViTPose) é líder de precisão; desde o fundo até o alto (OpenPose、HigherHRNet) é líder de tótomo de cenário de aglomeração.
...
> Não voltar diretamente .`(x, y)`Mas para cada um deles .`H x W`Coloque-o em um ponto alto no centro da sua posição real.
...
> Por que o calor é melhor do que o regresso direto: estrutura espacial da rede (volume de características) com o espaço de saída natural para o conjunto.
...
> Argmax  dá um conjunto de números inteiros  para obter a precisão de um pixel, pode ser feito através de uma linha de poluição para o argmax  e seus vizinhos.
...
> 标准人体姿态数据集:每人 17 个关键点,PCK(正确关键点百分比) e OKS(目标关键点相似度) como medida。OKS é o conteúdo do relatório, COCO mAP@OKS 内容──
...
> Cada ponto-chave de energia térmica se acumula ao longo do caminho, formando um objetivo completo.

### Passo 2: Cabeça de teclado

Um modelo de estilo U-Net que sai canais de heatmap K.

> Um modelo de U-Net, saída K 个热力图通道──
