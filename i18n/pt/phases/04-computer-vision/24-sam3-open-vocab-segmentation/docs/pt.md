...
> **【中文解读】**Dá-lo um texto e uma imagem, vamos conseguir todos os objetos correspondentes de divisão escondido. SAM 3Segmento Qualquer coisa Modelo 3 transformará este processo em uma única fase de divulgação.

> **【拓展：SAM 的革命性影响】**SAM 系列模型(Meta 发布) é um "modelo básico" de divisão, pode ser usado para dividir qualquer objeto.
...
> SAM de 2023 é um modelo de apenas indicação visual: você clica em um ponto ou desenha um quadro, ele retorna um esconderijo.
...
> SAM 3(Meta,2025 年 11 月,ICLR 2026) dobrou o nível de ligação.**可提示概念分割（PCS）**◊结合 2026 年 3 月的 Object Multiplex 更新(SAM 3.1), é capaz de ser altamente eficaz em vários exemplos de seguir o mesmo conceito no vídeo──
...
> Esta aula descreve a transformação estrutural que isso representa. 2D: divisão, análise e base de texto-imagem já se uniram para um modelo. A questão de produção não é mais "eu coloco quais fluxos de água ligados juntos", mas "qual modelo pode ser sugerido para processar meu uso de exemplo".
...
> "提示概念词" é uma palavra abreviada短语或一个图像示例―― modelo retorna à imagem para combinar todos os exemplos desse conceito, além de cada identificação de um único exemplo de correspondência―.

Isto difere do SAM visual-prompto clássico em três maneiras:

> Isto tem três diferenças com o visual SAM clássico:

1. Não é necessário solicitar por instância  um pedido de texto retorna todas as correspondências.
   Não é necessário cada exemplo de um texto de um texto de outro.
2. O conceito de vocabulário aberto pode ser qualquer coisa descrevida na linguagem natural.
   O conceito de "conhecimento" pode ser descrito em qualquer linguagem natural.
3. Retorna várias instâncias ao mesmo tempo em vez de uma máscara por pedido.
   Tradução do inglês: One time return multiple instances, instead of each hint one mask码.
...
- **Shared backbone** um único ViT processa a imagem. Tanto a cabeça do detector quanto o rastreador baseado em memória lê-lo.
  Tradução:**共享骨干** Único ViT  processamento de imagens  teste de cabeçalhos e rastreadores baseados em memória 
- **Presence head** prevê se o conceito está presente na imagem. Decouples "este aqui?" de "onde é?". Reduz falsos positivos sobre conceitos ausentes.
  Tradução:**存在性头** prevétion concept existem na imagem.将" isto aqui? " ou " isto aqui? "
- **Decoupled detector-tracker** A detecção a nível de imagem e o rastreamento a nível de vídeo têm cabeças separadas para que não interfiram.
  Tradução:**解耦的检测器-跟踪器** Imagem de nível de inspecção e vídeo de nível de acompanhamento têm cabeças independentes, interfere em si mesma.
- **Memory bank** armazenar recursos por instância em quadros para rastreamento de vídeo (mesmo mecanismo SAM 2 usado).
  Tradução:**记忆库**   armazenamento de cada instante características, para o vídeo seguimento 
...
- **YOLO-World** Detector de vocabulário aberto apenas (sem máscaras). em tempo real. Melhor quando você precisa de caixas em alta fps.
  Tradução:**YOLO-World**仅开放词汇检测器 (→ "exclusividade")
- **SAM 3** Segmentação completa + rastreamento.
  Tradução:**SAM 3** completa divisão + acompanhamento.
...
> Produção:YOLO-World Used for Quick Speed Only Testing Fluidline (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (RJ) (R) (RJ) (R) (RJ) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (R) (
