...
> - Não .**【前置】**O programa de trabalho é um programa de trabalho de um grupo de estudantes que trabalha em um grupo de estudantes.
> - Não .**【类比】**O contrato de extensão é o de um contrato de extensão, o de um contrato de extensão é o de um contrato de extensão.
...
> O agente irá espalhar-se. A missão é "reparar o bug de registro" e "reparar o bug de registro".
...
> O alcance de expansão é o modelo de falha mais pouco controlado do trabalho do Agente, pois o Agente narra honestamente cada passo.


> **【中文解读】**范围契约定义 Agente pode fazer o que e não pode fazer o que. 显然的范围契约包括: 1) 文件范围Agent pode modificar quais documentos e catálogos; 2) 操作范围可以执行哪些命令; 3) 依赖范围可以安装哪些包──范围越明确,Agent's predictability越高──
...
> 范围契约(Scope Contracts) define a operatividade do Agente.
