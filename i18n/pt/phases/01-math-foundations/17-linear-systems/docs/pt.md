...
> 解 Ax=b é a mais antiga questão da matemática, que ainda hoje está a impulsionar a sua rede neural.
...
- Resolver Ax = b usando a eliminação de Gaussian com rotação parcial e substituição de volta
  Utilize带部分主元选取(Partial Pivoting) de 高斯消元法和回代法求解 Ax = b
- Matriz de fatores com decomposições LU, QR e Cholesky e explicar quando cada uma é apropriada
  Utilize LU、QR 和 Cholesky 分解(Decomposition) descomponha a matriz,并 explica as situações de uso de cada método
...
- Diagnóstico de sistemas mal condicionados usando o número de condição e aplicar regularização para estabilizá-los
  Utilizando condições (condição)


> **【中文解读】**
> 解 Ax=b é o mais antigo problema da matemática.                                                                                                                                                                                                                                                        
...
> Cada treinamento de regresso linear, você está em um sistema linear. Cada cálculo mínimo de duas vezes, você está em um sistema linear.`y = Wx + b`, está em um lado do sistema linear de avaliação. Quando adiciona a normalização, você modifica o sistema. Quando usa o processo de Gaussian, você faz a matriz de descomposição.
...
> 方程 Ax = b 无处不在──A é uma matriz de fatores conhecidos, b é uma matriz de saída conhecida, x é a matriz de saída que você requer.
...
> Esta aula vai buscar todos os principais métodos para resolver a equação a partir de zero. Você vai entender por que alguns métodos são rápidos e alguns estáveis, por que alguns só são aplicáveis a sistemas de quadros e alguns podem tratar super-definidos sistemas, e por que o número de condições de matrizes determina se sua resposta é significativa.

## O conceito central.

> **【中文解读】**
> Ax = b significação geográfica: cada linha de equação define um superplano, o que é o ponto de interseção de todos os superplano. Para o sistema super-definido, não há uma solução precisa, o mínimo de duas vezes encontra o "melhor tipo" de "melhor aproximação" do restante.

> **【拓展：线性系统在推荐系统中的规模】**
> No concurso do Prêmio Netflix, o problema da matriz de decomposição envolveu 480.000 usuários e 17.770 filmes. Esta matriz de cerca de 500.000 x 17.770 requere algoritmos de decomposição de matriz de alta eficiência. O grande concurso da Netflix impulsionou o desenvolvimento de algoritmos de decomposição de matriz em grande escala (SVD、ALS), que ainda são o núcleo do sistema de recomendação.
...
> 线性方程组有几何解释── cada方程 define um superplano (超平面)──解是所有超平面的交点 (交点) ──
...
> Usar um矩阵语言说, "一个解" significa A 可逆――"无解" significa sistema não concordar――"无穷多解" significa A 有零空间(Zero Space)―― a maioria dos problemas de ML pertence à classe "无精确解", pois o número de quadros (não precisam) é maior que o número desconhecido (não conhecido).
...
> **行视角。**Cada linha de um define um quadrado. Cada quadrado é um superplano.

**Column picture.**Cada coluna de A é um vetor. A questão se torna: qual combinação linear das colunas de A produz b?

> **列视角。**Cada linha de A é um movimento. A questão se transforma em:
...
> Se b estiver no espaço de colunas, o sistema tem solução. Se b não estiver no espaço de colunas, você encontrará o ponto mais próximo do espaço de colunas.
...
> Quanto ao sistema 1000x1000, cerca de 10 milhões de vezes são necessárias para o cálculo de pontos de movimento.

> **【中文解读】**
> A ideia da lei de Gross Consumo é muito simples: através de uma linha de mudança de matrizes em forma de triângulo, então, desde a última linha, a "recorrência" é uma busca de solução.
...
>  Sem principal divisão, a lei de Gross Consumo pode falhar ou produzir resultados de lixo
...
> Em operações de flows de precisão limitada, a versão sem principal pode perder um número válido.
...
> Porque, uma vez que há L e U, para qualquer novo b, a solução Ax = b só precisa de O (n^2):
...
> O preço de O (n^3) é pago apenas uma vez quando se desintegra.

Com a rotação parcial, você obtém PA = LU onde P é uma matriz de permutação gravando os swaps de fila.

> Utiliza parte principal de seleção, obtém PA = LU, em que P é registado de câmbio de câmbio de matrizes (Permutation Matrix)

> **【拓展：LU 分解在大规模科学计算中的角色】**
> No sistema de análise de valores limitados (FEA), a rigidez das matrizes de estruturas é geralmente de milhões de fases raras. SuperLU e MUMPS são utilizados para resolver estes sistemas.
...
> O que significa que o volume de um sistema de rotas é igual ao volume de um sistema de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rotas de rot
...
> QR em busca de solução do problema mínimo de duplicação de tempo numérico em relação ao LU mais estabilizado.
...
> Cada passo é o de deslocar todas as divisões de direções anteriores, apenas deixando novas direções de correção.
...
> Quando A é对称的(A = A^T)且正确(todos os traços são valores正), você pode descompô-los em A = L L^T, em que L é a baixa três rectangular.
...
> Cholesky 快两倍比 LU, apenas precisa de metade do espaço de armazenamento. É apenas aplicável a matrizes de posição, mas essa matrizes não estão em geral presentes:
...
- A matriz do núcleo nos processos de Gaussian é simétrica positiva definida.
  A matriz nuclear no processo de alta é a de "regularidade".
...
> Durante o processo de alta, você usa Cholesky para resolver a matriz K, e então procura resolver K alfa = y  obter o valor médio previsto. Cholesky 因子 também fornece uma linha de ordem em número: log det(K) = 2 * soma

> **【中文解读】**
> Cholesky 分解是 LU 分解的"特殊优惠版"只适用于对称正定矩阵,但速度是 LU 的两倍. Boas notícias são que em ML todos os tipos de matrizes são chamados de正定矩阵:协方差矩阵、核矩阵、X^T X、Hessian 矩阵。GPTQ etc.
...
> Se A é m x n 且 m > n 方程数多于未知数), sistema é super determinado (overdeterminado) 没有精确解.
...
> 推导:展开A 求梯度并设为零:2 A  A x - 2 A  T b = 0──
...
> Esta ligação é precisa. Em regresso linear, data matrizes X cada linha de um modelo, cada linha de um traço, o objetivo de um modelo e cada modelo de um item, o peso de um modelo, o que se pode satisfazer:
...
> É a solução do regresso.`sklearn.linear_model.LinearRegression.fit()`Do mesmo modo, o preço do produto é calculado através de QR ou SVD.

Adicione um termo de regularização lambda * I à matriz e você obtém regressão de cresta:

> Em um rectangular, adicione a regra de regressão.
...
> Normalismo faz o número de condições de matriz melhor (precisa-se melhor) e faz o peso reduzir para zero para evitar o excesso de matriz. Quando lambda > 0 时, matriz X^T X + lambda * I 总是对称正确,所以可以用Cholesky 求解──

> **【拓展：条件数与深度学习训练稳定性】**
> O problema da escala explodindo/desaparecendo no treinamento do transformador está intimamente relacionado com as condições. O problema é que o nível de redução de tensão é melhorado em cada nível.

### Pseudoinversos (Moore-Penrose)

O pseudoinverso A+ generaliza a inversão de matriz para matrizes não quadradas e singulares.

> 伪逆(Pseudoinverse) A+ 将矩阵求逆推广到非方阵和奇异矩阵── para qualquer矩阵 A:
...
> Sigma+ por cada não-零奇异值取倒数并转置得到──如果A = U Sigma V^T, então A+ = V Sigma+ U^T──
...
> 条件数(Conditions Number) Messa a sensibilidade à entrada de pequenas variações.
...
> Em ML, quando os caracteres de proximidade são compartilhados, a condição de correlação é:
...
> Para sistemas muito grandes, com um número muito pequeno, LU ou Cholesky etc. método direto é muito caro.
...
> 共梯度法 (Conjugate Gradient, CG) em A é对称正定时求解 Ax = b。 é o maior número de vezes em que se consegue encontrar uma solução precisa (精确算术), mas se os valores de características de A se agruparem, normalmente se obtêm mais rapidamente。
...
- Optimização em larga escala (método Newton-CG)
  Massel 优化 (Método de Newton-CG)
- Resolver discretas de PDE
  Solução de separação de uma pequena equação
- Métodos do núcleo onde a matriz do núcleo é grande demais para factorizar
  Nuclear matrizes muito grandes não podem ser desintegrados
...
> A taxa de recepção depende da quantidade de condições.

> **【中文解读】**
> Compartilhar a escala é um grande resgate de um sistema de distribuição de dados. Não é necessário armazenar toda a matriz, mas é necessário apenas uma matriz de distribuição de dados.
...
> Cada método desta aula aparece na produção de ML:
...
> **岭回归。**Em X^T X 上加 lambda * I。正则化系统 (X^T X + lambda * I) w = X^T y 总是可以通过Cholesky 求解,因为当 lambda > 0 时 X^T X + lambda * I 是对称正确的──
...
> **高斯过程。**预测 média precisa de buscar solução K alfa = y, em que K é a matrizes nucleares.
...
> **神经网络初始化。**O sistema de inicialização é utilizado para criar uma linha de peso de um padrão de rede.
...
> **预处理。**Otimizador de grande escala utiliza não totalmente Cholesky ou não totalmente LU como condição de pré-processamento do requisitador de gradiente.

**Feature engineering.**O número de condição de X^T X diz-lhe se suas características são colineares.

> **特征工程。**O número de condições de X^T X diz-lhe se os traços são comuns. Se o kappa é grande, remove os traços ou adicione a normalização.
...
> Para combinar estas partes, fazer regressão linear e regressão em dados reais:
...
- Uma demonstração de trabalho de que as equações normais e a Regressão Linear de sklearn produzem os mesmos pesos
  Normal e equilíbrio de cálculo Regressão linear  produzir o mesmo peso
