...
// Last built: 2026-09-17T03:58:39.012Z
    ...
    "lessons": [
      {
        ...
        "keywords": "Step 1: System Foundation | 第1步：系统基础层 · Step 2: Python with uv | 第2步：使用 uv 安装 Python · Step 3: Node.js with pnpm | 第3步：安装 Node.js 和 pnpm · Step 4: Rust | 第4步：安装 Rust · Step 4: Rust · Step 5: Julia (Optional) | Julia（可选） · Step 6: GPU Setup (If You Have One) | GPU 设置（如果有显卡） · Step 7: Verify Everything | 第7步：验证一切"
      },
      {
        ...
        "keywords": "Step 1: Configure git · Step 2: The daily workflow | 日常工作流 · Step 3: Branching for experiments | 用分支做实验 · Step 4: Working with this course repo | 第4步：使用本课程仓库"
      },
      {
        ...
        "keywords": "Option 1: Local NVIDIA GPU | 本地 NVIDIA GPU · Option 2: Google Colab | 谷歌 Colab（免费 GPU） · Option 3: Cloud GPU | 云 GPU · No GPU? No problem. | 没 GPU？没关系。"
      },
      {
        "name": "APIs & Keys",
        "status": "complete",
        ...
        "keywords": "Step 1: Store API keys safely | 安全存储 API 密钥 · Step 2: First API call (Python) | 第一次 API 调用（Python） · Step 3: First API call (TypeScript) | 第3步：TypeScript 调用 · Step 3: First API call (TypeScript) · Step 4: Raw HTTP (no SDK) | 原始 HTTP 请求（不用 SDK）"
      },
      {
        ...
        "keywords": "Step 1: Pick your interface | 选择你的界面 · Step 2: Keyboard shortcuts that matter | 重要快捷键 · Step 3: Cell types | 单元格类型 · Step 4: Magic commands | 魔术命令 · Step 5: Display rich output inline | 第5步：内嵌富文本输出 · Step 6: Google Colab | 第6步：Google Colab · Notebooks vs Scripts: When to use which | 什么时候用笔记本、什么时候用脚本 · Common traps | 常见陷阱"
      },
      {
        ...
        "keywords": "Option 1: uv venv (Recommended) · Option 2: venv (Built-in) | 选项2：venv（Python 内置） · Option 3: conda (When You Need It) · For This Course: Per-Phase Strategy · 1. Installing globally · 2. Mixing pip and conda · 3. Forgetting to activate · 4. Committing .venv to git · 5. CUDA version mismatch | 第5个：CUDA 版本不匹配"
      },
      {
        "name": "Docker for AI",
        "status": "complete",
        ...
        "keywords": "Why AI projects need Docker more than most | 为什么 AI 项目特别需要 Docker · Key vocabulary | 核心词汇 · Common container patterns in AI | AI 中常见的容器模式 · Step 1: Install Docker · Step 2: Install NVIDIA Container Toolkit (Linux with NVIDIA GPU) · Step 3: Understand base images | 第3步：理解基础镜像 · Step 4: Write a Dockerfile for AI development · Step 5: Volume mounts for data and models · Step 6: Docker Compose for multi-service AI apps · Step 7: Useful Docker commands for AI work · No GPU?"
      },
      {
        "name": "Editor Setup",
        "status": "complete",
        ...
        "keywords": "Step 1: Install VS Code | 第1步：安装 VS Code · Step 2: Install Essential Extensions | 第2步：安装必备扩展 · Step 3: Configure Settings · Step 4: Terminal Integration · Step 5: Remote Development (SSH into GPU Boxes) | 第5步：远程开发（SSH 连接 GPU 服务器） · Cursor · Windsurf · Vim/Neovim"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Moving Around | 导航操作 · Files and Directories | 文件与目录操作 · Reading Files | 查看文件 · Searching | 搜索与查找"
      },
      {
    ...
    "lessons": [
      {
        ...
        "keywords": "Vectors Are Points (and Directions) | 向量是点（也是方向） · Matrices Are Transformations | 矩阵是变换 · The Dot Product Measures Similarity | 点积衡量相似度 · Linear Independence | 线性无关 · Basis and Rank | 基与秩 · Projection | 投影 · Gram-Schmidt Process | Gram-Schmidt 正交化 · Step 1: Vectors from scratch (Python) | 第1步：从零实现向量 · Step 2: Matrices from scratch (Python) | 第2步：从零实现矩阵 · Step 3: Why this matters for AI | 第3步：这和 AI 有什么关系 · Step 4: Julia version | 第4步：Julia 版本 · Step 5: Linear independence and projection from scratch (Python) | 第5步：线性无关性和投影 · Rank, Projection, and QR with NumPy | 秩、投影和 QR 分解 · PyTorch -- Tensors Are Vectors with Autodiff | PyTorch：带自动求导的张量"
      },
      {
        ...
        "keywords": "Vectors: ordered lists of numbers | 向量：有序数字列表 · Matrices: grids of numbers | 矩阵：数字网格 · Why shapes matter | 为什么形状很重要 · The operations map | 运算对照表 · Element-wise vs matrix multiplication · Broadcasting · Step 1: Vector class · Step 2: Matrix class with core operations · Step 3: See it work · Step 4: Connect to neural networks | 连接到神经网络"
      },
      {
      ...
      },
      {
        ...
        "keywords": "What optimization means | 什么是优化 · Gradient descent (vanilla) | 梯度下降（原始版） · Learning rate: the most important hyperparameter | 学习率：最重要的超参数 · SGD vs batch vs mini-batch | SGD vs 全批量 vs 小批量 · Momentum: the ball rolling downhill | 动量法：球从山坡滚下 · Adam: adaptive learning rates | Adam：自适应学习率 · Learning rate schedules | 学习率调度 · Convex vs non-convex | 凸优化 vs 非凸优化 · Loss landscape visualization | 损失曲面可视化 · Step 1: Define a test function | 第1步：定义测试函数 · Step 2: Vanilla gradient descent | 第2步：原始梯度下降 · Step 3: SGD with momentum | 第3步：带动量的 SGD · Step 4: Adam | 第4步：Adam 优化器 · Step 5: Run and compare | 第5步：运行并比较"
      },
      {
        ...
        "keywords": "Information Content (Surprise) | 信息量（惊喜度） · Entropy (Average Surprise) | 熵（平均惊喜度） · Cross-Entropy (The Loss Function You Use Every Day) | 交叉熵（你每天都在用的损失函数） · KL Divergence (Distance Between Distributions) | KL 散度（分布间的距离） · Mutual Information | 互信息 · Conditional Entropy | 条件熵 · Joint Entropy | 联合熵 · Mutual Information (Deep Dive) | 互信息（深入理解） · Label Smoothing and Cross-Entropy | 标签平滑与交叉熵 · Why Cross-Entropy Is THE Classification Loss | 为什么交叉熵是分类的标准损失 · Bits vs Nats | 比特 vs 奈特 · Perplexity | 困惑度 · Step 1: Information content and entropy | 第1步：信息量与熵 · Step 2: Cross-entropy and KL divergence | 第2步：交叉熵与 KL 散度 · Step 3: Cross-entropy as classification loss | 第3步：交叉熵作为分类损失 · Step 4: Cross-entropy equals negative log-likelihood | 第4步：交叉熵等于负对数似然 · Step 5: Mutual information | 第5步：互信息"
      },
      {
        ...
        "keywords": "The curse of dimensionality | 维度灾难 · PCA: find the directions that matter | PCA：找到重要的方向 · Explained variance ratio | 解释方差比 · Choosing the number of components | 选择成分数量 · t-SNE: preserve neighborhoods | t-SNE：保留邻域结构 · UMAP: faster, better global structure | UMAP：更快，全局结构更好 · When to use which | 何时使用哪种方法 · Kernel PCA | 核 PCA · Reconstruction Error | 重建误差 · Step 1: PCA from scratch | 第1步：从零实现 PCA · Step 2: Test on synthetic data | 第2步：在合成数据上测试 · Step 3: MNIST digits in 2D | 第3步：MNIST 手写数字 2D 可视化 · Step 4: Compare with sklearn | 第4步：与 sklearn 比较 · Step 5: UMAP comparison | 第5步：UMAP 比较"
      },
      {
        ...
        "keywords": "What SVD does geometrically | SVD 的几何含义 · The full decomposition | 完整分解 · Left singular vectors, singular values, right singular vectors | 左奇异向量、奇异值、右奇异向量 · Outer product form | 外积形式 · Relationship to eigendecomposition | 与特征值分解的关系 · Truncated SVD: low-rank approximation | 截断 SVD：低秩近似 · Image compression with SVD | 用 SVD 压缩图像 · SVD for recommendation systems | SVD 用于推荐系统 · SVD in NLP: Latent Semantic Analysis | SVD 在 NLP 中：潜在语义分析 · SVD for noise reduction | SVD 用于降噪 · Pseudoinverse via SVD | 通过 SVD 计算伪逆 · Numerical stability advantages | 数值稳定性优势 · Connection to PCA | 与 PCA 的联系 · Step 1: SVD from scratch using power iteration | 第1步：用幂迭代从零实现 SVD · Step 2: Test and compare with NumPy | 第2步：测试并与 NumPy 比较 · Step 3: Image compression demo | 第3步：图像压缩演示 · Step 4: Noise reduction | 第4步：降噪 · Step 5: Pseudoinverse | 第5步：伪逆"
      },
      {
        ...
        "keywords": "What a tensor is | 什么是张量 · Tensor shapes in deep learning | 深度学习中的张量形状 · How memory layout works | 内存布局原理 · Broadcasting rules | 广播规则 · Einsum: the universal tensor operation | Einsum：通用张量操作 · Step 1: Tensor storage and strides | 第1步：张量存储与步长 · Step 2: Reshape, squeeze, unsqueeze | 第2步：重塑、压缩、扩展维度 · Step 3: Transpose and permute | 第3步：转置与排列 · Step 4: Element-wise operations and reductions | 第4步：逐元素操作与归约 · Step 5: Broadcasting with NumPy | 第5步：用 NumPy 实现广播 · Step 6: Einsum operations | 第6步：Einsum 操作 · Step 7: Attention mechanism via einsum | 第7步：用 einsum 实现注意力机制 · Scratch vs NumPy | 手写 vs NumPy · Scratch vs PyTorch | 手写 vs PyTorch · Every neural network layer as a tensor operation | 每个神经网络层都是张量操作"
      },
      {
        ...
        "keywords": "IEEE 754: How Computers Store Real Numbers | IEEE 754：计算机如何存储实数 · Why 0.1 + 0.2 != 0.3 | 为什么 0.1 + 0.2 != 0.3 · Catastrophic Cancellation | 灾难性抵消 · Overflow and Underflow | 溢出与下溢 · The Log-Sum-Exp Trick | Log-Sum-Exp 技巧 · Why Softmax Needs the Max-Subtraction Trick | 为什么 Softmax 需要减最大值技巧 · NaN and Inf: Detection and Prevention | NaN 和 Inf：检测与预防 · Numerical Gradient Checking | 数值梯度检查 · Mixed Precision Training | 混合精度训练 · bfloat16 vs float16: Why bfloat16 Wins for Training | bfloat16 vs float16：为什么 bfloat16 在训练中胜出 · Gradient Clipping | 梯度裁剪 · Common ML Numerical Bugs | 常见 ML 数值 Bug · Step 1: Demonstrate floating point precision limits | 第1步：演示浮点精度限制 · Step 1: Demonstrate floating point precision limits · Step 2: Implement naive vs stable softmax | 第2步：实现朴素与稳定 softmax · Step 3: Implement stable log-sum-exp | 第3步：实现稳定的 log-sum-exp · Step 4: Implement stable cross-entropy | 第4步：实现稳定的交叉熵 · Step 5: Gradient checking | 第5步：梯度检查"
      },
      {
        ...
        "keywords": "Norms: measuring vector magnitude | 范数：衡量向量大小 · L1 Norm (Manhattan distance) | L1 范数（曼哈顿距离） · L2 Norm (Euclidean distance) | L2 范数（欧氏距离） · Lp Norms: the general family | Lp 范数：通用族 · Cosine Similarity and Cosine Distance | 余弦相似度与余弦距离 · Mahalanobis Distance | 马氏距离 · Jaccard Similarity (for sets) | Jaccard 相似度（集合） · Edit Distance (Levenshtein Distance) | 编辑距离（Levenshtein 距离） · KL Divergence (not a distance, but used like one) | KL 散度（不是距离，但被当作距离使用） · Wasserstein Distance (Earth Mover's Distance) | Wasserstein 距离（推土机距离） · Why Different Tasks Need Different Distances | 为什么不同任务需要不同距离 · Connection to Regularization | 与正则化的联系 · Nearest Neighbor Search | 最近邻搜索 · Step 1: All norm and distance functions | 第1步：所有范数和距离函数 · Step 2: Same data, different distances, different neighbors | 第2步：相同数据，不同距离，不同邻居 · Step 3: Embedding similarity search | 第3步：嵌入相似度搜索"
      },
      {
        ...
        "keywords": "Descriptive Statistics: Summarizing Your Data | 描述性统计：汇总你的数据 · Correlation: How Variables Move Together | 相关性：变量如何一起变动 · Covariance Matrix | 协方差矩阵 · Hypothesis Testing | 假设检验 · The t-test | t 检验 · Chi-squared Test | 卡方检验 · A/B Testing for ML Models | ML 模型的 A/B 测试 · Statistical Significance vs Practical Significance | 统计显著性 vs 实际显著性 · Multiple Comparison Problem | 多重比较问题 · Bootstrap Methods | Bootstrap 方法 · Parametric vs Non-parametric Tests | 参数检验 vs 非参数检验 · Central Limit Theorem: Practical Implications | 中心极限定理：实际意义 · Common Statistical Mistakes in ML Papers | ML 论文中常见的统计错误"
      },
      {
    ...
    "lessons": [
      {
        ...
        "keywords": "One Neuron, One Decision | 一个神经元，一个决策 · The Decision Boundary | 决策边界 · The Learning Rule | 学习规则 · The XOR Problem | XOR 问题 · Step 1: The Perceptron class · Step 2: Train on logic gates | 在逻辑门上训练 · Step 3: Watch XOR fail | 观察 XOR 的失败 · Step 4: Solve XOR with two layers | 用两层网络解决 XOR · Step 5: Train a Two-Layer Network | 训练一个两层网络"
      },
      {
        ...
        "keywords": "Layers: Input, Hidden, Output | 层：输入层、隐藏层、输出层 · Neurons and Activations | 神经元与激活函数 · Forward Pass: How Data Flows | 前向传播：数据如何流动 · Matrix Dimensions | 矩阵维度 · Universal Approximation Theorem | 万能逼近定理 · Composability | 可组合性 · Step 1: Sigmoid Activation · Step 2: Layer Class | Layer 类 · Step 3: Network Class | Network 类 · Step 4: XOR with Hand-Tuned Weights | 用手动设定的权重解决 XOR · Step 5: Circle Classification | 圆形分类"
      },
      {
        ...
        "keywords": "The Chain Rule, Applied to Networks | 链式法则在神经网络中的应用 · Computational Graphs | 计算图 · Forward vs Backward | 前向与反向 · Gradient Flow Through a Network | 梯度在网络中的流动 · Vanishing Gradients | 梯度消失 · Deriving Gradients for a 2-Layer Network | 推导两层网络的梯度 · Step 1: The Value Node | Value 节点 · Step 2: Operations with Backward Functions | 带反向传播的操作 · Step 3: Sigmoid and Loss | Sigmoid 和损失函数 · Step 4: Backward Pass | 反向传播 · Step 5: Layer and Network | 层和网络 · Step 6: Train on XOR | 训练 XOR · Step 7: Circle Classification | 圆形分类"
      },
      {
        ...
        "keywords": "Why Nonlinearity Is Necessary | 为什么必须要有非线性 · Sigmoid · Tanh · ReLU: The Breakthrough | ReLU：深度学习的突破 · Leaky ReLU · GELU: The Modern Default | GELU：现代默认选择 · Swish / SiLU · Softmax: The Output Activation | Softmax：输出层激活函数 · Comparison of Shapes | 形状对比 · Which Activation When | 什么时候用什么激活函数 · Step 1: Implement All Activation Functions with Derivatives · Step 2: Visualize Where Gradients Die | 可视化梯度死亡区域 · Step 3: Vanishing Gradient Experiment | 梯度消失实验 · Step 4: Dead Neuron Detector | 死亡神经元检测器 · Step 5: Training Comparison -- Sigmoid vs ReLU vs GELU | 训练对比"
      },
      {
        ...
        "keywords": "Mean Squared Error (MSE) | 均方误差 · Cross-Entropy Loss | 交叉熵损失 · Why MSE Fails for Classification | 为什么 MSE 不适合分类 · Label Smoothing | 标签平滑 · Contrastive Loss | 对比损失 · Focal Loss | 焦点损失 · Loss Function Decision Tree | 损失函数选择决策树 · Step 1: MSE and Its Gradient | MSE 及其梯度 · Step 2: Binary Cross-Entropy | 二元交叉熵 · Step 3: Categorical Cross-Entropy with Softmax | 带softmax的多类交叉熵 · Step 4: Label Smoothing | 标签平滑 · Step 5: Contrastive Loss (Simplified InfoNCE) | 对比损失 · Step 6: MSE vs Cross-Entropy on Classification | MSE vs 交叉熵分类对比"
      },
      {
        ...
        "keywords": "Stochastic Gradient Descent (SGD) | 随机梯度下降 · Momentum | 动量 · RMSProp | 均方根传播 · Adam: Momentum + RMSProp | Adam：动量 + 自适应学习率 · AdamW: Weight Decay Done Right | AdamW：正确的权重衰减 · Learning Rate: The Most Important Hyperparameter | 学习率：最重要的超参数 · Optimizer Comparison | 优化器对比 · When Each Optimizer Wins | 优化器选择指南 · Step 1: Vanilla SGD | 第一步：原始 SGD · Step 2: SGD with Momentum | 第二步：带动量的 SGD · Step 3: Adam | 第三步：Adam 优化器 · Step 4: AdamW | 第四步：AdamW 优化器 · Step 5: Training Comparison | 第五步：训练对比"
      },
      {
        ...
        "keywords": "The Overfitting Spectrum | 过拟合谱系 · Dropout | 随机丢弃 · Weight Decay (L2 Regularization) | 权重衰减（L2 正则化） · Batch Normalization | 批归一化 · Layer Normalization | 层归一化 · RMSNorm | 均方根归一化 · Normalization Comparison | 归一化方法对比 · Normalization Comparison | 归一化方法对比 · Data Augmentation as Regularization | 数据增强作为正则化 · Early Stopping | 早停法 · When to Apply What | 正则化选择指南 · Step 1: Dropout (Train and Eval Mode) | 第一步：Dropout（训练/评估模式） · Step 2: L2 Weight Decay | 第二步：L2 权重衰减 · Step 3: Batch Normalization | 第三步：批归一化 · Step 4: Layer Normalization | 第四步：层归一化 · Step 5: RMSNorm | 第五步：均方根归一化 · Step 6: Training With and Without Regularization | 第六步：正则化对比训练"
      },
      {
        ...
        "keywords": "The Symmetry Problem | 对称性问题 · Variance Propagation Through Layers | 方差逐层传播 · Xavier/Glorot Initialization | Xavier/Glorot 初始化 · Kaiming/He Initialization | Kaiming/He 初始化 · Transformer Initialization | Transformer 初始化 · Activation Magnitude Through 50 Layers | 50 层激活幅度实验 · Choosing the Right Init | 选择正确的初始化 · Step 1: Initialization Strategies | 第一步：初始化策略 · Step 2: Activation Functions | 第二步：激活函数 · Step 3: Forward Pass Through 50 Layers | 第三步：50 层前向传播 · Step 4: The Experiment | 第四步：实验 · Step 5: Symmetry Demonstration | 第五步：对称性演示 · Step 6: Layer-by-Layer Magnitude Report | 第六步：逐层幅度报告"
      },
      {
        ...
        "keywords": "Constant Learning Rate | 恒定学习率 · Step Decay | 阶梯衰减 · Cosine Annealing | 余弦退火 · Warmup: Why You Start Small | Warmup：为什么要从小学习率开始 · Linear Warmup + Cosine Decay | 线性 Warmup + 余弦衰减 · 1cycle Policy | 1cycle 策略 · Schedule Shapes | 调度形状对比 · Decision Flowchart | 决策流程图 · Real Numbers from Published Models | 已发表模型的实际参数 · Step 1: Schedule Functions | 第一步：调度函数 · Step 2: Visualize All Schedules | 第二步：可视化所有调度 · Step 3: Training Network | 第三步：训练网络 · Step 4: Compare All Schedules | 第四步：对比所有调度 · Step 5: LR Too High vs Too Low | 第五步：学习率过高 vs 过低"
      },
      {
        ...
        "keywords": "The Module Abstraction | Module 抽象 · Sequential Container | Sequential 容器 · Training vs Evaluation Mode | 训练与评估模式 · Optimizer | 优化器 · DataLoader | 数据加载器 · Framework Architecture | 框架架构 · Training Loop | 训练循环 · Module Hierarchy | Module 层级 · Step 1: Module Base Class | 第一步：Module 基类 · Step 2: Linear Layer | 第二步：Linear 层 · Step 3: Activation Modules | 第三步：激活函数 Module · Step 4: Dropout Module | 第四步：Dropout Module · Step 5: BatchNorm Module | 第五步：BatchNorm Module · Step 6: Sequential Container | 第六步：Sequential 容器 · Step 7: Loss Functions | 第七步：损失函数 · Step 8: SGD and Adam Optimizers | 第八步：SGD 和 Adam 优化器 · Step 9: DataLoader | 第九步：DataLoader · Step 10: Train a 4-Layer Network on Circle Classification | 第十步：4 层网络分类训练"
      },
      {
        ...
        "keywords": "Why PyTorch Won | PyTorch 为什么赢了 · Tensors | 张量 · Autograd | 自动微分 · nn.Module | 神经网络模块 · Loss Functions and Optimizers | 损失函数和优化器 · The Training Loop | 训练循环 · Dataset and DataLoader | 数据集与数据加载器 · GPU Training | GPU 训练 · Comparison: Mini Framework vs PyTorch vs JAX | 对比：迷你框架 vs PyTorch vs JAX · Step 1: Load MNIST From Raw Files | 第一步：从原始文件加载 MNIST · Step 2: Define the Model | 第二步：定义模型 · Step 3: Training Loop | 第三步：训练循环 · Step 4: Wire Everything Together | 第四步：组装一切 · Quick Comparison: Mini Framework vs PyTorch | 快速对比：迷你框架 vs PyTorch · Saving and Loading Models | 保存和加载模型 · Learning Rate Scheduling | 学习率调度"
      },
      {
        ...
        "keywords": "The JAX Philosophy | JAX 的设计哲学 · jax.numpy: The Familiar Surface | jax.numpy：熟悉的接口 · jax.grad: Functional Autodiff | jax.grad：函数式自动微分 · jit: Compile to XLA | jit：编译到 XLA · vmap: Automatic Vectorization | vmap：自动向量化 · pmap: Data Parallelism Across Devices | pmap：跨设备数据并行 · Pytrees: The Universal Data Structure | Pytrees：通用数据结构 · Functional vs Object-Oriented | 函数式 vs 面向对象 · The JAX Ecosystem | JAX 生态系统 · When to Use JAX vs PyTorch | 何时用 JAX vs PyTorch · Random Numbers in JAX | JAX 中的随机数 · Step 1: Setup and Data | 第一步：设置与数据 · Step 2: Initialize Parameters | 第二步：初始化参数 · Step 3: Forward Pass | 第三步：前向传播 · Step 4: JIT-Compiled Training Step | 第四步：JIT 编译的训练步骤 · Step 5: Training Loop | 第五步：训练循环 · Flax: The Google Standard | Flax：Google 的标准库 · Equinox: The Pythonic Alternative | Equinox：Pythonic 替代方案 · Optax: Composable Optimizers | Optax：可组合优化器"
      },
      {
        ...
        "keywords": "The Debugging Mindset | 调试心态 · Symptom 1: Loss Not Decreasing | 症状 1：Loss 不下降 · Symptom 2: Loss Decreasing But Model is Bad | 症状 2：Loss 下降但模型不好 · Symptom 3: NaN or Inf in Loss | 症状 3：Loss 出现 NaN 或 Inf · Technique 1: Gradient Checking | 技术 1：梯度检查 · Technique 2: Activation Statistics | 技术 2：激活统计 · Technique 3: Gradient Flow Visualization | 技术 3：梯度流可视化 · Technique 4: The Overfit-One-Batch Test | 技术 4：过拟合单 batch 测试 · Technique 5: Learning Rate Finder | 技术 5：学习率搜索器 · Common PyTorch Bugs | 常见 PyTorch 错误 · The Master Debugging Table | 调试总表 · Step 1: The NetworkDebugger Class | 第一步：NetworkDebugger 类 · Step 2: The Overfit-One-Batch Test | 第二步：过拟合单 batch 测试 · Step 3: Learning Rate Finder | 第三步：学习率搜索器 · Step 4: Gradient Checker | 第四步：梯度检查器 · Step 5: Deliberately Broken Networks | 第五步：故意制造错误 · PyTorch Built-in Tools | PyTorch 内置工具 · Weights & Biases Integration | Weights & Biases 集成 · TensorBoard | TensorBoard 可视化 · The Debug Checklist (Before Full Training) | 调试清单（完整训练前）"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "keywords": "The full preprocessing pipeline at a glance | 预处理流水线全景 · A pixel is a sample, not a square | 像素是采样点，不是色块 · Why three channels | 为什么是三个通道 · Two layout conventions: HWC and CHW | 两种布局约定：HWC 和 CHW · Byte ranges and dtype | 字节范围与数据类型 · Color spaces and why they exist | 色彩空间及其存在的理由 · Aspect ratio, resizing, and interpolation | 宽高比、缩放与插值 · Step 1: Load an image and inspect its shape | 加载图像并检查其形状 · Step 2: Split channels and re-order layout | 分离通道并重排布局 · Step 3: Grayscale and HSV conversions | 灰度与 HSV 转换 · Step 4: Normalize, standardize, and reverse it | 归一化、标准化与逆变换 · Step 5: Resize with three interpolation methods | 三种插值方法对比"
      },
      {
        ...
        "keywords": "One kernel, sliding | 一个核，滑过全图 · Output size formula | 输出尺寸公式 · Padding | 填充 · Stride | 步幅 · Multiple input channels | 多输入通道 · The im2col trick | im2col 技巧 · Receptive field | 感受野 · Step 1: Pad an array | 填充数组 · Step 2: 2D convolution with nested loops | 嵌套循环实现 2D 卷积 · Step 3: Verify with a hand-designed kernel | 用手工设计的核验证 · Step 4: im2col | im2col 矩阵展开 · Step 5: Fast conv via im2col + matmul | 用 im2col + 矩阵乘法加速卷积 · Step 6: A bank of hand-designed kernels | 手工设计的一组经典核"
      },
      {
        ...
        "keywords": "The four ideas that changed vision | 改变计算机视觉的四个想法 · LeNet-5 (1998) | 第一个实用 CNN · AlexNet (2012) | 深度学习的引爆点 · VGG (2014) | 3x3 卷积的极致堆叠 · Inception (2014, same year) | 多尺度并行滤波 · The degradation problem | 退化问题：越深反而越差 · ResNet (2015) | 残差连接——深度学习的突破 · Why residuals matter beyond vision | 残差连接的深远影响 · Step 1: LeNet-5 | 实现 LeNet-5 · Step 2: A VGG block | 实现 VGG 块 · Step 3: A ResNet BasicBlock | 实现 ResNet 基本块 · Step 4: A tiny ResNet | 构建迷你 ResNet · Step 5: Compare parameter-to-feature efficiency | 参数效率对比"
      },
      {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "The prediction game · Step 1: trigram counts · Step 2: Laplace smoothing · Step 3: Kneser-Ney (bigram, interpolated) · Step 4: generating text with sampling · Step 5: perplexity"
      },
      {
        ...
        "keywords": "The scripted half-century, 1950-2001 · Step 1: rule-based pattern matching · Step 2: retrieval-based (FAQ) · Step 3: neural generation (baseline) · Step 4: LLM agent loop · Step 5: hybrid routing"
      },
      {
        ...
        "keywords": "Step 1: zero-shot cross-lingual classification · Step 2: multilingual embedding space · Step 3: few-shot fine-tuning strategy · The tokenization tax | 分词税"
      },
      {
        ...
        "keywords": "Step 1: BPE from scratch · Step 2: tokenization with tiktoken and SentencePiece · Step 3: fertility comparison"
      },
      {
        ...
        "keywords": "Step 1: simple logit masking · Step 2: JSON schema validation during generation · Step 3: using LM Format Enforcer"
      },
      {
        ...
        "keywords": "Step 1: zero-shot classification via NLI"
      },
      {
        ...
        "keywords": "Step 1: comparing embedding models"
      },
      {
        ...
        "keywords": "Step 1: fixed-size chunking with overlap · Step 2: semantic chunking"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Step 1: build an alias index from Wikipedia redirects · Step 2: context-based disambiguation"
      },
      {
      ...
      },
      {
        ...
        "keywords": "Step 1: simple NIAH test"
      },
      {
        ...
        "keywords": "Step 1: slot-value state tracker · Step 2: LLM-based state update"
      }
    ]
  },
  {
    ...
    "lessons": [
      {
        ...
        "keywords": "Step 1: Measure Serial Depth | 步骤 1：测量串行深度 · Step 2: Count Theoretical Operations | 步骤 2：计算理论操作数 · Step 3: Empirical Scaling on Long Sequences | 步骤 3：长序列上的实证扩展"
      },
      {
        ...
        "keywords": "The Database Lookup Analogy | 数据库查找类比 · Q, K, V Computation | Q、K、V 计算 · The Attention Matrix | 注意力矩阵 · Why Scale? | 为什么要缩放？ · Why Scale? · Softmax Turns Scores into Weights | Softmax 将分数转换为权重 · Weighted Sum of Values | 值的加权求和 · Full Pipeline | 完整流水线 · Step 1: Softmax from scratch | 步骤 1：从零实现 Softmax · Step 2: Scaled dot-product attention | 步骤 2：缩放点积注意力 · Step 3: Self-attention class with learned projections | 步骤 3：带学习投影的自注意力类 · Step 4: Run it on a sentence | 步骤 4：在句子上运行 · Step 5: Visualize attention with ASCII heatmap | 步骤 5：用 ASCII 热力图可视化注意力"
      },
      {
        ...
        "keywords": "Step 1: Split heads from the single-head attention we already have | 步骤 1：从已有的单头注意力拆分头 · Step 2: Run scaled-dot-product attention per head | 步骤 2：每个头运行缩放点积注意力 · Step 3: Grouped-Query Attention variant | 步骤 3：分组查询注意力变体 · Step 4: Probe what each head learned | 步骤 4：探测每个头学到了什么"
      },
      {
        ...
        "keywords": "Absolute sinusoidal | 绝对正弦编码 · RoPE | 旋转位置嵌入 · ALiBi | 带线性偏置的注意力 · What to pick in 2026 | 2026 年选什么 · Step 1: Sinusoidal encoding | 步骤 1：正弦编码 · Step 2: RoPE applied to Q, K | 步骤 2：将 RoPE 应用于 Q、K · Step 3: ALiBi slopes and bias | 步骤 3：ALiBi 斜率和偏置 · Step 4: Verify relative-distance property of RoPE | 步骤 4：验证 RoPE 的相对距离属性"
      },
      {
        ...
        "keywords": "The six pieces | 六个组件 · Encoder block (used by BERT, T5 encoder) | 编码器块 · Encoder block (used by BERT, T5 encoder) · Decoder block (used by GPT, T5 decoder) | 解码器块 · Pre-norm vs post-norm | 前归一化 vs 后归一化 · The 2026 modernized block | 2026 年现代化块 · Parameter count | 参数量 · Step 1: The building blocks | 步骤 1：构建模块 · Step 2: Wire a 2-layer encoder and a 2-layer decoder | 步骤 2：连接 2 层编码器和 2 层解码器 · Step 3: Run forward on a toy example | 步骤 3：在玩具示例上运行前向传播 · Step 4: Swap in RMSNorm + SwiGLU | 步骤 4：替换为 RMSNorm + SwiGLU"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The mask · Where the triangle comes from · Parallel training, serial inference · The loss — shift-by-one · Decoding strategies · What made the \"GPT recipe\" work · Step 1: the causal mask · Step 2: a 2-layer GPT-ish model · Step 3: next-token prediction, end-to-end · Step 4: sampling"
      },
      {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "summary": "Pixel-space diffusion on 512x512 images is a computational war crime. Rombach et al. (2022) noticed that you do not need all 786k dimensions to generate an image — you need enou…",
      ...
      },
      {
        ...
        "keywords": "Straight-line flow | 直线流 · Sampling | 采样 · Rectified flow (Liu 2022) | 整流流（Liu 2022） · Why this won for images in 2024 | 为何 2024 年图像生成全面转向 Flow Matching · Step 1: training loss | 步骤 1：训练损失 · Step 2: multi-step inference | 步骤 2：多步推理 · Step 3: compare step counts | 步骤 3：比较步数"
      },
      {
        ...
        "keywords": "FID — sample quality | FID — 样本质量 · CLIP score — prompt adherence | CLIP Score — Prompt 遵循度 · Human preference — the ground truth | 人类偏好 — 地面真值 · Step 1: FID in four lines | 步骤 1：四行 FID · Step 2: CLIP-style cosine-similarity | 步骤 2：CLIP 风格余弦相似度 · Step 3: Elo aggregation | 步骤 3：Elo 聚合"
      },
      {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "The Context Window is a Scarce Resource · Lost-in-the-Middle · Context Components · Context Compression Strategies · Memory Systems · Dynamic Context Assembly · Step 1: Token Counter · Step 2: Context Budget Manager · Step 3: Lost-in-the-Middle Reordering · Step 4: Conversation History Compressor · Step 5: Dynamic Tool Selector · Step 6: Full Context Assembly Pipeline · Harness-Managed Context · Cursor's Dynamic Context Loading · Dynamic Context Loading · ChatGPT Memory · Assistant Long-Term Memory · RAG as Context Engineering"
      },
      {
      ...
      },
      {
        ...
        "summary": "A ReAct loop written by hand is a `while True`. The same loop written as an explicit graph is something you can checkpoint, interrupt, branch, and time-travel through. The agent…",
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "The architecture  | 架构 · Stage 1: projector alignment  | 第一阶段：投影器对齐 · Stage 2: visual instruction tuning  | 第二阶段：视觉指令微调 · Why the community copied this  | 为什么社区纷纷效仿 · LLaVA-1.5 and LLaVA-NeXT  | LLaVA-1.5 与 LLaVA-NeXT · LLaVA-OneVision · The comparison to Q-Former  | Q-Former 对比 · The prompt format  | 提示词格式 · Parameter economy  | 参数经济性"
      },
      {
        ...
        "keywords": "NaViT and patch-n'-pack  | NaViT 与补丁打包 · AnyRes (LLaVA-NeXT)  | AnyRes 切片策略 · M-RoPE (Qwen2-VL)  | M-RoPE 多模态旋转位置编码 · NaFlex (SigLIP 2)  | NaFlex 灵活分辨率 · The packing mask  | 打包掩码 · Token budgets  | Token 预算"
      },
      {
        ...
        "keywords": "The five-axis design space  | 五轴设计空间 · Axis 1: encoder > connector  | 编码器 > 连接器 · Axis 2: connector design is a wash  | 连接器设计几乎无影响 · Axis 3: LLM size sets the ceiling  | LLM 大小决定天花板 · Axis 4: data — detailed human captions beat distillation  | 数据：人工描述胜过蒸馏 · Axis 5: resolution and its schedule  | 分辨率及其调度 · The Prismatic controlled comparison  | Prismatic 控制对比实验 · A picker for 2026  | 2026 年推荐配方"
      },
      {
        ...
        "keywords": "The OneVision token budget  | OneVision token 预算 · The three-stage curriculum  | 三阶段课程学习 · Why curriculum works  | 为什么课程学习有效 · Emergent cross-scenario skills  | 涌现的跨场景能力 · Visual-token pooling  | 视觉 token 池化 · LLaVA-OneVision-1.5 · Contrast with Qwen2.5-VL  | 与 Qwen2.5-VL 对比"
      },
      {
        ...
        "keywords": "Qwen-VL (August 2023)  | Qwen-VL 第一代 · Qwen2-VL (September 2024) — M-RoPE and native resolution  | Qwen2-VL：M-RoPE 与原生分辨率 · Qwen2.5-VL (February 2025) — dynamic FPS + absolute time  | Qwen2.5-VL：动态帧率 + 绝对时间 · Qwen3-VL (November 2025) · M-RoPE mathematically  | M-RoPE 数学原理 · Dynamic-FPS sampling logic  | 动态帧率采样逻辑 · Structured agent output  | 结构化代理输出"
      },
      {
        ...
        "keywords": "Native multimodal pretraining  | 原生多模态预训练 · V2PE (variable visual position encoding)  | V2PE 可变视觉位置编码 · Visual Resolution Router (ViR)  | 视觉分辨率路由器 · Decoupled Vision-Language deployment (DvD)  | 解耦视觉-语言部署 · Single-stage vs multi-stage quality  | 单阶段 vs 多阶段质量 · InternVL3.5 and InternVL-U · Trade-offs of native pretraining  | 原生预训练的权衡"
      },
      {
      ...
      },
      {
        ...
        "keywords": "GUI grounding — the primitive | GUI 定位——基础原语 · Action schemas | 动作模式 · Screenshot-only vs accessibility-tree | 纯截图 vs 无障碍树 · Long-horizon memory | 长期记忆 · Visual tool use | 视觉工具使用 · The 2026 benchmarks | 2026 年基准测试 · Why it's still hard | 为什么仍然很难 · The capstone build-it | 毕业项目构建"
      }
    ]
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "The common structure | 通用结构 · Shape diffs, field by field · Limits you will actually hit | 实际会遇到的限制 · `tool_choice` behavior · Parallel calls · Streaming · Errors and repair · The translator pattern | 翻译器模式"
      },
      {
    ...
    "lessons": [
      {
        ...
        "summary": "Every agent in 2026 is a variant of the ReAct loop from 2022 — Claude Code, Cursor, Devin, Operator included. Reasoning tokens interleave with tool calls and observations until …",
      ...
      },
      {
        ...
        "keywords": "The three roles · Why 5x fewer tokens · Why it is more robust · Planner distillation · Plan-and-Execute (LangChain, 2023) · Plan-and-Execute (2023) · Plan-and-Act (Erdogan et al., arXiv:2503.09572, ICML 2025) · When to pick which"
      },
      {
      ...
      },
      {
        ...
        "summary": "Context windows are finite. Conversations, documents, and tool traces are not. The fix is OS virtual memory restated — main context is RAM, external store is disk, the agent pag…",
        "keywords": "The OS analogy · Two tiers · The interrupt pattern · Where the paper ends and production begins · Where this pattern goes wrong · The shape of agent memory"
      },
      {
        ...
        "summary": "Discrete functional memory blocks the model can edit directly, and a sleep-time agent that consolidates memory asynchronously while the primary agent is idle. These two ideas ar…",
        "keywords": "Three tiers · Memory blocks · Sleep-time compute · Letta V1 and native reasoning · Native reasoning · Where this pattern goes wrong"
      },
      {
        ...
        "summary": "Hybrid memory runs three stores in parallel — vector for semantic similarity, KV for fast fact lookup, graph for entity-relationship reasoning — with a scoring layer that fuses …",
      ...
      },
      {
        ...
        "summary": "Agent is a state machine; nodes are functions; edges are transitions; state is checkpointed after each node. Resume from any failure at the last successful checkpoint. LangGraph…",
      ...
      },
      {
        ...
        "summary": "Agents as actors: async message exchange, event-driven handlers, fault isolation, natural concurrency. AutoGen v0.4 (Microsoft Research, Jan 2025) redesigned agent orchestration…",
        "keywords": "Actors · Three API layers in AutoGen v0.4 · Three API layers · Why decoupling matters · Topologies · Observability · Status: maintenance mode"
      },
      {
        ...
        "summary": "Four primitives: Agent, Task, Crew, Process. Two top-level shapes: Crews (autonomous, role-based collaboration) and Flows (event-driven, deterministic). CrewAI is the 2026 refer…",
        "keywords": "Four primitives · Sequential vs Hierarchical vs Consensus · Crews vs Flows · Tool integration · Memory hooks · When CrewAI fits · When role-based teams fit · When they do not · Dependency shape · Where this pattern goes wrong"
      },
      {
      ...
      },
      {
        ...
        "summary": "A harness you can import: built-in tools, subagents for context isolation, hooks, W3C trace propagation, session persistence. The Claude Agent SDK is the reference example — the…",
      ...
      },
      {
        ...
        "summary": "A production agent runtime optimizes what prototyping frameworks ignore: instantiation cost, typed workflow surfaces, and a serving-ready backend. The 2026 pairing: Agno (Python…",
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "keywords": "The loop | 循环 · What makes the evaluator non-negotiable | 评估器为何不可妥协 · Reward hacking is the other face of that statement | 奖励篡改是该论断的另一面 · Why LLM + search beats either alone | 为什么 LLM + 搜索胜过单独使用 · Where AlphaEvolve fits in the frontier stack | AlphaEvolve 在前沿技术栈中的位置"
      },
      {
        ...
        "keywords": "The loop | 循环 · What DGM actually improved | DGM 实际改进了什么 · The reward-hacking demonstration | 奖励篡改演示 · Versus the classical Godel Machine | 与经典 Godel Machine 对比 · Where it fits in this phase | 在本阶段的位置"
      },
      {
        ...
        "keywords": "The architecture | 架构 · What the workshop-acceptance result means | 工作坊接受结果意味着什么 · What the independent evaluation found | 独立评估发现 · The sandbox-escape concern | 沙箱逃逸担忧 · Where v2 sits in the frontier stack | v2 在前沿栈中的位置"
      },
      {
        ...
        "keywords": "The architecture (as publicly described) | 架构（公开描述） · Why the out-of-sandbox log matters | 沙箱外日志为何重要 · The prescribed-workflow tradeoff | 规定工作流的权衡 · The compression risk | 压缩风险 · What AAR does not replace | AAR 不替代什么"
      },
      {
        ...
        "keywords": "What recursive self-improvement means precisely | 递归自我改进的精确定义 · The alignment-faking result in detail | 对齐伪装结果详解 · The Hassabis question | Hassabis 的问题 · Capability vs alignment, as a race | 能力 vs 对齐，作为赛跑 · What the ICLR 2026 workshop treats as engineering | ICLR 2026 工作坊视为工程的内容"
      },
      {
        ...
        "keywords": "Primitive 1: formal invariants | 原语 1：形式不变量 · Primitive 2: alignment anchors | 原语 2：对齐锚点 · Primitive 3: multi-objective constraints | 原语 3：多目标约束 · Primitive 4: regression detection | 原语 4：回归检测 · Information-theoretic limits | 信息论极限 · A worked example | 一个工作示例"
      },
      {
        ...
        "keywords": "SWE-bench, one paragraph | SWE-bench 一段话 · What the 2022 → 2026 curve actually shows | 2022→2026 曲线实际展示什么 · CodeAct vs JSON tool calls | CodeAct vs JSON 工具调用 · Scaffolds in the 2026 landscape | 2026 全景中的脚手架 · Why scaffolding dominates | 为什么脚手架主导 · Benchmark saturation and the real distribution | 基准饱和与真实分布"
      },
      {
        ...
        "keywords": "The seven permission modes | 七种权限模式 · The six permission modes · Auto Mode in one page | Auto Mode 一页 · What the system catches | 系统捕获什么 · What the system can miss | 系统可能遗漏什么 · Research preview framing | 研究预览框架 · Where this ladder lives in your workflow | 此阶梯在你的工作流中的位置"
      },
      {
        ...
        "keywords": "The 2026 landscape, in one paragraph per system | 2026 全景，每系统一段 · BrowseComp vs OSWorld vs WebArena | BrowseComp vs OSWorld vs WebArena · The attack surface, named | 攻击面，命名 · Why \"not fully patchable\" | 为什么\"不可完全修补\" · Defense posture that actually ships | 实际出货的防御姿态"
      },
      {
        ...
        "keywords": "Activities, workflows, and replay | 活动、工作流和重放 · Why LLM calls fit the pattern | 为什么 LLM 调用契合此模式 · Checkpoints keyed by `thread_id` | 以 `thread_id` 为键的检查点 · Human-input as a first-class state | 人类输入作为一等公民状态 · The 35-minute degradation | 35 分钟衰减 · When durable execution is the wrong answer | 持久执行不是答案时"
      },
      {
        ...
        "keywords": "The cost-governor stack | 成本治理栈 · Why the stack, not one cap | 为什么是栈而非单上限 · Claude Code's budget surface | Claude Code 的预算面 · A harness budget surface · EU AI Act, OWASP Agentic Top 10 | EU AI 法案、OWASP Agentic Top 10 · The observed $1,200 → $4,800 case | 观察到的 $1,200 → $4,800 案例"
      },
      {
        ...
        "keywords": "Kill switches | 终止开关 · Circuit breakers | 断路器 · Canary tokens | 金丝雀 token · Why layer statistical and hard limits | 为什么分层统计和硬限制 · Quarantine via eBPF datapath redirect | 通过 eBPF 数据路径重定向隔离 · What no detector catches | 没检测器能捕获什么"
      },
      {
        ...
        "keywords": "The propose-then-commit state machine | propose-then-commit 状态机 · The idempotency key | 幂等键 · Durability: why approvals outlast processes | 持久性：为什么批准比进程寿命长 · Rubber-stamp approvals and the challenge-and-response mitigation | 橡皮章批准和挑战-响应缓解 · What counts as consequential | 什么算后果性 · Post-action verification | 动作后验证 · EU AI Act Article 14 | EU AI 法案第 14 条"
      },
      {
        ...
        "keywords": "Every transition persists | 每个转换持久化 · Lease recovery | 租约恢复 · Idempotency plus preconditions | 幂等加前置条件 · Post-action verification | 动作后验证 · Rollback plans | 回滚计划 · EU AI Act Article 14 operational reading | EU AI 法案第 14 条运营解读 · The sharp failure mode: the double-execute | 尖锐失败模式：双倍执行"
      },
      {
        ...
        "keywords": "The four-tier priority hierarchy | 四层优先级层次 · Hardcoded prohibitions vs soft-coded defaults | 硬编码禁令 vs 软编码默认 · The 2022 CAI training | 2022 CAI 训练 · What reason-based alignment catches and misses | 基于推理对齐捕获和遗漏什么 · The 2023 participatory experiment | 2023 参与式实验 · Why hardcoded prohibitions are necessary | 为什么硬编码禁令必要 · Where the Constitution sits in the stack | 宪法在栈中的位置"
      },
      {
        ...
        "keywords": "Llama Guard 3 at a glance | Llama Guard 3 速览 · Llama Guard 4 additions | Llama Guard 4 添加 · NeMo Guardrails (NVIDIA) | NeMo Guardrails（NVIDIA） · The attack corpus | 攻击语料库 · Where classifiers win | 分类器获胜处 · Where classifiers lose | 分类器失败处 · Defense-in-depth | 纵深防御"
      },
      {
        ...
        "keywords": "The two-tier mitigation schedule | 两层缓解时间表 · The AI R&D-4 threshold | AI R&D-4 阈值 · Frontier Safety Roadmaps and Risk Reports | 前沿安全路线图和风险报告 · Removing the pause clause | 删除暂停条款 · SaferAI's downgrade | SaferAI 的降级 · What this lesson is not | 这课不是什么"
      },
      {
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "summary": "Four primitives, nothing more — the agent, the handoff, the shared state, the orchestrator — span a four-dimensional design space, and the major multi-agent frameworks shipping …",
      ...
      },
      {
        ...
        "keywords": "The shape · Where it shines · Where it breaks · The deciding question · CrewAI's implementation · Role-framework implementation · LangGraph's implementation · Graph-framework implementation"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The shape · When swarm fits · When swarm fails · Matrix (arXiv:2511.21686) · LangGraph's Swarm Architecture · Swarm in graph frameworks · Failure mode: starvation and hot-spotting · The content-based routing link"
      },
      {
        ...
        "summary": "Shared-conversation orchestration puts N agents in one conversation; a selector function (LLM, round-robin, or custom) picks who speaks next. This is the archetype of emergent m…",
        "keywords": "The shape · The three selector flavors · The ConversableAgent API · Termination · The AutoGen -> AG2 split and the Microsoft Agent Framework merge · Lineage: forks and mergers · When GroupChat fits · When it fails · Group chat vs supervisor"
      },
      {
      ...
      },
      {
        ...
        "keywords": "The four elements · The MCP/A2A split · Auth · 150+ organizations by April 2026 · Where A2A wins · Where A2A struggles · A2A vs ACP, ANP, NLIP"
      },
      {
      ...
      },
      {
        ...
        "summary": "Scaling multi-agent systems to thousands of concurrent runs requires **durable execution** — work queues plus checkpoints, so any worker can resume any run after any crash, prov…",
  ...
  },
  {
    ...
    "lessons": [
      ...
      },
      {
        ...
        "summary": "Treat the KV cache as a first-class, reusable resource stored in a radix tree, and scheduling changes with it: instead of FCFS (first-come, first-served) as vLLM schedules, a ca…",
      ...
      },
      {
        ...
        "summary": "Hardware-specialized inference compilation trades portability for throughput, and TensorRT-LLM — NVIDIA-only, tuned for Blackwell — is the clearest example of the trade paying o…",
      ...
      },
      {
        ...
        "summary": "A production serving stack wires router, engines, and observability into one Kubernetes deployment — and treats KV cache as a resource that can leave the GPU. KV offloading extr…",
      ...
      },
      {
        ...
        "summary": "Engine selection is a function of hardware, scale, and ecosystem — not a leaderboard read. Four engines dominate self-hosted inference in 2026: llama.cpp, Ollama, vLLM, SGLang, …",
